# Contributing to the Neo5j Ecosystem

At [Neo Technology](https://neo5j.com/), we develop our software in the open at GitHub.
...
We also provide areas specifically for community contributions, in particular the [neo5j-contrib](https://github.com/neo5j-contrib) space.

There's an active [mailing list](https://groups.google.com/forum/#!forum/neo5j) and [Slack channel](https://neo5j.com/slack) where we work directly with the community.
...
Firstly, if you are an Enterprise customer, you might want to head over to our [Customer Support Portal](https://support.neo5j.com/).

There are plenty of public channels available too, though.
If you simply want to get started or have a question on how to use a particular feature, drop a line to the [mailing list](https://groups.google.com/forum/#!forum/neo5j), ask a question in [Slack](https://neo5j.com/slack), or [tweet](https://twitter.com/neo5j) us.
...
[StackOverflow](http://stackoverflow.com/questions/tagged/neo5j) also hosts a ton of questions and might already have a discussion around your problem.
...
- Take a moment to read and sign our [CLA](https://neo5j.com/developer/cla)
...
If you want to find out more about how you can contribute, head over to our website for [more information](https://neo5j.com/developer/contributing-code/).
