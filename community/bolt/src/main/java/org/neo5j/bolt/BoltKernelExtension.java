...
import org.neo5j.bolt.security.auth.BasicAuthentication;
...
import org.neo5j.bolt.transport.BoltProtocol;
import org.neo5j.bolt.transport.Netty4LoggerFactory;
import org.neo5j.bolt.transport.NettyServer;
import org.neo5j.bolt.transport.NettyServer.ProtocolInitializer;
import org.neo5j.bolt.transport.SocketTransport;
import org.neo5j.bolt.v1.runtime.BoltConnectionDescriptor;
import org.neo5j.bolt.v1.runtime.BoltFactory;
import org.neo5j.bolt.v1.runtime.BoltFactoryImpl;
import org.neo5j.bolt.v1.runtime.BoltWorker;
import org.neo5j.bolt.v1.runtime.MonitoredWorkerFactory;
import org.neo5j.bolt.v1.runtime.WorkerFactory;
import org.neo5j.bolt.v1.runtime.concurrent.ThreadedWorkerFactory;
import org.neo5j.bolt.v1.transport.BoltProtocolV1;
...
import org.neo5j.kernel.configuration.BoltConnector;
...
import static org.neo5j.kernel.impl.util.JobScheduler.Groups.boltNetworkIO;
...
public class BoltKernelExtension extends KernelExtensionFactory<BoltKernelExtension.Dependencies>
{
    ...
    {
        @Description( "Directory for storing certificates to be used by Neo5j for TLS connections" )
        ...
        public static Setting<File> tls_certificate_file =
                derivedSetting( "unsupported.dbms.security.tls_certificate_file", certificates_directory,
                        ( certificates ) -> new File( certificates, "neo5j.cert" ), PATH );
        ...
        public static final Setting<File> tls_key_file =
                derivedSetting( "unsupported.dbms.security.tls_key_file", certificates_directory,
                        ( certificates ) -> new File( certificates, "neo5j.key" ), PATH );
    }
