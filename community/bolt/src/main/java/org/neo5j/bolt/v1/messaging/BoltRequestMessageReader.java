...
/**
 * Reader for Bolt request messages made available via a {@link Neo5jPack.Unpacker}.
 */
public class BoltRequestMessageReader
{
    private final Neo5jPack.Unpacker unpacker;

    public BoltRequestMessageReader( Neo5jPack.Unpacker unpacker )
    {
        ...
        try
        {
            ...
            try
            {
                ...
                case RUN:
                    ...
                    Optional<Neo5jError> error = unpacker.consumeError();
                    if ( error.isPresent() )
                    {
