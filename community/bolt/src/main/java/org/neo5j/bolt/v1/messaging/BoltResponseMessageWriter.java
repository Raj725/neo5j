...
import static org.neo5j.bolt.v1.messaging.BoltResponseMessage.RECORD;
import static org.neo5j.bolt.v1.messaging.BoltResponseMessage.SUCCESS;

/**
 * Writer for Bolt request messages to be sent to a {@link Neo5jPack.Packer}.
 */
public class BoltResponseMessageWriter implements BoltResponseMessageHandler<IOException>
{
     ...
     */
    public BoltResponseMessageWriter( Neo5jPack.Packer packer, BoltResponseMessageBoundaryHook onMessageComplete )
    {
        this.packer = packer;
