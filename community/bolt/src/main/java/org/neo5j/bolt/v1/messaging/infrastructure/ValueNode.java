        ...
        implements Node
{
    ...
    public static void pack( Neo5jPack.Packer packer, Node node )
            throws IOException
    {
        ...
        packer.packStructHeader( STRUCT_FIELD_COUNT, Neo5jPack.NODE );
    ...
    public static ValueNode unpackFields( Neo5jPack.Unpacker unpacker )
            throws IOException
    {
