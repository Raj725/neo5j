...
import org.neo5j.bolt.v1.messaging.BoltIOException;
...
public class ValueRelationship extends ValuePropertyContainer implements Relationship
{
    ...
    public static void pack( Neo5jPack.Packer packer, Relationship rel )
            throws IOException
    {
        packer.packStructHeader( STRUCT_FIELD_COUNT, Neo5jPack.RELATIONSHIP );
    ...
    public static ValueRelationship unpack( Neo5jPack.Unpacker unpacker )
            throws IOException
    {
        long numFields = unpacker.unpackStructHeader();
        char signature = unpacker.unpackStructSignature();
        if( signature != Neo5jPack.RELATIONSHIP )
        {
    ...
    public static ValueRelationship unpackFields( Neo5jPack.Unpacker unpacker )
            throws IOException
    {
