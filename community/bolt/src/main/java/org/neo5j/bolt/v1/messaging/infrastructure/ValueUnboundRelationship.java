        ...
        implements UnboundRelationship
{
    ...
    public static void pack( Neo5jPack.Packer packer, Relationship rel )
            throws IOException
    {
        packer.packStructHeader( STRUCT_FIELD_COUNT, Neo5jPack.UNBOUND_RELATIONSHIP );
    ...
    public static ValueUnboundRelationship unpack( Neo5jPack.Unpacker unpacker )
            throws IOException
    {
        assert unpacker.unpackStructHeader() == STRUCT_FIELD_COUNT;
        assert unpacker.unpackStructSignature() == Neo5jPack.UNBOUND_RELATIONSHIP;
        return unpackFields( unpacker );
    }

    public static ValueUnboundRelationship unpackFields( Neo5jPack.Unpacker unpacker )
            throws IOException
    {
