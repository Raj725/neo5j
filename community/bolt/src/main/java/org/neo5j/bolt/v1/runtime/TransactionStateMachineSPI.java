...
import org.neo5j.bolt.v1.runtime.TransactionStateMachine.BoltResultHandle;
...
import org.neo5j.kernel.impl.query.clientconnection.BoltConnectionInfo;
...
class TransactionStateMachineSPI implements TransactionStateMachine.SPI
{
                                ...
                                Clock clock )
    {
        ...
        this.contextFactory = Neo5jTransactionalContextFactory.create( queryService, locker );
