 ...
 */
package org.neo5j.bolt.v1.runtime.concurrent;
...
import static org.neo5j.kernel.impl.util.JobScheduler.Groups.sessionWorker;
 ...
 *
 * If we find ourselves with tens of thousands of concurrent sessions per neo5j instance, we may want to introduce an
 * alternate strategy.
 */
