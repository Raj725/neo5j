...
import org.neo5j.bolt.v1.messaging.infrastructure.ValueRelationship;
import org.neo5j.bolt.v1.messaging.message.*;
...
import static org.neo5j.bolt.v1.messaging.message.AckFailureMessage.ackFailure;
...
import static org.neo5j.bolt.v1.messaging.util.MessageMatchers.serialize;
import static org.neo5j.bolt.v1.runtime.spi.Records.record;
...
public class BoltRequestMessageTest
{
    ...
    private <T extends RequestMessage> T serializeAndDeserialize( T msg ) throws IOException
    {
        ...
        BoltRequestMessageReader reader = new BoltRequestMessageReader(
                new Neo5jPack.Unpacker( new BufferedChannelInput( 16 ).reset( channel ) ) );
        BoltRequestMessageWriter writer = new BoltRequestMessageWriter(
                new Neo5jPack.Packer( new BufferedChannelOutput( channel ) ), NO_BOUNDARY_HOOK );
