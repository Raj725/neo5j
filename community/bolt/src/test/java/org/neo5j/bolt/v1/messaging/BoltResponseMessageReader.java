...
import static org.neo5j.bolt.v1.runtime.Neo5jError.codeFromString;
import static org.neo5j.bolt.v1.runtime.spi.Records.record;

public class BoltResponseMessageReader
{
    private final Neo5jPack.Unpacker unpacker;

    public BoltResponseMessageReader( Neo5jPack.Unpacker unpacker )
    {
