 ...
 */
package org.neo5j.bolt.v1.messaging.infrastructure;
...
import static org.neo5j.bolt.v1.messaging.example.Support.nodes;
import static org.neo5j.bolt.v1.messaging.example.Support.relationships;
import static org.neo5j.bolt.v1.messaging.example.Nodes.ALICE;
import static org.neo5j.bolt.v1.messaging.example.Nodes.BOB;
import static org.neo5j.bolt.v1.messaging.example.Nodes.CAROL;
import static org.neo5j.bolt.v1.messaging.example.Nodes.DAVE;
import static org.neo5j.bolt.v1.messaging.example.Paths.PATH_WITH_LENGTH_ONE;
import static org.neo5j.bolt.v1.messaging.example.Paths.PATH_WITH_LENGTH_TWO;
import static org.neo5j.bolt.v1.messaging.example.Paths.PATH_WITH_LENGTH_ZERO;
import static org.neo5j.bolt.v1.messaging.example.Paths.PATH_WITH_LOOP;
import static org.neo5j.bolt.v1.messaging.example.Paths.PATH_WITH_NODES_VISITED_MULTIPLE_TIMES;
import static org.neo5j.bolt.v1.messaging.example.Paths
        .PATH_WITH_RELATIONSHIP_TRAVERSED_AGAINST_ITS_DIRECTION;
import static org.neo5j.bolt.v1.messaging.example.Paths
        .PATH_WITH_RELATIONSHIP_TRAVERSED_MULTIPLE_TIMES_IN_SAME_DIRECTION;
import static org.neo5j.bolt.v1.messaging.example.Relationships.ALICE_KNOWS_BOB;
import static org.neo5j.bolt.v1.messaging.example.Relationships.ALICE_LIKES_CAROL;
import static org.neo5j.bolt.v1.messaging.example.Relationships.CAROL_DISLIKES_BOB;
import static org.neo5j.bolt.v1.messaging.example.Relationships.CAROL_MARRIED_TO_DAVE;
import static org.neo5j.bolt.v1.messaging.example.Relationships.DAVE_WORKS_FOR_DAVE;
