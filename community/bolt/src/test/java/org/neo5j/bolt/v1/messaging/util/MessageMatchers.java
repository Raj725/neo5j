 ...
 */
package org.neo5j.bolt.v1.messaging.util;
...
import org.neo5j.bolt.v1.messaging.BoltRequestMessageReader;
import org.neo5j.bolt.v1.messaging.BoltRequestMessageRecorder;
import org.neo5j.bolt.v1.messaging.BoltRequestMessageWriter;
import org.neo5j.bolt.v1.messaging.BoltResponseMessageReader;
import org.neo5j.bolt.v1.messaging.BoltResponseMessageRecorder;
import org.neo5j.bolt.v1.messaging.BoltResponseMessageWriter;
import org.neo5j.bolt.v1.messaging.Neo5jPack;
import org.neo5j.bolt.v1.messaging.RecordingByteChannel;
import org.neo5j.bolt.v1.messaging.message.FailureMessage;
import org.neo5j.bolt.v1.messaging.message.IgnoredMessage;
import org.neo5j.bolt.v1.messaging.message.RecordMessage;
import org.neo5j.bolt.v1.messaging.message.RequestMessage;
import org.neo5j.bolt.v1.messaging.message.ResponseMessage;
import org.neo5j.bolt.v1.messaging.message.SuccessMessage;
import org.neo5j.bolt.v1.packstream.BufferedChannelInput;
import org.neo5j.bolt.v1.packstream.BufferedChannelOutput;
import org.neo5j.bolt.v1.runtime.spi.Record;
import org.neo5j.bolt.v1.transport.integration.TestNotification;
import org.neo5j.graphdb.Notification;
import org.neo5j.kernel.api.exceptions.Status;
import org.neo5j.kernel.impl.util.HexPrinter;

import static org.hamcrest.CoreMatchers.containsString;
import static org.hamcrest.CoreMatchers.equalTo;
import static org.hamcrest.CoreMatchers.instanceOf;
import static org.junit.Assert.assertThat;
import static org.neo5j.bolt.v1.messaging.BoltResponseMessageWriter.NO_BOUNDARY_HOOK;
...
public class MessageMatchers
{
    ...
    public static byte[] serialize( RequestMessage... messages ) throws IOException
    {
        ...
        final BoltRequestMessageWriter packer = new BoltRequestMessageWriter( new Neo5jPack.Packer( new
    ...
    {
        final RecordingByteChannel rawData = new RecordingByteChannel();
        final BoltResponseMessageWriter packer = new BoltResponseMessageWriter( new Neo5jPack.Packer( new
                BufferedChannelOutput( rawData )), NO_BOUNDARY_HOOK );
    ...
    private static BoltRequestMessageReader requestReader( byte[] bytes )
    {
        return new BoltRequestMessageReader(
                    new Neo5jPack.Unpacker( new BufferedChannelInput( 128 ).reset( new ArrayByteChannel( bytes ) ) ) );
    }
