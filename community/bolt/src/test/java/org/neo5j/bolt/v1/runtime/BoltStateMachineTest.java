...
import org.neo5j.bolt.v1.runtime.spi.BoltResult;
import org.neo5j.graphdb.TransactionFailureException;
import org.neo5j.graphdb.security.AuthorizationExpiredException;
...
import static org.neo5j.bolt.testing.BoltMatchers.canReset;
import static org.neo5j.bolt.testing.BoltMatchers.failedWithStatus;
import static org.neo5j.bolt.testing.BoltMatchers.hasNoTransaction;
import static org.neo5j.bolt.testing.BoltMatchers.hasTransaction;
import static org.neo5j.bolt.testing.BoltMatchers.inState;
import static org.neo5j.bolt.testing.BoltMatchers.isClosed;
import static org.neo5j.bolt.testing.BoltMatchers.succeeded;
import static org.neo5j.bolt.testing.BoltMatchers.verifyOneResponse;
import static org.neo5j.bolt.testing.BoltMatchers.wasIgnored;
import static org.neo5j.bolt.testing.NullResponseHandler.nullResponseHandler;
import static org.neo5j.bolt.v1.runtime.BoltStateMachine.State.CONNECTED;
import static org.neo5j.bolt.v1.runtime.BoltStateMachine.State.FAILED;
import static org.neo5j.bolt.v1.runtime.BoltStateMachine.State.READY;
import static org.neo5j.bolt.v1.runtime.BoltStateMachine.State.STREAMING;
import static org.neo5j.bolt.v1.runtime.MachineRoom.EMPTY_PARAMS;
import static org.neo5j.bolt.v1.runtime.MachineRoom.USER_AGENT;
import static org.neo5j.bolt.v1.runtime.MachineRoom.newMachine;
import static org.neo5j.bolt.v1.runtime.MachineRoom.newMachineWithTransaction;
import static org.neo5j.bolt.v1.runtime.MachineRoom.newMachineWithTransactionSPI;
