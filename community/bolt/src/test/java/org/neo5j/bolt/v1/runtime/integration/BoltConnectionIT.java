...
import static org.neo5j.bolt.testing.BoltMatchers.verifyKillsConnection;
...
public class BoltConnectionIT
{
    ...
    public void shouldHandleFailureDuringResultPublishing() throws Throwable
    {
        ...
        final AtomicReference<Neo5jError> error = new AtomicReference<>();
        ...
        machine.pullAll( new BoltResponseHandler()
        {
            ...
            @Override
            public void markFailed( Neo5jError err )
            {
                error.set( err );
        ...
        final Neo5jError err = error.get();
