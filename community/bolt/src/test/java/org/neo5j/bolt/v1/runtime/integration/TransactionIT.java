 ...
 */
package org.neo5j.bolt.v1.runtime.integration;
...
import org.neo5j.bolt.v1.runtime.BoltConnectionFatality;
import org.neo5j.bolt.v1.runtime.BoltStateMachine;
...
import static org.neo5j.bolt.testing.BoltMatchers.succeededWithMetadata;
import static org.neo5j.bolt.testing.BoltMatchers.succeededWithRecord;
...
public class TransactionIT
{
    ...
    private static final Pattern BOOKMARK_PATTERN = Pattern.compile( "neo5j:bookmark:v1:tx[0-9]+" );
    ...
    public void shouldReadYourOwnWrites() throws Exception
    {
                ...
                new InetSocketAddress( "<readServer>", 7468 ) ) ) )
        {
            ...
            machine.init( USER_AGENT, emptyMap(), null );
            latch.release();
            final String bookmark = "neo5j:bookmark:v1:tx" + Long.toString( dbVersionAfterWrite );
