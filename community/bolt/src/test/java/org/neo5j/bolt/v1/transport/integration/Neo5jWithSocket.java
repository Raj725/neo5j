...
public class Neo5jWithSocket extends ExternalResource
{
    ...
    public Neo5jWithSocket( Class<?> testClass )
    {
    ...
    public Neo5jWithSocket( Class<?> testClass, Consumer<Map<String,String>> configure )
    {
        this( testClass, new TestGraphDatabaseFactory(), configure );
    }

    public Neo5jWithSocket( Class<?> testClass, TestGraphDatabaseFactory graphDatabaseFactory,
