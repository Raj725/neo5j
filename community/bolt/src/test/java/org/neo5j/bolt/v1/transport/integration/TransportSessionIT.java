...
import org.neo5j.graphdb.SeverityLevel;
...
import static org.neo5j.bolt.v1.messaging.util.MessageMatchers.hasNotification;
...
{
    @Rule
    public Neo5jWithSocket server = new Neo5jWithSocket( getClass(), settings ->
