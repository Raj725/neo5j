...
import org.neo5j.codegen.bytecode.ByteCode;
import org.neo5j.codegen.source.SourceCode;
...
import static org.neo5j.codegen.Expression.add;
import static org.neo5j.codegen.Expression.and;
import static org.neo5j.codegen.Expression.constant;
import static org.neo5j.codegen.Expression.equal;
import static org.neo5j.codegen.Expression.invoke;
import static org.neo5j.codegen.Expression.isNull;
import static org.neo5j.codegen.Expression.multiply;
import static org.neo5j.codegen.Expression.newArray;
import static org.neo5j.codegen.Expression.newInstance;
import static org.neo5j.codegen.Expression.not;
import static org.neo5j.codegen.Expression.notNull;
import static org.neo5j.codegen.Expression.or;
import static org.neo5j.codegen.Expression.subtract;
import static org.neo5j.codegen.Expression.ternary;
import static org.neo5j.codegen.ExpressionTemplate.cast;
import static org.neo5j.codegen.ExpressionTemplate.load;
import static org.neo5j.codegen.ExpressionTemplate.self;
import static org.neo5j.codegen.MethodReference.constructorReference;
import static org.neo5j.codegen.MethodReference.methodReference;
import static org.neo5j.codegen.Parameter.param;
import static org.neo5j.codegen.TypeReference.extending;
import static org.neo5j.codegen.TypeReference.parameterizedType;
import static org.neo5j.codegen.TypeReference.typeParameter;
import static org.neo5j.codegen.TypeReference.typeReference;
...
public class CodeGenerationTest
{
    ...
    public static final String PACKAGE = "org.neo5j.codegen.test";
