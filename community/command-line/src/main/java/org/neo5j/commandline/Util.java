...
public class Util
{
    ...
    /**
     * @return the version of Neo5j as defined during the build
     */
    @Nonnull
    public static String neo5jVersion()
    {
        Properties props = new Properties();
        try
        {
            props.load( Util.class.getResourceAsStream( "/org/neo5j/commandline/build.properties" ) );
            return props.getProperty( "neo5jVersion" );
        }
        catch ( IOException e )
        {
