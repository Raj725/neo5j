...
public class AdminTool
{
    ...
    {
        Path homeDir = Paths.get( System.getenv().getOrDefault( "NEO5J_HOME", "" ) );
        Path configDir = Paths.get( System.getenv().getOrDefault( "NEO5J_CONF", "" ) );
        boolean debug = System.getenv( "NEO5J_DEBUG" ) != null;
    ...
    public static final String scriptName = "neo5j-admin";
    ...
    public void execute( Path homeDir, Path configDir, String... args )
    {
        try
        {
            ...
            {
                outsideWorld.stdOutLine( "neo5j-admin " + neo5jVersion() );
                success();
                return;
            }
