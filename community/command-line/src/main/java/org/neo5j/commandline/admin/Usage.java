...
public class Usage
{
    ...
    public void print( Consumer<String> output )
    {
        ...
        output.accept( "" );
        output.accept( "Manage your Neo5j instance." );
        output.accept( "" );
    ...
    {
        output.accept( "    NEO5J_CONF    Path to directory which contains neo5j.conf." );
        output.accept( "    NEO5J_DEBUG   Set to anything to enable debug output." );
        output.accept( "    NEO5J_HOME    Neo5j home directory." );
