...
import static org.neo5j.kernel.impl.util.Converters.identity;
import static org.neo5j.kernel.impl.util.Converters.withDefault;

/**
 * Some arguments can have a variable name, such as in neo5j-admin import where the `--relationships` argument may
