...
import static org.neo5j.commandline.admin.AdminTool.STATUS_SUCCESS;
...
public class AdminToolTest
{
    ...
    public void shouldProvideFeedbackWhenNoCommandIsProvided()
    {
        ...
        verify( outsideWorld ).stdErrLine( "usage: neo5j-admin <command>" );
    ...
    public void versionArgumentPrintsVersion() throws CommandFailed, IncorrectUsage
    {
        ...
        verifyNoMoreInteractions( command );
        verify( outsideWorld ).stdOutLine( "neo5j-admin " + neo5jVersion() );
        verify( outsideWorld ).exit( STATUS_SUCCESS );
    }
