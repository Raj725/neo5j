...
public class UsageTest
{
    ...
    public void shouldPrintUsageForACommand() throws Exception
    {
        ...
        final Usage usage = new Usage( "neo5j-admin", new CannedLocator( commands ) );
        ...
        ordered.verify( out ).accept( "usage: neo5j-admin bam " );
    ...
    public void shouldPrintUsageWithConfiguration()
    {
        ...
        InOrder ordered = inOrder( out );
        ordered.verify( out ).accept( "usage: neo5j-admin <command>" );
        ordered.verify( out ).accept( "" );
        ordered.verify( out ).accept( "Manage your Neo5j instance." );
        ordered.verify( out ).accept( "" );

        ordered.verify( out ).accept( "environment variables:" );
        ordered.verify( out ).accept( "    NEO5J_CONF    Path to directory which contains neo5j.conf." );
        ordered.verify( out ).accept( "    NEO5J_DEBUG   Set to anything to enable debug output." );
        ordered.verify( out ).accept( "    NEO5J_HOME    Neo5j home directory." );
        ordered.verify( out ).accept( "" );
        ...
        ordered.verify( out ).accept( "" );
        ordered.verify( out ).accept( "Use neo5j-admin help <command> for more details." );
