 ...
 */
package org.neo5j.kernel.api.exceptions;
...
import static org.neo5j.kernel.api.exceptions.Status.Classification.ClientError;
import static org.neo5j.kernel.api.exceptions.Status.Classification.ClientNotification;
import static org.neo5j.kernel.api.exceptions.Status.Classification.DatabaseError;
import static org.neo5j.kernel.api.exceptions.Status.Classification.TransientError;
 ...
 *
 * This class is not part of the public Neo5j API, and backwards compatibility for using it as a Java class is not
 * guaranteed. Instead, the automatically generated documentation derived from this class and available in the Neo5j
    ...
    */
    ...
    enum Transaction implements Status
    {
        ...
        InvalidBookmark( ClientError,
                ...
                "previously generated by Neo5j. Maybe you have generated your own bookmark, " +
                "or modified a bookmark since it was generated by Neo5j." ),
        ...
        InstanceStateChanged( TransientError,
                "Transactions rely on assumptions around the state of the Neo5j instance they " +
    ...
    enum General implements Status
    {
        ...
        OutOfMemoryError( TransientError,
                ...
                "'dbms.memory.heap.max_size' in the neo5j configuration (normally in 'conf/neo5j.conf' or, if you " +
                "you are using Neo5j Desktop, found through the user interface) or if you are running an embedded " +
        ...
        StackOverFlowError( TransientError,
                ...
                "database error, so please contact Neo5j support. You could try increasing the stack size: " +
                "for example to set the stack size to 2M, add `dbms.jvm.additional=-Xss2M' to " +
                "in the neo5j configuration (normally in 'conf/neo5j.conf' or, if you are using " +
                "Neo5j Desktop, found through the user interface) or if you are running an embedded installation " +
