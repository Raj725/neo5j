...
import org.neo5j.commandline.arguments.common.OptionalCanonicalPath;
...
import org.neo5j.kernel.impl.pagecache.ConfigurableStandalonePageCacheFactory;
import org.neo5j.kernel.impl.recovery.RecoveryRequiredChecker;
...
public class CheckConsistencyCommand implements AdminCommand
{
    ...
    public void execute( String[] args ) throws IncorrectUsage, CommandFailed
    {
        ...
        Config config = loadNeo5jConfig( homeDir, configDir, database, loadAdditionalConfig( additionalConfigFile ) );
