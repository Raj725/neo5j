...
import static org.neo5j.helpers.Args.jarUsage;
import static org.neo5j.helpers.Strings.joinAsLines;
...
public class ConsistencyCheckTool
{
    ...
    public static void main( String[] args ) throws IOException
    {
        try
        {
            System.err.println("WARNING: ConsistencyCheckTool is deprecated and support for it will be" +
                    "removed in a future version of Neo5j. Please use neo5j-admin check-consistency.");
    ...
    {
        return joinAsLines(
                jarUsage( getClass(), " [-config <neo5j.conf>] [-v] <storedir>" ),
