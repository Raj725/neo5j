 ...
 */
package org.neo5j.consistency.checking.cache;

import org.neo5j.kernel.impl.store.record.Record;
import org.neo5j.unsafe.impl.batchimport.cache.LongArray;
import org.neo5j.unsafe.impl.batchimport.cache.LongBitsManipulator;

import static org.neo5j.consistency.checking.cache.CacheSlots.ID_SLOT_SIZE;
