...
import org.neo5j.consistency.checking.cache.DefaultCacheAccess;
import org.neo5j.consistency.report.ConsistencyReport;
import org.neo5j.consistency.report.ConsistencySummaryStatistics;
import org.neo5j.consistency.report.InconsistencyLogger;
import org.neo5j.consistency.report.InconsistencyReport;
import org.neo5j.consistency.report.PendingReferenceCheck;
...
import static org.neo5j.consistency.report.ConsistencyReporter.NO_MONITOR;
...
public class ExecutionOrderIntegrationTest
{
    ...
    public final GraphStoreFixture fixture = new GraphStoreFixture( getRecordFormatName() )
    {
        ...
        protected void generateInitialData( GraphDatabaseService graphDb )
        {
            ...
            try ( org.neo5j.graphdb.Transaction tx = graphDb.beginTx() )
            {
