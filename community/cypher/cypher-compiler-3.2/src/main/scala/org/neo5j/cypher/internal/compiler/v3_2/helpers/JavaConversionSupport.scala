...
import org.neo5j.collection.primitive.{PrimitiveIntIterator, PrimitiveLongIterator}
    ...
    private def fetchNext(): Option[T] = {
      if (!hasMore())
        ...
        try {
          ...
          case _: org.neo5j.kernel.api.exceptions.EntityNotFoundException => fetchNext()
