...
import org.neo5j.cypher.internal.compiler.v3_2.planner.logical.cardinality._
...
import org.neo5j.cypher.internal.frontend.v3_2.ast.{LabelName, RelTypeName}
import org.neo5j.cypher.internal.frontend.v3_2._
import org.neo5j.cypher.internal.ir.v3_2.{Selections, _}
...
case class PatternSelectivityCalculator(stats: GraphStatistics, combiner: SelectivityCombiner) extends Pattern2Selectivity {
  ...
  import org.neo5j.cypher.internal.compiler.v3_2.planner.logical.cardinality.assumeIndependence.PatternSelectivityCalculator._
