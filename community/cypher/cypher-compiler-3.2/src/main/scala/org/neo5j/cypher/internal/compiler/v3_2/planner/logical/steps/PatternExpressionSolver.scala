...
import org.neo5j.cypher.internal.compiler.v3_2.planner.logical.{LogicalPlanningContext, patternExpressionRewriter}
import org.neo5j.cypher.internal.frontend.v3_2.Rewritable._
import org.neo5j.cypher.internal.frontend.v3_2.ast._
import org.neo5j.cypher.internal.frontend.v3_2.ast.functions.Exists
import org.neo5j.cypher.internal.frontend.v3_2.ast.rewriters.{PatternExpressionPatternElementNamer, projectNamedPaths}
import org.neo5j.cypher.internal.frontend.v3_2.helpers.{FreshIdNameGenerator, UnNamedNameGenerator}
import org.neo5j.cypher.internal.frontend.v3_2.{Rewriter, ast, topDown}
...
object PatternExpressionSolver {
  def solvePatternExpressions(availableSymbols: Set[IdName], context: LogicalPlanningContext,
    ...
    def extractQG(source: LogicalPlan, namedExpr: PatternExpression): QueryGraph = {
      import org.neo5j.cypher.internal.ir.v3_2.helpers.ExpressionConverters._
