...
import org.neo5j.cypher.internal.compiler.v3_2.{CRS, GeographicPoint}
import org.neo5j.cypher.internal.frontend.v3_2.test_helpers.CypherFunSuite
import org.neo5j.graphdb.spatial.{CRS => JavaCRS, Coordinate, Point}
...
class EquivalentTest extends CypherFunSuite {
  ...
  shouldMatch(Math.PI, Math.PI.toFloat)
  shouldMatch(Math.PI.toFloat, Math.PI)
