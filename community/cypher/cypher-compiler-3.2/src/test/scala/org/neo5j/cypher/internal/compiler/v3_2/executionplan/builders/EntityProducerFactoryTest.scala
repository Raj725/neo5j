...
import org.neo5j.cypher.internal.compiler.v3_2.{ExecutionContext, IndexDescriptor}
import org.neo5j.cypher.internal.frontend.v3_2.IndexHintException
...
class EntityProducerFactoryTest extends CypherFunSuite {
  ...
  test("should translate values to neo5j") {
    //GIVEN
    val labelName = "Label"
