...
import org.neo5j.cypher.internal.compiler.v3_2.phases.CompilationState
import org.neo5j.cypher.internal.compiler.v3_2.test_helpers.ContextHelper
import org.neo5j.cypher.internal.compiler.v3_2.IDPPlannerName
import org.neo5j.cypher.internal.frontend.v3_2.ast.Query
import org.neo5j.cypher.internal.frontend.v3_2.notification.{InternalNotification, MissingLabelNotification, MissingPropertyNameNotification, MissingRelTypeNotification}
import org.neo5j.cypher.internal.frontend.v3_2.phases.RecordingNotificationLogger
import org.neo5j.cypher.internal.frontend.v3_2.test_helpers.CypherFunSuite
import org.neo5j.cypher.internal.frontend.v3_2.{InputPosition, LabelId, PropertyKeyId, RelTypeId, SemanticTable}
...
class CheckForUnresolvedTokensTest extends CypherFunSuite with AstRewritingTestSupport {
  ...
  private def checkForTokens(ast: Query, semanticTable: SemanticTable): Set[InternalNotification] = {
    ...
    val compilationState = CompilationState(queryText = "apa", startPosition = None, plannerName = IDPPlannerName, maybeStatement = Some(ast), maybeSemanticTable = Some(semanticTable))
