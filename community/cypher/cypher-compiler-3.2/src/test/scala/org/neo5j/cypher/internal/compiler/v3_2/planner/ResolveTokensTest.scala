...
import org.neo5j.cypher.internal.frontend.v3_2.ast.{Match, Query, SingleQuery, Where, _}
import org.neo5j.cypher.internal.frontend.v3_2.test_helpers.CypherFunSuite

class ResolveTokensTest extends CypherFunSuite {

  import org.neo5j.cypher.internal.compiler.v3_2.parser.ParserFixture._
      ...
      SingleQuery(Seq(
        Match(
          ...
          Pattern(Seq(EveryPath(RelationshipChain(
            ...
            RelationshipPattern(None, Seq(relTypeToken), None, None, SemanticDirection.OUTGOING),
            NodePattern(None, Seq(), None)
          )))),
          Seq(),
          None
