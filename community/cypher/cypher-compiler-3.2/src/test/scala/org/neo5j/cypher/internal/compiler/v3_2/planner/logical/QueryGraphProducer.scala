...
import org.neo5j.cypher.internal.frontend.v3_2.ast.rewriters._
import org.neo5j.cypher.internal.frontend.v3_2.ast.{Query, Statement}
import org.neo5j.cypher.internal.frontend.v3_2.phases.LateAstRewriting
import org.neo5j.cypher.internal.frontend.v3_2.{SemanticChecker, SemanticTable, inSequence}
import org.neo5j.cypher.internal.ir.v3_2.{PlannerQuery, QueryGraph}
...
trait QueryGraphProducer extends MockitoSugar {
  ...
  import org.neo5j.cypher.internal.compiler.v3_2.ast.convert.plannerQuery.StatementConverters._
