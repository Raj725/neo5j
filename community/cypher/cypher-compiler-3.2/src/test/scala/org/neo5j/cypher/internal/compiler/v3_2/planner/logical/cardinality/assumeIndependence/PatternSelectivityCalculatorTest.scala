 ...
 */
package org.neo5j.cypher.internal.compiler.v3_2.planner.logical.cardinality.assumeIndependence

import org.mockito.Matchers.any
import org.mockito.Mockito._
import org.mockito.invocation.InvocationOnMock
import org.mockito.stubbing.Answer
import org.neo5j.cypher.internal.compiler.v3_2.planner.logical.cardinality.IndependenceCombiner
import org.neo5j.cypher.internal.compiler.v3_2.planner.LogicalPlanConstructionTestSupport
import org.neo5j.cypher.internal.compiler.v3_2.spi.GraphStatistics
import org.neo5j.cypher.internal.frontend.v3_2.ast.{AstConstructionTestSupport, HasLabels, LabelName}
import org.neo5j.cypher.internal.frontend.v3_2.test_helpers.CypherFunSuite
import org.neo5j.cypher.internal.frontend.v3_2.{LabelId, SemanticDirection, SemanticTable}
import org.neo5j.cypher.internal.ir.v3_2.{VarPatternLength, _}
