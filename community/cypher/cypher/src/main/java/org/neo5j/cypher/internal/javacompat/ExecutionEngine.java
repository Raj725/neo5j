...
import org.neo5j.cypher.internal.CompatibilityFactory;
...
{
    private org.neo5j.cypher.internal.ExecutionEngine inner;
    ...
    {
        inner = new org.neo5j.cypher.internal.ExecutionEngine( queryService, logProvider, compatibilityFactory );
    }
