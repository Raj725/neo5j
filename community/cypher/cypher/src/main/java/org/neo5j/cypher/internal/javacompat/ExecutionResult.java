...
import org.neo5j.graphdb.QueryExecutionType.QueryType;
 ...
 * The result objects could be {@link org.neo5j.graphdb.Node Nodes},
 * {@link org.neo5j.graphdb.Relationship Relationships} or java primitives.
 *
 *
...
{
    private final org.neo5j.cypher.internal.ExecutionResult inner;
     ...
     * returned from calling {@link QueryExecutionEngine#executeQuery(String, Map, org.neo5j.kernel.impl.query.TransactionalContext)}.
     *
     * @param   projection Execution result projection to use.
     */
    public ExecutionResult( org.neo5j.cypher.internal.ExecutionResult projection )
    {
     ...
     * either be fully exhausted, or the {@link org.neo5j.graphdb.ResourceIterator#close() close()} method must be
     * called.</b></p>
     *
     ...
     * @throws org.neo5j.graphdb.NotFoundException when the column name does not appear in the original query
     */
    @Override
