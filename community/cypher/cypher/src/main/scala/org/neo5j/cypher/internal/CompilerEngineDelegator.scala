...
import org.neo5j.cypher.internal.compatibility.v3_2.exceptionHandler
import org.neo5j.cypher.internal.compiler.v3_2._
import org.neo5j.cypher.internal.frontend.v3_2
import org.neo5j.cypher.internal.frontend.v3_2.InputPosition
import org.neo5j.cypher.internal.frontend.v3_2.helpers.fixedPoint
import org.neo5j.cypher.internal.frontend.v3_2.phases.CompilationPhaseTracer
import org.neo5j.cypher.{InvalidArgumentException, SyntaxException, _}
import org.neo5j.graphdb.factory.GraphDatabaseSettings
import org.neo5j.graphdb.impl.notification.NotificationCode.{CREATE_UNIQUE_UNAVAILABLE_FALLBACK, RULE_PLANNER_UNAVAILABLE_FALLBACK}
...
import org.neo5j.logging.{Log, LogProvider}
...
class CompilerEngineDelegator(graph: GraphDatabaseQueryService,
  ...
  import org.neo5j.cypher.internal.CompilerEngineDelegator._
  ...
  def parseQuery(preParsedQuery: PreParsedQuery, tracer: CompilationPhaseTracer): ParsedQuery = {
    import org.neo5j.cypher.internal.compatibility.v2_3.helpers._
    ...
    var preParsingNotifications: Set[org.neo5j.graphdb.Notification] = Set.empty
  ...
  private def convertInputPosition(offset: InputPosition) =
    new org.neo5j.graphdb.InputPosition(offset.offset, offset.line, offset.column)
