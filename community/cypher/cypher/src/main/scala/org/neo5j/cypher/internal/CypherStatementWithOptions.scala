...
import org.neo5j.cypher.{CypherPlanner, CypherRuntime, CypherUpdateStrategy, CypherVersion, InvalidArgumentException}
      ...
      case option :: tail =>
        option match {
          ...
          case p: PlannerPreParserOption if p.name == GreedyPlannerOption.name =>
            throw new InvalidArgumentException("The greedy planner has been removed in Neo5j 3.1. Please use the cost planner instead.")
