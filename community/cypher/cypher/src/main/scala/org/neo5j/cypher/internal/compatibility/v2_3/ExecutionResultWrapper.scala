...
import org.neo5j.cypher.internal.compiler.v2_3.executionplan.InternalExecutionResult
import org.neo5j.cypher.internal.compiler.v2_3.planDescription.InternalPlanDescription
import org.neo5j.cypher.internal.compiler.v2_3.planDescription.InternalPlanDescription.Arguments._
import org.neo5j.cypher.internal.compiler.v2_3.{PlannerName, _}
import org.neo5j.cypher.internal.frontend.v2_3.notification.{InternalNotification, LegacyPlannerNotification, PlannerUnsupportedNotification, RuntimeUnsupportedNotification, _}
import org.neo5j.cypher.internal.frontend.v2_3.{InputPosition => InternalInputPosition}
...
import org.neo5j.graphdb.{InputPosition, QueryExecutionType}
...
class ExecutionResultWrapper(val inner: InternalExecutionResult, val planner: PlannerName, val runtime: RuntimeName,
  ...
  def executionPlanDescription(): org.neo5j.cypher.internal.PlanDescription =
    convert(
  ...
  private def convert(i: InternalPlanDescription): org.neo5j.cypher.internal.PlanDescription = exceptionHandler.runSafely {
