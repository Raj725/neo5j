...
import org.neo5j.cypher.internal.compatibility.v3_1.helpers._
import org.neo5j.cypher.internal.compiler.v3_1
import org.neo5j.cypher.internal.compiler.v3_1.executionplan.{ExecutionPlan => ExecutionPlan_v3_1}
import org.neo5j.cypher.internal.compiler.v3_1.tracing.rewriters.RewriterStepSequencer
import org.neo5j.cypher.internal.compiler.v3_1.{CompilationPhaseTracer, InfoLogger, ExplainMode => ExplainModev3_1, NormalMode => NormalModev3_1, ProfileMode => ProfileModev3_1, _}
import org.neo5j.cypher.internal.spi.v3_1.TransactionBoundQueryContext.IndexSearchMonitor
import org.neo5j.cypher.internal.spi.v3_1.{TransactionalContextWrapper => TransactionalContextWrapperV3_1, _}
import org.neo5j.cypher.internal.spi.v3_2.{TransactionalContextWrapper => TransactionalContextWrapperV3_2}
import org.neo5j.cypher.internal.{frontend, _}
...
trait Compatibility {
  ...
  protected val rewriterSequencer: (String) => RewriterStepSequencer = {
    import org.neo5j.cypher.internal.compiler.v3_1.tracing.rewriters.RewriterStepSequencer._
  ...
  def produceParsedQuery(preParsedQuery: PreParsedQuery, tracer: CompilationPhaseTracer,
                         preParsingNotifications: Set[org.neo5j.graphdb.Notification]): ParsedQuery = {
  ...
  class ExecutionPlanWrapper(inner: ExecutionPlan_v3_1, preParsingNotifications: Set[org.neo5j.graphdb.Notification]) extends ExecutionPlan {
