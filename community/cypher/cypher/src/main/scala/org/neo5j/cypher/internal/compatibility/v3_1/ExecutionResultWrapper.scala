...
import org.neo5j.cypher.internal.compiler.v3_1.executionplan._
import org.neo5j.cypher.internal.compiler.v3_1.planDescription.InternalPlanDescription
import org.neo5j.cypher.internal.compiler.v3_1.planDescription.InternalPlanDescription.Arguments._
import org.neo5j.cypher.internal.compiler.v3_1.spi.{InternalResultRow, InternalResultVisitor}
import org.neo5j.cypher.internal.compiler.v3_1.{PlannerName, ExplainMode => ExplainModev3_1, NormalMode => NormalModev3_1, ProfileMode => ProfileModev3_1, _}
import org.neo5j.cypher.internal.frontend.v3_1.notification.{DeprecatedPlannerNotification, InternalNotification, PlannerUnsupportedNotification, RuntimeUnsupportedNotification, _}
import org.neo5j.graphdb
import org.neo5j.graphdb.Result.{ResultRow, ResultVisitor}
import org.neo5j.graphdb.impl.notification.{NotificationCode, NotificationDetail}

import scala.collection.JavaConverters._

class ExecutionResultWrapper(val inner: InternalExecutionResult, val planner: PlannerName, val runtime: RuntimeName,
                             preParsingNotification: Set[org.neo5j.graphdb.Notification])
  ...
  override def executionPlanDescription(): org.neo5j.cypher.internal.PlanDescription =
    convert(
  ...
  private def convert(i: InternalPlanDescription): org.neo5j.cypher.internal.PlanDescription =
    CompatibilityPlanDescription(i, CypherVersion.v3_1, planner, runtime)
