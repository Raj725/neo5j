...
import org.neo5j.cypher.internal.compatibility.{ExceptionHandler, _}
import org.neo5j.cypher.internal.frontend.v3_1.spi.MapToPublicExceptions
import org.neo5j.cypher.internal.frontend.v3_1.{CypherException => InternalCypherException}
...
object exceptionHandler extends MapToPublicExceptions[CypherException] {
  ...
  def shortestPathCommonEndNodesForbiddenException(message: String, cause: Throwable): CypherException =
