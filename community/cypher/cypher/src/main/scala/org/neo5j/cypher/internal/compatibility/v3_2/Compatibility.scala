 ...
 */
package org.neo5j.cypher.internal.compatibility.v3_2

import org.neo5j.cypher.internal._
import org.neo5j.cypher.internal.compatibility._
import org.neo5j.cypher.internal.compiler.v3_2
import org.neo5j.cypher.internal.compiler.v3_2.executionplan.{LegacyNodeIndexUsage, LegacyRelationshipIndexUsage, SchemaIndexScanUsage, SchemaIndexSeekUsage, ExecutionPlan => ExecutionPlan_v3_2}
import org.neo5j.cypher.internal.compiler.v3_2.phases.CompilerContext
import org.neo5j.cypher.internal.compiler.v3_2.{InfoLogger, ExplainMode => ExplainModev3_2, NormalMode => NormalModev3_2, ProfileMode => ProfileModev3_2}
import org.neo5j.cypher.internal.frontend.v3_2.helpers.rewriting.RewriterStepSequencer
import org.neo5j.cypher.internal.frontend.v3_2.phases.{CompilationPhaseTracer, RecordingNotificationLogger}
import org.neo5j.cypher.internal.spi.v3_2.TransactionBoundQueryContext.IndexSearchMonitor
import org.neo5j.cypher.internal.spi.v3_2._
import org.neo5j.kernel.api.KernelAPI
import org.neo5j.kernel.api.query.IndexUsage.{legacyIndexUsage, schemaIndexUsage}
import org.neo5j.kernel.api.query.PlannerInfo
...
trait Compatibility[C <: CompilerContext] {
  ...
  class ExecutionPlanWrapper(inner: ExecutionPlan_v3_2, preParsingNotifications: Set[org.neo5j.graphdb.Notification])
