...
import org.neo5j.cypher.internal.compiler.v3_2.RuntimeName
import org.neo5j.cypher.internal.compiler.v3_2.planDescription.InternalPlanDescription.Arguments.{DbHits, PageCacheHits, PageCacheMisses, Rows}
import org.neo5j.cypher.internal.compiler.v3_2.planDescription.{Argument, InternalPlanDescription, PlanDescriptionArgumentSerializer}
import org.neo5j.cypher.internal.frontend.v3_2.PlannerName
import org.neo5j.cypher.internal.javacompat.{PlanDescription, ProfilerStatistics}
import org.neo5j.cypher.{CypherVersion, InternalException}
...
case class CompatibilityPlanDescription(inner: InternalPlanDescription, version: CypherVersion,
  ...
  extends org.neo5j.cypher.internal.PlanDescription {
  ...
  def asJava(in: org.neo5j.cypher.internal.PlanDescription): PlanDescription = new PlanDescription {
