...
import org.neo5j.cypher.internal.compiler.v3_2.planDescription.InternalPlanDescription.Arguments._
import org.neo5j.cypher.internal.compiler.v3_2.spi.{InternalResultRow, InternalResultVisitor}
import org.neo5j.cypher.internal.compiler.v3_2.{ExplainMode => ExplainModev3_2, NormalMode => NormalModev3_2, ProfileMode => ProfileModev3_2, _}
import org.neo5j.cypher.internal.frontend.v3_2.PlannerName
import org.neo5j.cypher.internal.frontend.v3_2.notification.{DeprecatedPlannerNotification, InternalNotification, PlannerUnsupportedNotification, RuntimeUnsupportedNotification, _}
...
class ExecutionResultWrapper(val inner: InternalExecutionResult, val planner: PlannerName, val runtime: RuntimeName,
                             preParsingNotifications: Set[org.neo5j.graphdb.Notification]) extends ExecutionResult {
