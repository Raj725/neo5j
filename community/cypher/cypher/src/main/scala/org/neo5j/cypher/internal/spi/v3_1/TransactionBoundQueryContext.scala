...
import org.neo5j.cypher.internal.compiler.v3_1.MinMaxOrdering.{BY_NUMBER, BY_STRING, BY_VALUE}
import org.neo5j.cypher.internal.compiler.v3_1._
import org.neo5j.cypher.internal.compiler.v3_1.ast.convert.commands.DirectionConverter.toGraphDb
import org.neo5j.cypher.internal.compiler.v3_1.commands.expressions
import org.neo5j.cypher.internal.compiler.v3_1.commands.expressions.{KernelPredicate, OnlyDirectionExpander, TypeAndDirectionExpander}
import org.neo5j.cypher.internal.compiler.v3_1.helpers.JavaConversionSupport
import org.neo5j.cypher.internal.compiler.v3_1.helpers.JavaConversionSupport._
import org.neo5j.cypher.internal.compiler.v3_1.pipes.matching.PatternNode
import org.neo5j.cypher.internal.compiler.v3_1.spi._
import org.neo5j.cypher.internal.frontend.v3_1.{Bound, EntityNotFoundException, FailedIndexException, SemanticDirection}
import org.neo5j.cypher.internal.spi.BeansAPIRelationshipIterator
import org.neo5j.cypher.internal.spi.v3_1.TransactionBoundQueryContext.IndexSearchMonitor
import org.neo5j.cypher.javacompat.internal.GraphDatabaseCypherService
import org.neo5j.cypher.{InternalException, internal}
...
import org.neo5j.kernel.api.proc.{QualifiedName => KernelQualifiedName}
import org.neo5j.kernel.api.schema_new.IndexQuery
import org.neo5j.kernel.api.schema_new.SchemaDescriptorFactory
import org.neo5j.kernel.api.schema_new.constaints.{ConstraintBoundary, ConstraintDescriptor, ConstraintDescriptorFactory, UniquenessConstraintDescriptor}
...
final class TransactionBoundQueryContext(txContext: TransactionalContextWrapper)(implicit indexSearchMonitor: IndexSearchMonitor)
  ...
  override def getLabelsForNode(node: Long) = try {
    ...
    case e: org.neo5j.kernel.api.exceptions.EntityNotFoundException =>
