...
import org.neo5j.cypher.internal.compiler.v3_2.{IndexDescriptor => CypherIndexDescriptor}
import org.neo5j.kernel.api.schema_new.{LabelSchemaDescriptor, SchemaDescriptorFactory}
