...
import org.neo5j.cypher.internal.compiler.v3_2.MinMaxOrdering.{BY_NUMBER, BY_STRING, BY_VALUE}
...
import org.neo5j.cypher.internal.compiler.v3_2.commands.expressions
import org.neo5j.cypher.internal.compiler.v3_2.commands.expressions.{KernelPredicate, OnlyDirectionExpander, TypeAndDirectionExpander, UserDefinedAggregator}
import org.neo5j.cypher.internal.compiler.v3_2.helpers.JavaConversionSupport
import org.neo5j.cypher.internal.compiler.v3_2.helpers.JavaConversionSupport._
import org.neo5j.cypher.internal.compiler.v3_2.pipes.matching.PatternNode
import org.neo5j.cypher.internal.compiler.v3_2.spi._
import org.neo5j.cypher.internal.frontend.v3_2._
import org.neo5j.cypher.internal.spi.BeansAPIRelationshipIterator
import org.neo5j.cypher.internal.spi.v3_2.TransactionBoundQueryContext.IndexSearchMonitor
...
import org.neo5j.kernel.api.proc.CallableUserAggregationFunction.Aggregator
...
import org.neo5j.kernel.api.schema_new.{IndexQuery, SchemaDescriptorFactory}
