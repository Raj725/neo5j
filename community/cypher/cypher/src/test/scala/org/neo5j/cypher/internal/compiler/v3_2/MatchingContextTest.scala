...
import org.neo5j.cypher.GraphDatabaseFunSuite
import org.neo5j.cypher.internal.compiler.v3_2.commands._
import org.neo5j.cypher.internal.compiler.v3_2.commands.expressions.{Variable, Literal, Property}
import org.neo5j.cypher.internal.compiler.v3_2.commands.predicates.{Equals, Predicate}
import org.neo5j.cypher.internal.compiler.v3_2.commands.values.TokenType.PropertyKey
import org.neo5j.cypher.internal.compiler.v3_2.executionplan.builders.PatternGraphBuilder
import org.neo5j.cypher.internal.compiler.v3_2.pipes.matching.MatchingContext
import org.neo5j.cypher.internal.compiler.v3_2.symbols.SymbolTable
