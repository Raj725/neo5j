...
import org.neo5j.cypher.internal.compiler.v3_2.commands.SingleQueryExpression
import org.neo5j.cypher.internal.compiler.v3_2.commands.expressions.{Literal, Property, Variable}
import org.neo5j.cypher.internal.compiler.v3_2.commands.predicates.Equals
import org.neo5j.cypher.internal.compiler.v3_2.commands.values.TokenType.{Label => _, _}
...
import org.neo5j.cypher.internal.frontend.v3_2.{LabelId, PropertyKeyId, SemanticDirection, ast}
import org.neo5j.cypher.internal.spi.v3_2.TransactionBoundQueryContext.IndexSearchMonitor
import org.neo5j.cypher.internal.spi.v3_2.{TransactionBoundPlanContext, TransactionBoundQueryContext, TransactionalContextWrapper}
...
class ActualCostCalculationTest extends CypherFunSuite {
  ...
  private def transactionContext(graph: GraphDatabaseQueryService, tx: InternalTransaction) = {
    val contextFactory = Neo5jTransactionalContextFactory.create(graph, new PropertyContainerLocker)
