 ...
 */
package org.neo5j.cypher.internal.helpers

import java.util
import java.util.concurrent.TimeUnit

import org.neo5j.cypher.internal.compiler.v3_2.helpers.RuntimeJavaValueConverter
import org.neo5j.cypher.internal.isGraphKernelResultValue
import org.neo5j.cypher.javacompat.internal.GraphDatabaseCypherService
import org.neo5j.graphdb.Label._
...
import org.neo5j.kernel.impl.query._
...
trait GraphIcing {
  ...
  implicit class RichGraphDatabaseQueryService(graphService: GraphDatabaseQueryService) {
    ...
    private def createTransactionalContext(txType: Type, queryText: String, params: Map[String, Any] = Map.empty): (InternalTransaction, TransactionalContext) = {
      ...
      val contextFactory = Neo5jTransactionalContextFactory.create(graphService,
        locker)
