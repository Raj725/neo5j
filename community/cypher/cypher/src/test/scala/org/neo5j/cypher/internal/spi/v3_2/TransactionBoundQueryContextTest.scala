...
import org.neo5j.cypher.internal.compiler.v3_2.helpers.DynamicIterable
...
import org.neo5j.kernel.api.security.{AnonymousContext, SecurityContext}
import org.neo5j.kernel.impl.api.{KernelStatement, KernelTransactionImplementation, StatementOperationParts}
...
import org.neo5j.kernel.impl.query.{Neo5jTransactionalContext, Neo5jTransactionalContextFactory}
...
class TransactionBoundQueryContextTest extends CypherFunSuite {
  ...
  test("should mark transaction successful if successful") {
    ...
    val tc = new Neo5jTransactionalContext(graph, null, null, null, locker, outerTx, statement, null)
