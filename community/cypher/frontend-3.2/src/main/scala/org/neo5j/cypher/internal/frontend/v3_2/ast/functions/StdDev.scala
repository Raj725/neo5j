...
import org.neo5j.cypher.internal.frontend.v3_2.ast.{AggregatingFunction, ExpressionSignature, SimpleTypedFunction}
import org.neo5j.cypher.internal.frontend.v3_2.symbols._

case object StdDev extends AggregatingFunction with SimpleTypedFunction {
  def name = "stdev"
