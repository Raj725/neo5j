...
public class DumpCommand implements AdminCommand
{
    ...
    public void execute( String[] args ) throws IncorrectUsage, CommandFailed
    {
        ...
        {
            throw new CommandFailed( "the database is in use -- stop Neo5j and try again", e );
        }
        catch ( IOException e )
        {
            wrapIOException( e );
        ...
        catch ( CannotWriteException e )
        {
            throw new CommandFailed(
                    "you do not have permission to dump the database -- is Neo5j running as a " + "different user?",
                    e );
        }
    }
