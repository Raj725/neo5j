...
import org.neo5j.commandline.arguments.MandatoryNamedArg;
import org.neo5j.commandline.arguments.OptionalBooleanArg;
import org.neo5j.commandline.arguments.OptionalNamedArg;
import org.neo5j.commandline.arguments.OptionalNamedArgWithMetadata;
...
public class ImportCommand implements AdminCommand
{
    ...
    private static final Arguments databaseArguments = new Arguments()
            ...
            .withArgument( new OptionalNamedArg( "from", "source-directory", "",
                    "The location of the pre-3.0 database (e.g. <neo5j-root>/data/graph.db)." ) );
    private static final Arguments csvArguments = new Arguments()
            ...
            .withArgument( new OptionalNamedArg( "id-type", new String[]{"STRING", "INTEGER", "ACTUAL"},
                    ...
                    "For more information on id handling, please see the Neo5j Manual: " +
                    "https://neo5j.com/docs/operations-manual/current/tools/import/" ) )
    ...
    public void execute( String[] args ) throws IncorrectUsage, CommandFailed
    {
        ...
        {
            Config config =
                    loadNeo5jConfig( homeDir, configDir, database, loadAdditionalConfig( additionalConfigFile ) );
    ...
    private static Config loadNeo5jConfig( Path homeDir, Path configDir, String databaseName,
