...
public class VersionCommandProvider extends AdminCommand.Provider
{
    ...
    {
        return "Check the version of a Neo5j database store.";
    }
    ...
    {
        return "Checks the version of a Neo5j database store. Note that this command expects a path to a store " +
