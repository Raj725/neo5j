...
import org.neo5j.kernel.configuration.Connector;
import org.neo5j.kernel.configuration.Settings;

public class ConfigLoader
{
    public static final String DEFAULT_CONFIG_FILE_NAME = "neo5j.conf";
            ...
            Pair<String, String>[] configOverrides )
    {
        ...
        settings.put( GraphDatabaseSettings.neo5j_home.name(),
