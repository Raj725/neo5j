...
import static org.neo5j.dbms.archive.TestUtils.withPermissions;
...
public class DumpCommandTest
{
    ...
    public void shouldReportAHelpfulErrorIfWeDontHaveWritePermissionsForLock() throws Exception
    {
              ...
              StoreLocker storeLocker = new StoreLocker( fileSystem ) )
        {
            ...
            {
                assertThat( e.getMessage(), equalTo( "you do not have permission to dump the database -- is Neo5j " +
    ...
    public void shouldPrintNiceHelp() throws Exception
    {
        try ( ByteArrayOutputStream baos = new ByteArrayOutputStream() )
        {
            ...
            assertEquals( String.format( "usage: neo5j-admin dump [--database=<name>] --to=<destination-path>%n" +
                            "%n" +
                            ...
                            "that is mounted in a running Neo5j server.%n" +
                            "%n" +
                            "options:%n" +
