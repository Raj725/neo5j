...
import org.neo5j.commandline.admin.NullOutsideWorld;
import org.neo5j.commandline.admin.OutsideWorld;
import org.neo5j.commandline.admin.RealOutsideWorld;
...
public class ImportCommandTest
{
    ...
    public void shouldPrintNiceHelp() throws Throwable
    {
        try ( ByteArrayOutputStream baos = new ByteArrayOutputStream() )
        {
            ...
            assertEquals( String.format( "usage: neo5j-admin import [--mode=csv] [--database=<name>]%n" +
                            ...
                            "usage: neo5j-admin import --mode=database [--database=<name>]%n" +
                            "                          [--additional-config=<config-file-path>]%n" +
                            ...
                            "  --from=<source-directory>%n" +
                            "      The location of the pre-3.0 database (e.g. <neo5j-root>/data/graph.db).%n" +
                            "      [default:]%n" +
                            "  --report-file=<filename>%n" +
                            ...
                            "      For more information on id handling, please see the Neo5j Manual:%n" +
                            "      https://neo5j.com/docs/operations-manual/current/tools/import/%n" +
                            "      [default:STRING]%n" +
                            "  --input-encoding=<character-set>%n" +
