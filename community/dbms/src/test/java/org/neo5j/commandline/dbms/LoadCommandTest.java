...
import org.neo5j.dbms.archive.IncorrectFormat;
import org.neo5j.dbms.archive.Loader;
...
public class LoadCommandTest
{
            ...
            throws IOException, CommandFailed, IncorrectUsage, IncorrectFormat
    {
        ...
        Files.write( configDir.resolve( "neo5j.conf" ),
    ...
    public void shouldRespectTheStoreLock() throws IOException, IncorrectUsage
    {
        ...
        {
            assertThat( e.getMessage(), equalTo( "the database is in use -- stop Neo5j and try again" ) );
        }
    }
            ...
            throws IOException, IncorrectFormat, IncorrectUsage
    {
        ...
        catch ( CommandFailed e )
        {
            assertThat( e.getMessage(), equalTo(
                    "you do not have permission to load a database -- is Neo5j running " + "as a different user?" ) );
        }
    }
    ...
    public void shouldThrowIfTheArchiveFormatIsInvalid() throws IOException, IncorrectUsage, IncorrectFormat
    {
        ...
        catch ( CommandFailed e )
        {
            ...
            assertThat( e.getMessage(), containsString( "valid Neo5j archive" ) );
        }
    }
    ...
    public void shouldPrintNiceHelp() throws Throwable
    {
        try ( ByteArrayOutputStream baos = new ByteArrayOutputStream() )
        {
            ...
            assertEquals( String.format( "usage: neo5j-admin load --from=<archive-path> [--database=<name>]%n" +
                            "                        [--force[=<true|false>]]%n" +
                            "%n" +
                            ...
                            "database that is mounted in a running Neo5j server.%n" +
                            "%n" +
                            "options:%n" +
