...
public class VersionCommandTest
{
    ...
    public void shouldPrintNiceHelp() throws Exception
    {
        try ( ByteArrayOutputStream baos = new ByteArrayOutputStream() )
        {
            ...
            assertEquals( String.format( "usage: neo5j-admin version --store=<path-to-dir>%n" +
                            "%n" +
                            "Checks the version of a Neo5j database store. Note that this command expects a%n" +
    ...
    public void readsLatestStoreVersionCorrectly() throws Exception
    {
        ...
        assertEquals(
                Arrays.asList(
                        ...
                        String.format( "Current version:         %s", Version.getNeo5jVersion() ) ),
