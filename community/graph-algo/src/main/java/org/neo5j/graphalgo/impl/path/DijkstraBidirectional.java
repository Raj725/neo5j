 ...
 */
package org.neo5j.graphalgo.impl.path;
...
import org.neo5j.graphalgo.impl.util.DijkstraBranchCollisionDetector;
import org.neo5j.graphalgo.impl.util.DijkstraSelectorFactory;
import org.neo5j.graphalgo.impl.util.PathInterest;
import org.neo5j.graphalgo.impl.util.PathInterestFactory;
import org.neo5j.graphalgo.impl.util.TopFetchingWeightedPathIterator;
...
import org.neo5j.graphdb.traversal.BranchCollisionDetector;
import org.neo5j.graphdb.traversal.BranchCollisionPolicy;
import org.neo5j.graphdb.traversal.BranchState;
import org.neo5j.graphdb.traversal.Evaluation;
import org.neo5j.graphdb.traversal.Evaluator;
import org.neo5j.graphdb.traversal.Evaluators;
import org.neo5j.graphdb.traversal.InitialBranchState;
import org.neo5j.graphdb.traversal.PathEvaluator;
import org.neo5j.graphdb.traversal.TraversalDescription;
import org.neo5j.graphdb.traversal.TraversalMetadata;
import org.neo5j.graphdb.traversal.Traverser;
import org.neo5j.graphdb.traversal.Uniqueness;
import org.neo5j.kernel.impl.util.NoneStrictMath;

import static org.neo5j.graphdb.Direction.OUTGOING;
import static org.neo5j.helpers.collection.Iterators.firstOrNull;
 ...
 * but in the reverse direction ( {@link org.neo5j.graphdb.Direction#reverse()} ) from the
 * end node. This doesn't affect {@link org.neo5j.graphdb.Direction#BOTH}.
 *
