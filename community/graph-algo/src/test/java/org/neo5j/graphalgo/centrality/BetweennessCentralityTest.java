...
import org.neo5j.graphalgo.impl.shortestpath.Util;
import org.neo5j.graphalgo.impl.shortestpath.Util.PathCounter;
...
public class BetweennessCentralityTest extends Neo5jAlgoTestCase
{
    ...
    {
        DependencyTest( SingleSourceShortestPath<Double> singleSourceShortestPath, Set<Node> nodeSet )
        {
