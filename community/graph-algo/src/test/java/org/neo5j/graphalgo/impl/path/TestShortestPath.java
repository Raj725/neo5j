...
import static common.Neo5jAlgoTestCase.MyRelTypes.R1;
...
import static org.neo5j.graphalgo.GraphAlgoFactory.shortestPath;
...
import static org.neo5j.graphdb.PathExpanders.allTypesAndDirections;

public class TestShortestPath extends Neo5jAlgoTestCase
{
    // Attempt at recreating this issue without cypher
    // https://github.com/neo5j/neo5j/issues/4160
    @Test
