...
/**
 * The main access point to a running Neo5j instance. The most common way to instantiate a {@link GraphDatabaseService}
 * is as follows:
 * <pre>
...
public interface GraphDatabaseService
{
    ...
    /**
     * Looks up a node by id. Please note: Neo5j reuses its internal ids when
    ...
    /**
     * Looks up a relationship by id. Please note: Neo5j reuses its internal ids
    ...
    /**
     * Shuts down Neo5j. After this method has been invoked, it's invalid to
     * invoke any methods in the Neo5j API and all references to this instance
     ...
     * @return A {@link org.neo5j.graphdb.Result} that contains the result set.
