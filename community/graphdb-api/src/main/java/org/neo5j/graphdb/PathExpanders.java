...
public abstract class PathExpanders
{
    ...
    /**
     * A wrapper that uses {@link org.neo5j.graphdb.traversal.Paths.DefaultPathDescriptor} to print expanded paths.
    ...
    /**
     * A wrapper that uses {@link org.neo5j.graphdb.traversal.Paths.DefaultPathDescriptor}
    ...
    /**
     * A wrapper that uses {@link org.neo5j.graphdb.traversal.Paths.DefaultPathDescriptor} to print expanded paths
     * using given {@link org.neo5j.graphdb.traversal.Paths.PathDescriptor}.
     * All expanded paths will be printed.
     * Will use System.out as {@link PrintStream}.
     * @param source        {@link PathExpander} to wrap.
     * @param descriptor    {@link org.neo5j.graphdb.traversal.Paths.PathDescriptor} to use when printing paths.
     * @param <STATE>       the type of the object that holds the state
     * @return              A new {@link PathExpander}.
     */
    public static <STATE> PathExpander<STATE> printingWrapper(
    ...
    /**
     * A wrapper that uses {@link org.neo5j.graphdb.traversal.Paths.DefaultPathDescriptor} to print expanded paths
     * that fulfill {@link BiFunction} predicate using given {@link org.neo5j.graphdb.traversal.Paths.PathDescriptor}.
     * Will use System.out as {@link PrintStream}.
     * @param source    {@link PathExpander} to wrap.
     * @param pred      {@link BiFunction} used as predicate for printing expansion.
     * @param descriptor {@link org.neo5j.graphdb.traversal.Paths.PathDescriptor} to use when printing paths.
