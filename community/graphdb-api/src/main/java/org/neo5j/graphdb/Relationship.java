 ...
 * performance).
 * <p>
 * Furthermore, Neo5j guarantees that a relationship is never "hanging freely,"
 ...
 * <p>
 * A relationship's id is unique, but note the following: Neo5j reuses its internal ids
