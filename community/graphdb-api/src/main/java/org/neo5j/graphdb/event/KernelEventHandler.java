 ...
 */
package org.neo5j.graphdb.event;

import org.neo5j.graphdb.GraphDatabaseService;

/**
 * Event handler interface for Neo5j Kernel life cycle events.
 *
 */
public interface KernelEventHandler
{
    /**
     * This method is invoked during the shutdown process of a Neo5j Graph
     ...
     * the Neo5j Graph Database will terminate. This event can be used to shut
     * down other services that depend on the {@link GraphDatabaseService}.
     */
    void beforeShutdown();

    /**
     * This is invoked when the Neo5j Graph Database enters a state from which
     * it cannot continue.
     *
