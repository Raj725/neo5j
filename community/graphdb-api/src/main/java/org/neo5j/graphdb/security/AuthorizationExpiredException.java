 ...
 */
package org.neo5j.graphdb.security;

import org.neo5j.kernel.api.exceptions.Status;

/**
 * Thrown when required authorization info has expired in the Neo5j auth cache
 */
public class AuthorizationExpiredException extends RuntimeException implements Status.HasStatus
{
    ...
    /** The Neo5j status code associated with this exception type. */
    @Override
