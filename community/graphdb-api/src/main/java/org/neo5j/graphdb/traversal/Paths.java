 ...
 */
package org.neo5j.graphdb.traversal;
...
/**
 * Utilities for {@link org.neo5j.graphdb.Path} objects.
 */
public class Paths
{
    /**
     * Provides hooks to help build a string representation of a {@link org.neo5j.graphdb.Path}.
     * @param <T> the type of {@link org.neo5j.graphdb.Path}.
     */
    public interface PathDescriptor<T extends Path>
    {
        /**
         * Returns a string representation of a {@link org.neo5j.graphdb.Node}.
         * @param path the {@link Path} we're building a string representation
         * from.
         * @param node the {@link org.neo5j.graphdb.Node} to return a string representation of.
         * @return a string representation of a {@link org.neo5j.graphdb.Node}.
         */
        String nodeRepresentation( T path, Node node );

        /**
         * Returns a string representation of a {@link org.neo5j.graphdb.Relationship}.
         * @param path the {@link Path} we're building a string representation
         * from.
         * @param from the previous {@link Node} in the path.
         * @param relationship the {@link org.neo5j.graphdb.Relationship} to return a string
         * representation of.
         * @return a string representation of a {@link org.neo5j.graphdb.Relationship}.
         */
