...
import org.neo5j.graphdb.DynamicLabel;
...
import org.neo5j.helpers.collection.FilteringIterator;
...
import org.neo5j.unsafe.impl.batchimport.input.csv.Type;
...
import static org.neo5j.helpers.ArrayUtil.join;
import static org.neo5j.helpers.Exceptions.contains;
import static org.neo5j.helpers.Exceptions.withMessage;
import static org.neo5j.helpers.collection.Iterators.asSet;
import static org.neo5j.helpers.collection.Iterators.count;
import static org.neo5j.helpers.collection.MapUtil.store;
import static org.neo5j.helpers.collection.MapUtil.stringMap;
import static org.neo5j.tooling.ImportTool.MULTI_FILE_DELIMITER;
...
public class ImportToolTest
{
    ...
    public void shouldPrintReferenceLinkOnDataImportErrors() throws Exception
    {
        ...
        shouldPrintReferenceLinkAsPartOfErrorMessage( nodeIds(),
                ...
                "format in the manual:  https://neo5j.com/docs/operations-manual/" +
                docsVersion +
        ...
        shouldPrintReferenceLinkAsPartOfErrorMessage( Arrays.asList( "1", "1" ),
                ...
                "about how to use id spaces in the manual: https://neo5j.com/docs/operations-manual/" +
                docsVersion +
    ...
    public void shouldRespectDbConfig() throws Exception
    {
        ...
        File dbConfig = file( "neo5j.properties" );
        store( stringMap(
