...
import org.neo5j.csv.reader.CharSeekers;
...
import org.neo5j.unsafe.impl.batchimport.input.csv.Header;
...
import static org.neo5j.kernel.configuration.Settings.parseLongWithUnit;
import static org.neo5j.tooling.DataGeneratorInput.bareboneNodeHeader;
import static org.neo5j.tooling.DataGeneratorInput.bareboneRelationshipHeader;
...
import static org.neo5j.unsafe.impl.batchimport.staging.ExecutionMonitors.defaultVisible;
...
public class QuickImport
{
    public static void main( String[] arguments ) throws IOException
    {
        ...
        org.neo5j.unsafe.impl.batchimport.Configuration importConfig = new Default()
        {
            @Override
    ...
    private static CharSeeker seeker( String definition, Configuration config )
    {
        return CharSeekers.charSeeker( Readables.wrap( new StringReader( definition ) ),
                new org.neo5j.csv.reader.Configuration.Overridden( config )
        {
            @Override
