...
import static org.neo5j.index.internal.gbptree.PageCursorUtil.get6BLong;
import static org.neo5j.index.internal.gbptree.PageCursorUtil.getUnsignedInt;
import static org.neo5j.index.internal.gbptree.PageCursorUtil.put6BLong;
 ...
 * </pre>
 *
 * A free-list node is a page in the same {@link org.neo5j.io.pagecache.PagedFile mapped page cache file}
