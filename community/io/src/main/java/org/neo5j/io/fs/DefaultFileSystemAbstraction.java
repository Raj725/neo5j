...
import org.neo5j.io.fs.watcher.DefaultFileSystemWatcher;
...
{
    static final String UNABLE_TO_CREATE_DIRECTORY_FORMAT = "Unable to create directory path [%s] for Neo5j store.";
