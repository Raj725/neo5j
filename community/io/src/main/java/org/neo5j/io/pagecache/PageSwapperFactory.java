...
public interface PageSwapperFactory
{
     ...
     * required for doing direct IO, then {@link org.neo5j.unsafe.impl.internal.dragons.UnsafeUtil#pageSize()} can be
     * returned.
     *
     ...
     * {@link org.neo5j.io.pagecache.impl.FileIsMappedException}s.
     *
