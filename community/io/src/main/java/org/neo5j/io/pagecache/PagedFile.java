...
public interface PagedFile extends AutoCloseable
{
     ...
     * <p>
     * This implies {@link org.neo5j.io.pagecache.PagedFile#PF_NO_GROW}, since
     ...
     *     }
     * </code></pre>
     * {@link org.neo5j.io.pagecache.PageCursor PageCursors} are {@link AutoCloseable}, so interacting with them
     ...
     * will return the {@link org.neo5j.io.pagecache.PageCursor#UNBOUND_PAGE_ID} constant, and attempts at reading from
     ...
     * {@link org.neo5j.io.pagecache.PagedFile#PF_SHARED_WRITE_LOCK} or
     * {@link org.neo5j.io.pagecache.PagedFile#PF_SHARED_READ_LOCK}.
     * <p>
