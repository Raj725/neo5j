...
import org.neo5j.io.fs.StoreFileChannelUnwrapper;
import org.neo5j.io.pagecache.Page;
...
public class SingleFilePageSwapper implements PageSwapper
{
    ...
    private static final int channelStripePower = Integer.getInteger(
            "org.neo5j.io.pagecache.implSingleFilePageSwapper.channelStripePower",
    ...
    private static final int channelStripeShift = Integer.getInteger(
            "org.neo5j.io.pagecache.implSingleFilePageSwapper.channelStripeShift", 4 );
