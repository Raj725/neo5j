...
import org.neo5j.io.pagecache.PageCacheOpenOptions;
...
import org.neo5j.io.pagecache.tracing.EvictionEvent;
import org.neo5j.io.pagecache.tracing.EvictionRunEvent;
import org.neo5j.io.pagecache.tracing.FlushEventOpportunity;
import org.neo5j.io.pagecache.tracing.MajorFlushEvent;
import org.neo5j.io.pagecache.tracing.PageCacheTracer;
import org.neo5j.io.pagecache.tracing.PageFaultEvent;
import org.neo5j.io.pagecache.tracing.cursor.PageCursorTracerSupplier;
import org.neo5j.unsafe.impl.internal.dragons.MemoryManager;
import org.neo5j.unsafe.impl.internal.dragons.UnsafeUtil;

import static org.neo5j.unsafe.impl.internal.dragons.FeatureToggles.flag;
import static org.neo5j.unsafe.impl.internal.dragons.FeatureToggles.getInteger;

/**
 * The Muninn {@link org.neo5j.io.pagecache.PageCache page cache} implementation.
 * <pre>
 *                                                                      ....
 *                                                                .;okKNWMUWN0ko,
 ...
 * </p>
 * <p>
 *     This implementation of {@link org.neo5j.io.pagecache.PageCache} is optimised for
...
public class MuninnPageCache implements PageCache
{
    ...
    private CacheLiveLockException cooperativeEvictionLiveLock()
    {
        return new CacheLiveLockException(
                ...
                "with the `dbms.memory.pagecache.size` setting. Please contact Neo5j support if you need help tuning " +
                "your database." );
    }
