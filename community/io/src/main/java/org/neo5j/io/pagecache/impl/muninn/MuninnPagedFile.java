...
import org.neo5j.io.pagecache.PageEvictionCallback;
import org.neo5j.io.pagecache.PageSwapper;
import org.neo5j.io.pagecache.PageSwapperFactory;
import org.neo5j.io.pagecache.PagedFile;
import org.neo5j.io.pagecache.impl.PagedReadableByteChannel;
import org.neo5j.io.pagecache.impl.PagedWritableByteChannel;
import org.neo5j.io.pagecache.tracing.FlushEvent;
...
final class MuninnPagedFile implements PagedFile, Flushable
{
    private static final int translationTableChunkSizePower = Integer.getInteger(
            "org.neo5j.io.pagecache.impl.muninn.MuninnPagedFile.translationTableChunkSizePower", 12 );
