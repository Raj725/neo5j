...
import org.neo5j.adversaries.RandomAdversary;
import org.neo5j.adversaries.pagecache.AdversarialPagedFile;
import org.neo5j.concurrent.BinaryLatch;
import org.neo5j.function.ThrowingConsumer;
import org.neo5j.graphdb.mockfs.DelegatingFileSystemAbstraction;
import org.neo5j.graphdb.mockfs.DelegatingStoreChannel;
...
import static org.neo5j.io.pagecache.PagedFile.PF_NO_FAULT;
import static org.neo5j.io.pagecache.PagedFile.PF_NO_GROW;
...
import static org.neo5j.test.ThreadTestUtils.fork;
import static org.neo5j.test.matchers.ByteArrayMatcher.byteArray;
...
public abstract class PageCacheTest<T extends PageCache> extends PageCacheTestSupport<T>
{
    ...
    private T createStandardPageCache() throws IOException
    {
        return getPageCache( fs, maxPages, pageCachePageSize, PageCacheTracer.NULL,
                PageCursorTracerSupplier.NULL );
    }
}
