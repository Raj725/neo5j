...
@Description( "Information about the sizes of the different parts of the Neo5j graph store" )
public interface StoreFile
{
    String NAME = "Store file sizes";

    @Description( "The amount of disk space used by the current Neo5j logical log, in bytes." )
    long getLogicalLogSize();

    @Description( "The total disk space used by this Neo5j instance, in bytes." )
