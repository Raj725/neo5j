...
public abstract class Neo5jMBean extends StandardMBean
{
    final ObjectName objectName;

    protected Neo5jMBean( ManagementData management, boolean isMXBean, String... extraNaming )
    {
    ...
    protected Neo5jMBean( ManagementData management, String... extraNaming )
    ...
    Neo5jMBean( Class<Kernel> beanInterface, KernelData kernel, ManagementSupport support )
            throws NotCompliantMBeanException
    {
        super( beanInterface );
    ...
    Neo5jMBean( String beanName, KernelData kernel, ManagementSupport support )
            throws NotCompliantMBeanException
    {
