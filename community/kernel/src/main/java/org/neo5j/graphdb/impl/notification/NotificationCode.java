...
public enum NotificationCode
{
    ...
    EAGER_LOAD_CSV(
        ...
        "See the Neo5j Manual entry on the Eager operator for more information and hints on " +
    ...
    private final class Notification implements org.neo5j.graphdb.Notification
    {
