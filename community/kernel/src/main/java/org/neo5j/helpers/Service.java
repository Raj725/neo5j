 ...
 * <pre>
 * <code>
 * public abstract class StringConverter extends org.neo5j.commons.Service
 * {
 ...
 *     {
 *         return org.neo5j.commons.Service.load( StringConverter.class, id );
 *     }
 * }
 * </code>
 * </pre>
    ...
    private static <T> Iterable<T> java6Loader( Class<T> type )
    {
        try
        {
            ...
            if ( currentCL != contextCL )
            {
                ...
                // class loader, so this call adds implementations defined in Neo5j
