 ...
 *
 * The reason for the separation between transactions and statements is isolation levels. While Neo5j is read-committed
 ...
 *
 * This class has a 1-1 relationship with{@link org.neo5j.kernel.impl.transaction.state.TransactionRecordState}, please see its'
 * javadoc for details.
 *
 * Typical usage:
 * <pre>
...
public interface KernelTransaction extends AutoCloseable
{
     ...
     * @see org.neo5j.kernel.impl.api.TransactionCommitProcess
