...
/**
 * Contract for implementing an index in Neo5j.
 *
 * This is a sensitive thing to implement, because it manages data that is controlled by
 * Neo5js logical log. As such, the implementation needs to behave under some rather strict rules.
 *
 ...
 *
 * The index will be notified, through the {@link org.neo5j.kernel.api.index.IndexPopulator#close(boolean)}
 ...
 * {@link org.neo5j.kernel.api.index.IndexPopulator#close(boolean) close method}.
 *
