...
import org.neo5j.graphdb.config.ScopeAwareSetting;
...
import org.neo5j.helpers.SocketAddressFormat;
import org.neo5j.helpers.TimeUtil;
import org.neo5j.helpers.collection.Iterables;

import static java.lang.Character.isDigit;
import static java.lang.Integer.parseInt;
import static org.neo5j.graphdb.factory.GraphDatabaseSettings.default_advertised_address;
import static org.neo5j.graphdb.factory.GraphDatabaseSettings.default_listen_address;
import static org.neo5j.io.fs.FileUtils.fixSeparatorsInPath;

/**
 * Create settings for configurations in Neo5j. See {@link org.neo5j.graphdb.factory.GraphDatabaseSettings} for example.
 *
    ...
    public static Setting<File> pathSetting( String name, String defaultValue )
    {
        return new ScopeAwareSetting<File>()
        {
            ...
            public File apply( Function<String, String> config )
            {
                ...
                {
                    return new File( GraphDatabaseSettings.neo5j_home.apply( config ), setting );
                }
            }
            ...
            public String valueDescription()
            {
                return "A filesystem path; relative paths are resolved against the installation root, _<neo5j-home>_";
            }
        };
    }
