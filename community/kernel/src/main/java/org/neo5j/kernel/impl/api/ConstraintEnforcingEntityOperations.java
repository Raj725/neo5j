...
import org.neo5j.helpers.collection.CastingIterator;
...
import org.neo5j.kernel.api.exceptions.schema.UnableToValidateConstraintException;
...
import org.neo5j.kernel.api.schema_new.IndexQuery.ExactPredicate;
...
import org.neo5j.kernel.impl.api.schema.NodeSchemaMatcher;
import org.neo5j.kernel.impl.api.store.NodeLoadingIterator;
...
import static org.neo5j.kernel.api.StatementConstants.NO_SUCH_PROPERTY_KEY;
import static org.neo5j.kernel.api.exceptions.schema.ConstraintValidationException.Phase.VALIDATION;
import static org.neo5j.kernel.api.schema_new.SchemaDescriptorPredicates.hasProperty;
import static org.neo5j.kernel.impl.locking.ResourceTypes.INDEX_ENTRY;
import static org.neo5j.kernel.impl.locking.ResourceTypes.indexEntryResourceId;
