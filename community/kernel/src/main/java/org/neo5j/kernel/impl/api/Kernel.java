...
/**
 * This is the Neo5j Kernel, an implementation of the Kernel API which is an internal component used by Cypher and the
 * Core API (the API under org.neo5j.graphdb).
 *
 * <h1>Structure</h1>
 *
 ...
 * finally {@link org.neo5j.storageengine.api.StoreReadLayer} will read the current committed state from
