...
import org.neo5j.collection.primitive.PrimitiveIntCollection;
import org.neo5j.collection.primitive.PrimitiveIntIterator;
import org.neo5j.collection.primitive.PrimitiveIntSet;
import org.neo5j.collection.primitive.PrimitiveIntStack;
...
import org.neo5j.kernel.api.LegacyIndex;
import org.neo5j.kernel.api.LegacyIndexHits;
...
import org.neo5j.kernel.api.exceptions.LabelNotFoundKernelException;
import org.neo5j.kernel.api.exceptions.PropertyKeyIdNotFoundKernelException;
import org.neo5j.kernel.api.exceptions.RelationshipTypeIdNotFoundKernelException;
...
import org.neo5j.kernel.api.exceptions.legacyindex.AutoIndexingKernelException;
import org.neo5j.kernel.api.exceptions.legacyindex.LegacyIndexNotFoundKernelException;
...
import org.neo5j.kernel.api.exceptions.schema.DropIndexFailureException;
import org.neo5j.kernel.api.exceptions.schema.IllegalTokenNameException;
import org.neo5j.kernel.api.exceptions.schema.IndexBrokenKernelException;
...
import org.neo5j.kernel.api.properties.PropertyKeyIdIterator;
...
import org.neo5j.kernel.impl.api.operations.CountsOperations;
...
import org.neo5j.kernel.impl.api.operations.KeyWriteOperations;
import org.neo5j.kernel.impl.api.operations.LegacyIndexReadOperations;
import org.neo5j.kernel.impl.api.operations.LegacyIndexWriteOperations;
import org.neo5j.kernel.impl.api.operations.SchemaReadOperations;
import org.neo5j.kernel.impl.api.operations.SchemaWriteOperations;
import org.neo5j.kernel.impl.api.state.ConstraintIndexCreator;
import org.neo5j.kernel.impl.api.state.IndexTxStateUpdater;
import org.neo5j.kernel.impl.api.store.RelationshipIterator;
import org.neo5j.kernel.impl.index.IndexEntityType;
import org.neo5j.kernel.impl.index.LegacyIndexStore;
import org.neo5j.register.Register.DoubleLongRegister;
...
import org.neo5j.storageengine.api.txstate.NodeState;
import org.neo5j.storageengine.api.txstate.ReadableDiffSets;

import static java.lang.String.format;
import static org.neo5j.collection.primitive.PrimitiveIntCollections.filter;
import static org.neo5j.collection.primitive.PrimitiveLongCollections.resourceIterator;
import static org.neo5j.collection.primitive.PrimitiveLongCollections.single;
import static org.neo5j.function.Predicates.any;
import static org.neo5j.helpers.collection.Iterators.filter;
import static org.neo5j.helpers.collection.Iterators.iterator;
import static org.neo5j.helpers.collection.Iterators.singleOrNull;
import static org.neo5j.kernel.api.StatementConstants.NO_SUCH_NODE;
import static org.neo5j.kernel.api.properties.DefinedProperty.NO_SUCH_PROPERTY;
...
import static org.neo5j.kernel.impl.util.Cursors.count;
import static org.neo5j.kernel.impl.util.Cursors.empty;
import static org.neo5j.register.Registers.newDoubleLongRegister;
import static org.neo5j.storageengine.api.txstate.TxStateVisitor.EMPTY;
