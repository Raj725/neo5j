...
import org.neo5j.collection.primitive.PrimitiveLongVisitor;
...
import org.neo5j.kernel.api.index.SchemaIndexProvider.Descriptor;
...
import org.neo5j.kernel.impl.api.index.sampling.IndexSamplingController;
...
import org.neo5j.register.Registers;
...
import static org.neo5j.kernel.impl.api.index.IndexPopulationFailure.failure;
import static org.neo5j.kernel.impl.util.JobScheduler.Groups.indexPopulation;

/**
 * Manages the indexes that were introduced in 2.0. These indexes depend on the normal neo5j logical log for
 * transactionality. Each index has an {@link org.neo5j.kernel.impl.store.record.IndexRule}, which it uses to filter
 ...
 * <p>
 * Each index has a state, as defined in {@link org.neo5j.kernel.api.index.InternalIndexState}, which is used during
 * recovery. If an index is anything but {@link org.neo5j.kernel.api.index.InternalIndexState#ONLINE}, it will simply be
 * destroyed and re-created.
 * <p>
 * If, however, it is {@link org.neo5j.kernel.api.index.InternalIndexState#ONLINE}, the index provider is required to
