 ...
 */
package org.neo5j.kernel.impl.coreapi;
...
import org.neo5j.graphdb.event.LabelEntry;
import org.neo5j.graphdb.event.PropertyEntry;
import org.neo5j.graphdb.event.TransactionData;
...
import org.neo5j.kernel.impl.core.RelationshipProxy.RelationshipActions;
...
/**
 * Transform for {@link org.neo5j.storageengine.api.txstate.ReadableTransactionState} to make it accessible as {@link TransactionData}.
 */
