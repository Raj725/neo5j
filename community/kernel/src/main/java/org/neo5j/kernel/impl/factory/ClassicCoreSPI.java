...
import org.neo5j.graphdb.NotInTransactionException;
 ...
 * @see org.neo5j.kernel.impl.factory.GraphDatabaseFacade.SPI
 */
class ClassicCoreSPI implements GraphDatabaseFacade.SPI
{
    ...
    public KernelTransaction beginTransaction( KernelTransaction.Type type, SecurityContext securityContext, long timeout )
    {
        ...
        {
            throw new org.neo5j.graphdb.TransactionFailureException( e.getMessage(), e );
        }
    }
