...
import org.neo5j.graphdb.spatial.Geometry;
import org.neo5j.graphdb.spatial.Point;
...
import org.neo5j.kernel.builtinprocs.SpecialBuiltInProcedures;
import org.neo5j.kernel.configuration.Config;
import org.neo5j.kernel.guard.Guard;
import org.neo5j.kernel.guard.TimeoutGuard;
import org.neo5j.kernel.impl.api.NonTransactionalTokenNameLookup;
import org.neo5j.kernel.impl.api.SchemaWriteGuard;
import org.neo5j.kernel.impl.api.dbms.NonTransactionalDbmsOperations;
...
import org.neo5j.kernel.impl.core.TokenNotFoundException;
import org.neo5j.kernel.impl.logging.LogService;
import org.neo5j.kernel.impl.proc.ProcedureTransactionProvider;
import org.neo5j.kernel.impl.proc.ProcedureConfig;
import org.neo5j.kernel.impl.proc.ProcedureGDSFactory;
import org.neo5j.kernel.impl.proc.Procedures;
import org.neo5j.kernel.impl.proc.TerminationGuardProvider;
import org.neo5j.kernel.impl.proc.TypeMappers.SimpleConverter;
...
import org.neo5j.kernel.internal.KernelEventHandlers;
...
import org.neo5j.procedure.ProcedureTransaction;
import org.neo5j.procedure.TerminationGuard;

import static org.neo5j.kernel.api.proc.Context.KERNEL_TRANSACTION;
import static org.neo5j.kernel.api.proc.Context.SECURITY_CONTEXT;
import static org.neo5j.kernel.api.proc.Neo5jTypes.NTGeometry;
import static org.neo5j.kernel.api.proc.Neo5jTypes.NTNode;
import static org.neo5j.kernel.api.proc.Neo5jTypes.NTPath;
import static org.neo5j.kernel.api.proc.Neo5jTypes.NTPoint;
import static org.neo5j.kernel.api.proc.Neo5jTypes.NTRelationship;
...
public class DataSourceModule
{
    ...
    private Procedures setupProcedures( PlatformModule platform, EditionModule editionModule )
    {
        ...
        Procedures procedures = new Procedures(
                new SpecialBuiltInProcedures( Version.getNeo5jVersion(),
