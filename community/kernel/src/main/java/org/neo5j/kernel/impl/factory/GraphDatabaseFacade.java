...
import org.neo5j.function.ThrowingAction;
...
import org.neo5j.graphdb.MultipleFoundException;
...
import org.neo5j.graphdb.event.KernelEventHandler;
import org.neo5j.graphdb.event.TransactionEventHandler;
...
import org.neo5j.graphdb.security.URLAccessValidationError;
import org.neo5j.graphdb.traversal.BidirectionalTraversalDescription;
import org.neo5j.graphdb.traversal.TraversalDescription;
import org.neo5j.helpers.collection.PrefetchingResourceIterator;
import org.neo5j.helpers.collection.ResourceClosingIterator;
...
import org.neo5j.kernel.impl.api.TokenAccess;
import org.neo5j.kernel.impl.api.operations.KeyReadOperations;
import org.neo5j.kernel.impl.core.NodeProxy;
import org.neo5j.kernel.impl.core.RelationshipProxy;
import org.neo5j.kernel.impl.core.ThreadToStatementContextBridge;
import org.neo5j.kernel.impl.coreapi.AutoIndexerFacade;
import org.neo5j.kernel.impl.coreapi.IndexManagerImpl;
import org.neo5j.kernel.impl.coreapi.IndexProviderImpl;
import org.neo5j.kernel.impl.coreapi.InternalTransaction;
import org.neo5j.kernel.impl.coreapi.PlaceboTransaction;
import org.neo5j.kernel.impl.coreapi.PropertyContainerLocker;
import org.neo5j.kernel.impl.coreapi.ReadOnlyIndexFacade;
import org.neo5j.kernel.impl.coreapi.ReadOnlyRelationshipIndexFacade;
import org.neo5j.kernel.impl.coreapi.RelationshipAutoIndexerFacade;
import org.neo5j.kernel.impl.coreapi.StandardNodeActions;
import org.neo5j.kernel.impl.coreapi.StandardRelationshipActions;
import org.neo5j.kernel.impl.coreapi.TopLevelTransaction;
import org.neo5j.kernel.impl.coreapi.schema.SchemaImpl;
...
import org.neo5j.kernel.impl.traversal.BidirectionalTraversalDescriptionImpl;
import org.neo5j.kernel.impl.traversal.MonoDirectionalTraversalDescription;
import org.neo5j.kernel.internal.GraphDatabaseAPI;
import org.neo5j.storageengine.api.EntityType;

import static java.lang.String.format;
import static org.neo5j.collection.primitive.PrimitiveLongCollections.map;
...
import static org.neo5j.kernel.impl.api.legacyindex.InternalAutoIndexing.NODE_AUTO_INDEX;
import static org.neo5j.kernel.impl.api.legacyindex.InternalAutoIndexing.RELATIONSHIP_AUTO_INDEX;
import static org.neo5j.kernel.impl.api.operations.KeyReadOperations.NO_SUCH_LABEL;
import static org.neo5j.kernel.impl.api.operations.KeyReadOperations.NO_SUCH_PROPERTY_KEY;
...
public class GraphDatabaseFacade implements GraphDatabaseAPI
{
     ...
     * alternate {@link org.neo5j.graphdb.GraphDatabaseService} instances without having to re-implement this whole API
     * implementation.
     */
    public interface SPI
    {
        ...
        /** Eg. Neo5j Enterprise HA, Neo5j Community Standalone.. */
        String name();
         ...
         *
         * @throws org.neo5j.graphdb.TransactionFailureException if unable to begin, or a transaction already exists.
         ...
         *
         * @throws org.neo5j.graphdb.NotInTransactionException if no transaction present
         * @throws org.neo5j.graphdb.DatabaseShutdownException if the database has been shut down
         */
    ...
    public void init( SPI spi, Guard guard, ThreadToStatementContextBridge txBridge, Config config )
    {
        ...
        this.contextFactory = Neo5jTransactionalContextFactory.create( spi, guard, txBridge, locker );
    }
