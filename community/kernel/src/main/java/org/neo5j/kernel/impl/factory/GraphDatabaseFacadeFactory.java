...
import static org.neo5j.kernel.impl.query.QueryEngineProvider.noEngine;
 ...
 * <p>
 * It is abstract in order for subclasses to specify their own {@link org.neo5j.kernel.impl.factory.EditionModule}
 ...
 * <p>
 * To create test versions of databases, override an edition factory (e.g. {@link org.neo5j.kernel.impl.factory
...
public class GraphDatabaseFacadeFactory
{
    ...
    {
        /**
         * Allowed to be null. Null means that no external {@link org.neo5j.kernel.monitoring.Monitors} was created,
         * let the
     ...
     *
     * @param storeDir the directory where the Neo5j data store is located
     ...
     * .neo5j.kernel.impl.factory.GraphDatabaseFacade}.
     *
     * @param storeDir the directory where the Neo5j data store is located
