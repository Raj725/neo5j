...
import org.neo5j.kernel.impl.security.URLAccessRules;
...
/**
 * Platform module for {@link org.neo5j.kernel.impl.factory.GraphDatabaseFacadeFactory}. This creates
 * all the services needed by {@link org.neo5j.kernel.impl.factory.EditionModule} implementations.
 */
public class PlatformModule
{
    ...
    public final org.neo5j.kernel.impl.util.Dependencies dependencies;
            ...
            GraphDatabaseFacadeFactory.Dependencies externalDependencies, GraphDatabaseFacade graphDatabaseFacade )
    {
        ...
        dependencies = new org.neo5j.kernel.impl.util.Dependencies(
        ...
        this.config = dependencies.satisfyDependency( config.withDefaults(
                stringMap( GraphDatabaseSettings.neo5j_home.name(), providedStoreDir.getAbsolutePath() )
        ) );
    ...
    {
        sysInfo.set( UsageDataKeys.version, Version.getNeo5jVersion() );
