...
import org.neo5j.kernel.api.exceptions.ComponentInjectionException;
...
import org.neo5j.kernel.api.proc.FailedLoadAggregatedFunction;
import org.neo5j.kernel.api.proc.FailedLoadFunction;
import org.neo5j.kernel.api.proc.FailedLoadProcedure;
...
class ReflectiveProcedureCompiler
{
            ...
            throws ProcedureException, IllegalAccessException
    {
        ...
        {
            if ( !procedure.mode().equals( org.neo5j.procedure.Mode.DEFAULT ) )
            {
