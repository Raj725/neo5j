...
import org.neo5j.kernel.impl.store.record.MetaDataRecord;
...
import org.neo5j.kernel.impl.util.ArrayQueueOutOfOrderSequence;
import org.neo5j.kernel.impl.util.Bits;
import org.neo5j.kernel.impl.util.CappedLogger;
import org.neo5j.kernel.impl.util.OutOfOrderSequence;
...
import static org.neo5j.kernel.impl.store.format.standard.MetaDataRecordFormat.RECORD_SIZE;
        ...
        implements TransactionIdStore, LogVersionRepository
{
    ...
    public <FAILURE extends Exception> void accept(
            org.neo5j.kernel.impl.store.RecordStore.Processor<FAILURE> processor, MetaDataRecord record )
                    throws FAILURE
    {
