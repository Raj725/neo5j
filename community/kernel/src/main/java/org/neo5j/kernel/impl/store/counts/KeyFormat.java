...
class KeyFormat implements CountsVisitor
{
     ...
     *  l - label id
     * </pre>
     * For value format, see {@link org.neo5j.kernel.impl.store.counts.CountsUpdater#incrementNodeCount(int, long)}.
     */
    @Override
     ...
     *  e - end label id
     * </pre>
     * For value format, see {@link org.neo5j.kernel.impl.store.counts.CountsUpdater#incrementRelationshipCount(int, int, int, long)}
     */
    @Override
     ...
     *  i - index id
     * </pre>
     * For value format, see {@link org.neo5j.kernel.impl.store.counts.CountsUpdater#replaceIndexUpdateAndSize(long, long, long)}.
     */
    @Override
     ...
     *  i - index id
     * </pre>
     * For value format, see {@link org.neo5j.kernel.impl.store.counts.CountsUpdater#replaceIndexSample(long , long, long)}.
     */
    @Override
