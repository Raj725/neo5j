...
import org.neo5j.kernel.impl.storemigration.monitoring.MigrationProgressMonitor.Section;
...
public class StoreUpgrader
{
    ...
    public static class UnexpectedUpgradingStoreVersionException extends UnableToUpgradeException
    {
        protected static final String MESSAGE =
                "Not possible to upgrade a store with version '%s' to current store version `%s` (Neo5j %s).";

        public UnexpectedUpgradingStoreVersionException( String fileVersion, String currentVersion )
        {
            super( String.format( MESSAGE, fileVersion, currentVersion, Version.getNeo5jVersion() ) );
        }
    }
