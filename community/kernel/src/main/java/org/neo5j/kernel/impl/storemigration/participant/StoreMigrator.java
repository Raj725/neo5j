 ...
 */
package org.neo5j.kernel.impl.storemigration.participant;
...
import org.neo5j.io.pagecache.FileHandle;
...
import org.neo5j.kernel.impl.api.store.StorePropertyCursor;
import org.neo5j.kernel.impl.locking.LockService;
import org.neo5j.kernel.impl.logging.LogService;
import org.neo5j.kernel.impl.store.CountsComputer;
...
import org.neo5j.kernel.impl.store.RecordCursors;
...
import org.neo5j.kernel.impl.store.format.CapabilityType;
import org.neo5j.kernel.impl.store.format.FormatFamily;
import org.neo5j.kernel.impl.store.format.RecordFormats;
import org.neo5j.kernel.impl.store.format.standard.MetaDataRecordFormat;
import org.neo5j.kernel.impl.store.format.standard.NodeRecordFormat;
import org.neo5j.kernel.impl.store.format.standard.RelationshipRecordFormat;
import org.neo5j.kernel.impl.store.format.standard.StandardV2_0;
import org.neo5j.kernel.impl.store.format.standard.StandardV2_1;
import org.neo5j.kernel.impl.store.format.standard.StandardV2_2;
import org.neo5j.kernel.impl.store.id.ReadOnlyIdGeneratorFactory;
import org.neo5j.kernel.impl.store.record.NodeRecord;
import org.neo5j.kernel.impl.store.record.PrimitiveRecord;
import org.neo5j.kernel.impl.store.record.RelationshipRecord;
import org.neo5j.kernel.impl.storemigration.DirectRecordStoreMigrator;
import org.neo5j.kernel.impl.storemigration.ExistingTargetStrategy;
import org.neo5j.kernel.impl.storemigration.StoreFile;
import org.neo5j.kernel.impl.storemigration.StoreFileType;
import org.neo5j.kernel.impl.storemigration.StoreMigratorCheckPointer;
import org.neo5j.kernel.impl.storemigration.StoreUpgrader;
import org.neo5j.kernel.impl.storemigration.legacylogs.LegacyLogs;
import org.neo5j.kernel.impl.storemigration.legacystore.v21.propertydeduplication.PropertyDeduplicator;
import org.neo5j.kernel.impl.storemigration.monitoring.MigrationProgressMonitor;
import org.neo5j.kernel.impl.storemigration.monitoring.SilentMigrationProgressMonitor;
import org.neo5j.kernel.impl.transaction.log.LogPosition;
...
import org.neo5j.kernel.impl.util.CustomIOConfigValidator;
import org.neo5j.kernel.lifecycle.Lifespan;
import org.neo5j.logging.NullLogProvider;
import org.neo5j.unsafe.impl.batchimport.AdditionalInitialIds;
import org.neo5j.unsafe.impl.batchimport.BatchImporter;
import org.neo5j.unsafe.impl.batchimport.Configuration;
import org.neo5j.unsafe.impl.batchimport.InputIterable;
import org.neo5j.unsafe.impl.batchimport.ParallelBatchImporter;
import org.neo5j.unsafe.impl.batchimport.cache.idmapping.IdGenerators;
import org.neo5j.unsafe.impl.batchimport.cache.idmapping.IdMappers;
import org.neo5j.unsafe.impl.batchimport.input.Collectors;
import org.neo5j.unsafe.impl.batchimport.input.InputEntity;
import org.neo5j.unsafe.impl.batchimport.input.InputNode;
import org.neo5j.unsafe.impl.batchimport.input.InputRelationship;
import org.neo5j.unsafe.impl.batchimport.input.Inputs;
import org.neo5j.unsafe.impl.batchimport.staging.CoarseBoundedProgressExecutionMonitor;
import org.neo5j.unsafe.impl.batchimport.staging.ExecutionMonitor;

import static java.util.Arrays.asList;
import static org.neo5j.kernel.impl.store.MetaDataStore.DEFAULT_NAME;
import static org.neo5j.kernel.impl.store.format.Capability.VERSION_TRAILERS;
import static org.neo5j.kernel.impl.store.format.RecordFormatSelector.selectForVersion;
import static org.neo5j.kernel.impl.store.format.standard.MetaDataRecordFormat.FIELD_NOT_PRESENT;
import static org.neo5j.kernel.impl.storemigration.FileOperation.COPY;
import static org.neo5j.kernel.impl.storemigration.FileOperation.DELETE;
import static org.neo5j.kernel.impl.storemigration.FileOperation.MOVE;
import static org.neo5j.kernel.impl.transaction.log.TransactionIdStore.BASE_TX_CHECKSUM;
import static org.neo5j.kernel.impl.transaction.log.TransactionIdStore.BASE_TX_COMMIT_TIMESTAMP;
import static org.neo5j.kernel.impl.transaction.log.TransactionIdStore.BASE_TX_LOG_BYTE_OFFSET;
import static org.neo5j.kernel.impl.transaction.log.TransactionIdStore.BASE_TX_LOG_VERSION;
import static org.neo5j.kernel.impl.transaction.log.TransactionIdStore.UNKNOWN_TX_CHECKSUM;
import static org.neo5j.kernel.impl.transaction.log.TransactionIdStore.UNKNOWN_TX_COMMIT_TIMESTAMP;
import static org.neo5j.unsafe.impl.batchimport.staging.ExecutionSupervisors.withDynamicProcessorAssignment;

/**
 * Migrates a neo5j kernel database from one version to the next.
 * <p>
...
public class StoreMigrator extends AbstractStoreMigrationParticipant
{
            ...
            String versionToMigrateFrom, String versionToMigrateTo ) throws IOException
    {
        ...
        if ( versionToMigrateFrom.equals( "vE.H.0" ) )
        {
            ...
            //
            // In later versions of neo5j there are better mechanics in place so that a non-migration like this
    ...
    private class BatchImporterProgressMonitor extends CoarseBoundedProgressExecutionMonitor
    {
        ...
        BatchImporterProgressMonitor( long highNodeId, long highRelationshipId,
                org.neo5j.unsafe.impl.batchimport.staging.Configuration configuration,
