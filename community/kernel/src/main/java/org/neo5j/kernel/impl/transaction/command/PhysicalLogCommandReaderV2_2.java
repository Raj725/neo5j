 ...
 */
package org.neo5j.kernel.impl.transaction.command;
...
import org.neo5j.kernel.impl.index.IndexCommand;
import org.neo5j.kernel.impl.index.IndexCommand.AddNodeCommand;
import org.neo5j.kernel.impl.index.IndexCommand.AddRelationshipCommand;
import org.neo5j.kernel.impl.index.IndexCommand.CreateCommand;
import org.neo5j.kernel.impl.index.IndexCommand.DeleteCommand;
import org.neo5j.kernel.impl.index.IndexCommand.RemoveCommand;
import org.neo5j.kernel.impl.index.IndexDefineCommand;
...
import org.neo5j.kernel.impl.store.record.SchemaRuleSerialization;
import org.neo5j.kernel.impl.transaction.command.CommandReading.DynamicRecordAdder;
import org.neo5j.storageengine.api.ReadableChannel;
import org.neo5j.storageengine.api.schema.SchemaRule;

import static org.neo5j.kernel.impl.transaction.command.CommandReading.COLLECTION_DYNAMIC_RECORD_ADDER;
import static org.neo5j.kernel.impl.transaction.command.CommandReading.PROPERTY_BLOCK_DYNAMIC_RECORD_ADDER;
import static org.neo5j.kernel.impl.transaction.command.CommandReading.PROPERTY_DELETED_DYNAMIC_RECORD_ADDER;
import static org.neo5j.kernel.impl.transaction.command.CommandReading.PROPERTY_INDEX_DYNAMIC_RECORD_ADDER;
import static org.neo5j.kernel.impl.util.Bits.bitFlag;
import static org.neo5j.kernel.impl.util.Bits.notFlag;
import static org.neo5j.kernel.impl.util.IoPrimitiveUtils.read2bLengthAndString;
import static org.neo5j.kernel.impl.util.IoPrimitiveUtils.read2bMap;
import static org.neo5j.kernel.impl.util.IoPrimitiveUtils.read3bLengthAndString;
import static org.neo5j.kernel.impl.util.IoPrimitiveUtils.shortToUnsignedInt;
...
public class PhysicalLogCommandReaderV2_2 extends BaseCommandReader
{
    ...
    private static final class IndexCommandHeader
    {
        ...
        IndexCommandHeader( byte valueType, byte entityType, boolean entityIdNeedsLong, byte indexNameId,
                boolean startNodeNeedsLong, boolean endNodeNeedsLong, byte keyId )
        {
