...
import org.neo5j.kernel.impl.transaction.log.PositionableChannel;
...
import org.neo5j.storageengine.api.ReadPastEndException;

import static org.neo5j.helpers.Exceptions.launderedException;
import static org.neo5j.helpers.Exceptions.withMessage;
import static org.neo5j.kernel.impl.transaction.log.entry.LogEntrySanity.logEntryMakesSense;
import static org.neo5j.kernel.impl.transaction.log.entry.LogEntryVersion.byVersion;

/**
 * Version aware implementation of LogEntryReader
 * Starting with Neo5j version 2.1, log entries are prefixed with a version. This allows for Neo5j instances of
 ...
 * with previous versions of Neo5j.
 *
