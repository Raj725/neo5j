...
import org.neo5j.graphdb.traversal.SideSelectorPolicy;
import org.neo5j.graphdb.traversal.TraversalDescription;
import org.neo5j.graphdb.traversal.Traverser;

import static org.neo5j.graphdb.traversal.BranchCollisionPolicies.STANDARD;
import static org.neo5j.graphdb.traversal.SideSelectorPolicies.ALTERNATING;
import static org.neo5j.kernel.impl.traversal.MonoDirectionalTraversalDescription.NO_STATEMENT;
import static org.neo5j.kernel.impl.traversal.MonoDirectionalTraversalDescription.addEvaluator;
import static org.neo5j.kernel.impl.traversal.MonoDirectionalTraversalDescription.nullCheck;
...
public class BidirectionalTraversalDescriptionImpl implements BidirectionalTraversalDescription
{
    ...
    final org.neo5j.graphdb.traversal.BranchCollisionPolicy collisionPolicy;
    ...
    private BidirectionalTraversalDescriptionImpl( MonoDirectionalTraversalDescription start,
                                                   ...
                                                   org.neo5j.graphdb.traversal.BranchCollisionPolicy
                                                           collisionPolicy,
