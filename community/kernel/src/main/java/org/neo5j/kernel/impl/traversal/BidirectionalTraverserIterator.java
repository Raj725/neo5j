...
import org.neo5j.graphdb.traversal.BidirectionalUniquenessFilter;
import org.neo5j.graphdb.traversal.BranchCollisionDetector;
import org.neo5j.graphdb.traversal.BranchSelector;
...
import org.neo5j.graphdb.traversal.SideSelector;
import org.neo5j.graphdb.traversal.SideSelectorPolicy;
import org.neo5j.graphdb.traversal.TraversalBranch;
import org.neo5j.graphdb.traversal.TraversalContext;
import org.neo5j.graphdb.traversal.UniquenessFilter;
...
class BidirectionalTraverserIterator extends AbstractTraverserIterator
{
    ...
    BidirectionalTraverserIterator( Resource resource,
                                    ...
                                    org.neo5j.graphdb.traversal.BranchCollisionPolicy collisionPolicy,
