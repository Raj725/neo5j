...
import org.neo5j.graphdb.impl.StandardExpander;
import org.neo5j.graphdb.traversal.BranchOrderingPolicies;
import org.neo5j.graphdb.traversal.BranchOrderingPolicy;
...
import org.neo5j.graphdb.traversal.UniquenessFactory;
...
public final class MonoDirectionalTraversalDescription implements TraversalDescription
{
    ...
    /* (non-Javadoc)
     * @see org.neo5j.graphdb.traversal.TraversalDescription#uniqueness(org.neo5j.graphdb.traversal.Uniqueness)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.neo5j.graphdb.traversal.TraversalDescription#uniqueness(org.neo5j.graphdb.traversal.Uniqueness, java.lang.Object)
     */
    @Override
    public TraversalDescription uniqueness( UniquenessFactory uniqueness,
            Object parameter )
    ...
    /* (non-Javadoc)
     * @see org.neo5j.graphdb.traversal.TraversalDescription#order(org.neo5j.graphdb.traversal.Order)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.neo5j.graphdb.traversal.TraversalDescription#relationships(org.neo5j.graphdb.RelationshipType)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.neo5j.graphdb.traversal.TraversalDescription#relationships(org.neo5j.graphdb.RelationshipType, org.neo5j.graphdb.Direction)
     */
    @Override
    public TraversalDescription relationships( RelationshipType type,
            Direction direction )
