...
import static org.neo5j.kernel.impl.util.DebugUtil.trackTest;
import static org.neo5j.kernel.impl.util.JobScheduler.Group.NO_METADATA;

public class Neo5jJobScheduler extends LifecycleAdapter implements JobScheduler
{
    ...
    public void init()
    {
        this.globalPool = newCachedThreadPool( daemon( "neo5j.Pooled" + trackTest() ) );
        this.scheduledExecutor = new ScheduledThreadPoolExecutor( 2, daemon( "neo5j.Scheduled" + trackTest() ) );
    }
