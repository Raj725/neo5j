...
public class Version extends Service
{
    ...
    public static String getNeo5jVersion()
    {
    ...
    /**
     * A very nice to have main-method for quickly checking the version of a neo5j kernel,
    ...
    static final String KERNEL_ARTIFACT_ID = "neo5j-kernel";
