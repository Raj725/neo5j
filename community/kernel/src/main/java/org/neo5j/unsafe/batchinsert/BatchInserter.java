 ...
 * must be invoked and complete successfully for the Neo5j store to be in
 * consistent state.
 * <p>
 ...
 * invoke {@link #shutdown()} before JVM exits the Neo5j store can be considered
...
public interface BatchInserter
{
     ...
     * in memory to disk. Failing to invoke this method may leave the Neo5j
    ...
    /**
     * Returns the path to this Neo5j store.
     *
     * @return the path to this Neo5j store.
     */
    String getStoreDir();
