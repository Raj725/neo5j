...
import static org.neo5j.unsafe.impl.batchimport.Utils.unsignedCompare;
import static org.neo5j.unsafe.impl.batchimport.Utils.unsignedDifference;
import static org.neo5j.unsafe.impl.batchimport.cache.idmapping.string.ParallelSort.DEFAULT;
import static org.neo5j.unsafe.impl.batchimport.cache.idmapping.string.SourceInformation.encodeSourceInformation;
 ...
 * - input id:
 *       An id coming from the user that is associated with a neo5j id by calling {@link #put(Object, long, Group)}.
 *       the first argument is the id that the user specified, the second is the neo5j id that user id will
 *       be associated with.
 * - encoder:
 ...
 * - data cache:
 *       An array of eIds. eIds are added in the order of neo5j ids, i.e. in the order in which they are put.
 * - tracker cache:
