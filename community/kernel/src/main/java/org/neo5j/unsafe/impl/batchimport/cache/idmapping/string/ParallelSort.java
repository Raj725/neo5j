...
import org.neo5j.collection.primitive.PrimitiveLongStack;
import org.neo5j.helpers.progress.ProgressListener;
import org.neo5j.unsafe.impl.batchimport.Utils;
import org.neo5j.unsafe.impl.batchimport.Utils.CompareType;
import org.neo5j.unsafe.impl.batchimport.cache.LongArray;

import static org.neo5j.unsafe.impl.batchimport.cache.idmapping.string.EncodingIdMapper.clearCollision;
