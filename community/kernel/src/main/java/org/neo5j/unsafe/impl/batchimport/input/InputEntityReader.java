 ...
 */
package org.neo5j.unsafe.impl.batchimport.input;
...
import org.neo5j.helpers.collection.PrefetchingIterator;
import org.neo5j.io.ByteUnit;
import org.neo5j.io.fs.StoreChannel;
import org.neo5j.kernel.impl.transaction.log.InMemoryClosableChannel;
import org.neo5j.kernel.impl.transaction.log.LogPositionMarker;
...
import org.neo5j.kernel.impl.transaction.log.ReadableClosableChannel;
import org.neo5j.kernel.impl.transaction.log.ReadableClosablePositionAwareChannel;
import org.neo5j.kernel.impl.util.collection.ContinuableArrayCursor;
import org.neo5j.unsafe.impl.batchimport.InputIterator;
import org.neo5j.unsafe.impl.batchimport.staging.TicketedProcessing;

import static org.neo5j.kernel.impl.transaction.log.LogVersionBridge.NO_MORE_CHANNELS;
import static org.neo5j.unsafe.impl.batchimport.Utils.safeCastLongToInt;
import static org.neo5j.unsafe.impl.batchimport.input.InputCache.END_OF_ENTITIES;
import static org.neo5j.unsafe.impl.batchimport.input.InputCache.END_OF_HEADER;
import static org.neo5j.unsafe.impl.batchimport.input.InputCache.GROUP_TOKEN;
import static org.neo5j.unsafe.impl.batchimport.input.InputCache.HAS_FIRST_PROPERTY_ID;
import static org.neo5j.unsafe.impl.batchimport.input.InputCache.HIGH_TOKEN_TYPE;
import static org.neo5j.unsafe.impl.batchimport.input.InputCache.LABEL_TOKEN;
import static org.neo5j.unsafe.impl.batchimport.input.InputCache.NEW_GROUP;
import static org.neo5j.unsafe.impl.batchimport.input.InputCache.PROPERTY_KEY_TOKEN;
import static org.neo5j.unsafe.impl.batchimport.input.InputCache.RELATIONSHIP_TYPE_TOKEN;
import static org.neo5j.unsafe.impl.batchimport.input.InputCache.SAME_GROUP;
