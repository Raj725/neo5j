 ...
 */
public interface Configuration extends org.neo5j.csv.reader.Configuration
{
    /**
    ...
    abstract class Default extends org.neo5j.csv.reader.Configuration.Default implements Configuration
    {
    }
    ...
    class Overridden extends org.neo5j.csv.reader.Configuration.Overridden implements Configuration
    {
