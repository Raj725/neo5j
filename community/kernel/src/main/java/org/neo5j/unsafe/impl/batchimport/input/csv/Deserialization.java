 ...
 *
 * <ol>
 * <li>One or more calls to {@link #handle(org.neo5j.unsafe.impl.batchimport.input.csv.Header.Entry, Object)}</li>
...
public interface Deserialization<ENTITY>
{
    ...
    /**
     * Takes values received in {@link #handle(org.neo5j.unsafe.impl.batchimport.input.csv.Header.Entry, Object)}
