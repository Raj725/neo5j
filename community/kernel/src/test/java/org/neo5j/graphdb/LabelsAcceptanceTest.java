...
import org.neo5j.kernel.impl.store.id.configuration.IdTypeConfiguration;
...
import static org.neo5j.collection.primitive.PrimitiveIntCollections.consume;
...
import static org.neo5j.test.mockito.matcher.Neo5jMatchers.hasLabel;
import static org.neo5j.test.mockito.matcher.Neo5jMatchers.hasLabels;
import static org.neo5j.test.mockito.matcher.Neo5jMatchers.hasNoLabels;
import static org.neo5j.test.mockito.matcher.Neo5jMatchers.hasNoNodes;
import static org.neo5j.test.mockito.matcher.Neo5jMatchers.hasNodes;
...
public class LabelsAcceptanceTest
{
    ...
    /** https://github.com/neo5j/neo5j/issues/1279 */
    @Test
