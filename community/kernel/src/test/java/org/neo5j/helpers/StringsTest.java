...
import static org.neo5j.helpers.Strings.prettyPrint;
...
public class StringsTest
{
    ...
    public void testPrettyPrint()
    {
        ...
        assertEquals(
                "[Cat, [http://neo5j.com, http://neo5j.org], Dog, [1, 2, 3], [[[Wolf]]]]",
                prettyPrint( new Object[]{
                        "Cat",
                        new URI[]{URI.create( "http://neo5j.com" ), URI.create( "http://neo5j.org" )},
                        "Dog",
                        new int[]{1, 2, 3},
