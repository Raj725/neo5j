...
import org.neo5j.kernel.api.proc.Key;
...
import org.neo5j.kernel.impl.proc.TypeMappers;
...
{
    private final List<NewIndexDescriptor> indexes = new LinkedList<>();
    private final List<NewIndexDescriptor> uniqueIndexes = new LinkedList<>();
    ...
    public void shouldListCorrectBuiltinProcedures() throws Throwable
    {
        ...
        assertThat( call( "dbms.procedures" ), containsInAnyOrder(
                record( "dbms.listConfig",
                        ...
                        "value" +
                        " :: STRING?)",
                        "List the currently active config of Neo5j." ),
                ...
                record( "dbms.queryJmx",
                        ...
                        "MAP?)",
                        "Query JMX management data by domain and name. For instance, \"org.neo5j:*\"" )
        ) );
    }
    ...
    public void shouldListSystemComponents() throws Throwable
    {
        ...
        assertThat( call( "dbms.components" ), contains(
                record( "Neo5j Kernel", singletonList( "1.3.37" ), "enterprise" )
        ) );
    }
