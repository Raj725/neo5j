...
public class JmxQueryProcedureTest
{
    ...
    public void shouldHandleBasicMBean() throws Throwable
    {
        ...
        assertThat( asList( result ), contains(
            equalTo( new Object[]{
                    "org.neo5j:chevyMakesTheTruck=bobMcCoshMakesTheDifference",
    ...
    {
        // given
        ObjectName beanName = new ObjectName( "org.neo5j:chevyMakesTheTruck=bobMcCoshMakesTheDifference" );
    ...
    public void shouldConvertAllStandardBeansWithoutError() throws Throwable
    {
        ...
        //      single MBean into Neo5j types, and we always get the correct number of MBeans out.
    ...
    public void setup() throws Throwable
    {
        ...
        beanName = new ObjectName( "org.neo5j:chevyMakesTheTruck=bobMcCoshMakesTheDifference" );
        attributeName = "name";
