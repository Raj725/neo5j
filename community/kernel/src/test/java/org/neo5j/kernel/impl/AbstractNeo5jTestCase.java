...
@AbstractNeo5jTestCase.RequiresPersistentGraphDatabase( false )
public abstract class AbstractNeo5jTestCase
{
    ...
    protected static final File NEO5J_BASE_DIR = new File( "target", "var" );
    ...
    protected AbstractNeo5jTestCase()
    {
    ...
    {
        AbstractNeo5jTestCase.requiresPersistentGraphDatabase.set( requiresPersistentGraphDatabase );
        AbstractNeo5jTestCase.currentTestClassName.set( testClassName );
    ...
    {
        return new File( NEO5J_BASE_DIR, currentTestClassName.get() + "-" + endPath ).getAbsoluteFile();
    }
