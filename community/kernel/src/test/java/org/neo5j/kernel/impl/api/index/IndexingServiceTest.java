...
import org.neo5j.collection.primitive.PrimitiveLongObjectMap;
...
import org.neo5j.helpers.collection.BoundedIterable;
...
import org.neo5j.kernel.api.exceptions.index.IndexPopulationFailedKernelException;
...
import org.neo5j.kernel.impl.transaction.command.Command.NodeCommand;
import org.neo5j.kernel.impl.transaction.command.Command.PropertyCommand;
import org.neo5j.kernel.impl.transaction.state.DefaultSchemaIndexProviderMap;
import org.neo5j.kernel.impl.transaction.state.DirectIndexUpdates;
...
import org.neo5j.kernel.lifecycle.LifeRule;
import org.neo5j.kernel.lifecycle.LifecycleException;
import org.neo5j.logging.AssertableLogProvider;
import org.neo5j.logging.AssertableLogProvider.LogMatcherBuilder;
...
import static org.neo5j.collection.primitive.PrimitiveLongCollections.setOf;
import static org.neo5j.helpers.collection.Iterators.asCollection;
import static org.neo5j.helpers.collection.Iterators.asResourceIterator;
import static org.neo5j.helpers.collection.Iterators.asSet;
import static org.neo5j.helpers.collection.Iterators.iterator;
import static org.neo5j.helpers.collection.Iterators.loop;
import static org.neo5j.helpers.collection.MapUtil.stringMap;
import static org.neo5j.kernel.api.index.InternalIndexState.FAILED;
import static org.neo5j.kernel.api.index.InternalIndexState.ONLINE;
import static org.neo5j.kernel.api.index.InternalIndexState.POPULATING;
import static org.neo5j.kernel.impl.api.index.IndexUpdateMode.RECOVERY;
import static org.neo5j.kernel.impl.api.index.TestSchemaIndexProviderDescriptor.PROVIDER_DESCRIPTOR;
import static org.neo5j.kernel.impl.api.index.sampling.IndexSamplingMode.TRIGGER_REBUILD_ALL;
...
import static org.neo5j.test.mockito.answer.AwaitAnswer.afterAwaiting;
...
public class IndexingServiceTest
{
    ...
    private final NewIndexDescriptor index = NewIndexDescriptorFactory.forLabel( labelId, propertyKeyId );
                                                                      ...
                                                                      IndexRule... rules ) throws IOException
    {
        ...
        return life.add( IndexingServiceFactory.createIndexingService( config,
                        life.add( new Neo5jJobScheduler() ),
