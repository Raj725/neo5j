...
import org.neo5j.test.rule.GraphTransactionRule;
...
public class TestShortStringProperties
{
    ...
    {
        return AbstractNeo5jTestCase.numberOfRecordsInUse( propertyStore() );
    }

    private long dynamicRecordsInUse()
    {
        return AbstractNeo5jTestCase.numberOfRecordsInUse( propertyStore().getStringStore() );
    }
