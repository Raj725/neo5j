...
import org.neo5j.graphdb.event.ErrorState;
...
import static org.neo5j.kernel.impl.AbstractNeo5jTestCase.getStorePath;
...
public class TestShutdownSequence
{
    ...
    {
        graphDb.shutdown();
        AbstractNeo5jTestCase.deleteFileOrDirectory( getStorePath( "shutdown" ) );
        graphDb.shutdown();
    }
