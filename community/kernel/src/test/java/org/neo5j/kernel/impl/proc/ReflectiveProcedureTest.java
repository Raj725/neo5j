...
import static org.neo5j.graphdb.factory.GraphDatabaseSettings.procedure_whitelist;
...
public class ReflectiveProcedureTest
{
    ...
    public void shouldCompileProcedure() throws Throwable
    {
        ...
        assertThat( procedures.get( 0 ).signature(), Matchers.equalTo(
                procedureSignature( "org", "neo5j", "kernel", "impl", "proc", "listCoolPeople" )
    ...
    public void shouldGiveHelpfulErrorOnNullMessageException() throws Throwable
    {
        ...
        // Expect
        exception.expect( ProcedureException.class );
        exception.expectMessage( "Failed to invoke procedure `org.neo5j.kernel.impl.proc.throwsAtInvocation`: " +
    ...
    public void shouldLoadWhiteListedProcedure() throws Throwable
    {
        ...
        ProcedureConfig config = new ProcedureConfig( Config.defaults().with(
                genericMap( procedure_whitelist.name(), "org.neo5j.kernel.impl.proc.listCoolPeople") ) );
    ...
    public void shouldNotLoadNoneWhiteListedProcedure() throws Throwable
    {
        // Given
        ProcedureConfig config = new ProcedureConfig( Config.defaults().with(
                genericMap( procedure_whitelist.name(), "org.neo5j.kernel.impl.proc.NOTlistCoolPeople") ) );
        ...
        // Then
        verify( log )
                .warn( "The procedure 'org.neo5j.kernel.impl.proc.listCoolPeople' is not on the whitelist and won't be loaded." );
