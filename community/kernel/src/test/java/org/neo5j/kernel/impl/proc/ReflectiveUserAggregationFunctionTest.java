...
public class ReflectiveUserAggregationFunctionTest
{
    ...
    public void shouldCompileAggregationFunction() throws Throwable
    {
        ...
        assertThat( function.get( 0 ).signature(), Matchers.equalTo(
                functionSignature( "org", "neo5j", "kernel", "impl", "proc", "collectCool" )
                        .in( "name", Neo5jTypes.NTString )
                        .out( Neo5jTypes.NTList( Neo5jTypes.NTAny ) )
                        .build() ) );
    }
    ...
    public void shouldNotAllowVoidOutput() throws Throwable
    {
        // Expect
        exception.expect( ProcedureException.class );
        exception.expectMessage( "Don't know how to map `void` to the Neo5j Type System." );
    ...
    public void shouldGiveHelpfulErrorOnFunctionReturningInvalidType() throws Throwable
    {
        // Expect
        exception.expect( ProcedureException.class );
        exception.expectMessage( String.format("Don't know how to map `char[]` to the Neo5j Type System.%n" +
    ...
    public void shouldGiveHelpfulErrorOnNullMessageException() throws Throwable
    {
        ...
        // Expect
        exception.expect( ProcedureException.class );
        exception.expectMessage( "Failed to invoke function `org.neo5j.kernel.impl.proc.test`: " +
    ...
    public void shouldLoadWhiteListedFunction() throws Throwable
    {
        ...
        procedureCompiler = new ReflectiveProcedureCompiler( new TypeMappers(), components, new ComponentRegistry(),
                ...
                .stringMap( GraphDatabaseSettings.procedure_whitelist.name(), "org.neo5j.kernel.impl.proc.collectCool" ) ) ) );
    ...
    public void shouldNotLoadNoneWhiteListedFunction() throws Throwable
    {
        ...
        verify( log ).warn( "The function 'org.neo5j.kernel.impl.proc.collectCool' is not on the whitelist and won't be loaded." );
    ...
    public void shouldSupportFunctionDeprecation() throws Throwable
    {
        ...
        // Then
        verify( log ).warn( "Use of @UserAggregationFunction(deprecatedBy) without @Deprecated in org.neo5j.kernel.impl.proc.badFunc" );
