...
public class ResourceInjectionTest
{
    ...
    public void shouldFailNicelyWhenUnknownAPI() throws Throwable
    {
        ...
        exception.expectMessage( "Unable to set up injection for procedure `ProcedureWithUnknownAPI`, " +
                "the field `api` has type `class org.neo5j.kernel.impl.proc.ResourceInjectionTest$UnknownAPI` " +
    ...
    public void shouldFailNicelyWhenUnsafeAPISafeMode() throws Throwable
    {
        ...
        verify( log )
                .warn( "org.neo5j.kernel.impl.proc.listCoolPeople is not " +
        ...
        catch ( ProcedureException e )
        {
            assertThat( e.getMessage(), containsString(
                    "org.neo5j.kernel.impl.proc.listCoolPeople is not " +
                            "available due to having restricted access rights, check configuration." ) );
        }
    }
    ...
    public void shouldFailNicelyWhenAllUsesUnsafeAPI() throws Throwable
    {
        ...
        verify( log )
                .warn( "org.neo5j.kernel.impl.proc.safeUserFunctionInUnsafeAPIClass is not " +
                        "available due to having restricted access rights, check configuration." );
        verify( log )
                .warn( "org.neo5j.kernel.impl.proc.listCoolPeopleProcedure is not " +
                        "available due to having restricted access rights, check configuration." );
        verify( log )
                .warn( "org.neo5j.kernel.impl.proc.listCoolPeople is not " +
                        "available due to having restricted access rights, check configuration." );
