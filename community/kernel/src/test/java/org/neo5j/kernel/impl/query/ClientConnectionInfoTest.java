...
import org.neo5j.kernel.impl.query.clientconnection.HttpConnectionInfo;
...
public class ClientConnectionInfoTest
{
    ...
    public void connectionDetailsForBoltQuerySource() throws Exception
    {
        ...
        // then
        assertEquals(
                "bolt-session\tbolt\tusername\tneo5j-java-bolt-driver\t\tclient/127.0.0.1:56789\t"
