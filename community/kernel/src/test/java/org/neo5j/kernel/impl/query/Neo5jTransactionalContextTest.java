...
public class Neo5jTransactionalContextTest
{
    ...
    public void checkKernelStatementOnCheck() throws Exception
    {
        ...
        Neo5jTransactionalContext transactionalContext =
    ...
    public void neverStopsExecutingQueryDuringCommitAndRestartTx()
    {
        ...
        Neo5jTransactionalContext context = new Neo5jTransactionalContext( queryService,
                null,
                guard,
                txBridge,
                locker,
    ...
    public void rollsBackNewlyCreatedTransactionIfTerminationDetectedOnCloseDuringPeriodicCommit()
    {
        ...
        Neo5jTransactionalContext context = new Neo5jTransactionalContext(
            queryService,
            null,
            guard,
            txBridge,
