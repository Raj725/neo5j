...
import org.neo5j.kernel.impl.store.IntStoreHeader;
import org.neo5j.kernel.impl.store.format.RecordGenerators.Generator;
            ...
            RecordKey<R> key, PagedFile storeFile, int recordSize ) throws IOException
    {
        try ( PageCursor cursor = storeFile.io( 0, PagedFile.PF_SHARED_READ_LOCK ) )
        {
            ...
            /**
             ...
             Same retry is done on the store level in {@link org.neo5j.kernel.impl.store.CommonAbstractStore}
             */
