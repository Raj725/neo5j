...
import org.neo5j.kernel.api.exceptions.index.IndexActivationFailedKernelException;
...
import org.neo5j.kernel.impl.store.RelationshipGroupStore;
...
import org.neo5j.kernel.impl.transaction.command.Command.LabelTokenCommand;
import org.neo5j.kernel.impl.transaction.command.Command.PropertyKeyTokenCommand;
import org.neo5j.kernel.impl.transaction.command.Command.RelationshipTypeTokenCommand;
...
import static org.neo5j.kernel.impl.transaction.command.CommandHandlerContract.apply;
import static org.neo5j.storageengine.api.TransactionApplicationMode.INTERNAL;
