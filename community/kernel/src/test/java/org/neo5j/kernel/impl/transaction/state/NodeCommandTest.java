...
import org.neo5j.kernel.impl.transaction.command.PhysicalLogCommandReaderV3_0;
import org.neo5j.kernel.impl.transaction.log.InMemoryClosableChannel;
import org.neo5j.logging.NullLogProvider;
import org.neo5j.storageengine.api.CommandReader;
...
import static org.neo5j.kernel.impl.store.ShortArray.LONG;
import static org.neo5j.kernel.impl.store.record.AbstractBaseRecord.NO_ID;
...
public class NodeCommandTest
{
    ...
    private void assertSerializationWorksFor( org.neo5j.kernel.impl.transaction.command.Command.NodeCommand cmd )
            throws IOException
    {
        channel.reset();
        cmd.serialize( channel );
