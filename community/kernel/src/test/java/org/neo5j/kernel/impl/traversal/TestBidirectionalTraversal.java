...
import org.neo5j.graphdb.impl.traversal.StandardBranchCollisionDetector;
...
import org.neo5j.graphdb.traversal.SideSelectorPolicies;
import org.neo5j.graphdb.traversal.TraversalBranch;
...
import static org.neo5j.graphdb.traversal.Evaluators.includeIfContainsAll;
import static org.neo5j.graphdb.traversal.Uniqueness.NODE_PATH;
import static org.neo5j.graphdb.traversal.Uniqueness.RELATIONSHIP_PATH;
