...
import static org.neo5j.graphdb.traversal.Evaluation.EXCLUDE_AND_CONTINUE;
import static org.neo5j.graphdb.traversal.Evaluation.INCLUDE_AND_CONTINUE;
import static org.neo5j.graphdb.traversal.Evaluation.INCLUDE_AND_PRUNE;
import static org.neo5j.graphdb.traversal.Evaluators.includeWhereEndNodeIs;
import static org.neo5j.graphdb.traversal.Evaluators.lastRelationshipTypeIs;
