...
import org.neo5j.io.fs.watcher.SilentFileWatcher;
import org.neo5j.kernel.impl.util.watcher.FileWatcherLifecycleAdapter;
...
public class FileWatcherLifecycleAdapterTest
{
    ...
    private static Neo5jJobScheduler jobScheduler;
    private FileWatcher fileWatcher = Mockito.mock( FileWatcher.class );

    @BeforeClass
    public static void setUp()
    {
        jobScheduler = new Neo5jJobScheduler();
    }
