...
import org.neo5j.csv.reader.DataAfterQuoteException;
import org.neo5j.csv.reader.Readables;
import org.neo5j.io.NullOutputStream;
...
import static org.neo5j.unsafe.impl.batchimport.input.csv.DataFactories.nodeData;
...
public class ImportPanicIT
{
    ...
    private org.neo5j.unsafe.impl.batchimport.input.csv.Configuration csvConfigurationWithLowBufferSize()
    {
        return new org.neo5j.unsafe.impl.batchimport.input.csv.Configuration.Overridden( COMMAS )
        {
            @Override
