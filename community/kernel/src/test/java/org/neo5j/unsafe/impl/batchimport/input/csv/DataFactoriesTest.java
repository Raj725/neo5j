...
import static org.neo5j.csv.reader.Readables.sources;
import static org.neo5j.csv.reader.Readables.wrap;
import static org.neo5j.helpers.ArrayUtil.array;
...
public class DataFactoriesTest
{
    ...
    private static final org.neo5j.csv.reader.Configuration SEEKER_CONFIG =
            new org.neo5j.csv.reader.Configuration.Overridden( new org.neo5j.csv.reader.Configuration.Default() )
    {
        @Override
