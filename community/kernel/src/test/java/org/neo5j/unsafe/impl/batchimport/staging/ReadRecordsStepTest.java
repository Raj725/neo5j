 ...
 */
package org.neo5j.unsafe.impl.batchimport.staging;
...
import org.neo5j.unsafe.impl.batchimport.StoreWithReservedId;
...
import static org.neo5j.unsafe.impl.batchimport.RecordIdIterator.allIn;
...
public class ReadRecordsStepTest
{
    ...
    public void reservedIdIsSkipped()
    {
        ...
        org.neo5j.unsafe.impl.batchimport.Configuration config = withBatchSize( DEFAULT, batchSize );
    ...
    public void shouldContinueThroughBigIdHoles() throws Exception
    {
        ...
        org.neo5j.unsafe.impl.batchimport.Configuration config = withBatchSize( DEFAULT, 10 );
