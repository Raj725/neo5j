...
import static org.neo5j.logging.FormattedLog.DEFAULT_CURRENT_DATE_SUPPLIER;
import static org.neo5j.logging.FormattedLog.OUTPUT_STREAM_CONVERTER;
import static org.neo5j.logging.FormattedLog.UTC;
...
public class FormattedLogProvider extends AbstractLogProvider<FormattedLog>
{
    ...
    public static class Builder
    {
         ...
         * starts with the specified string will have its level set. For example, setting the level for the context {@code org.neo5j}
         * would result in that level being applied to {@link Log}s with the context {@code org.neo5j.Foo}, {@code org.neo5j.foo.Bar}, etc.
         *
