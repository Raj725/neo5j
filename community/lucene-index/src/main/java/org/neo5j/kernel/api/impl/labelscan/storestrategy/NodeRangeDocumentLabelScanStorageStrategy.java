...
import org.neo5j.kernel.api.impl.index.LuceneAllDocumentsReader;
import org.neo5j.kernel.api.impl.labelscan.bitmaps.BitmapFormat;
import org.neo5j.kernel.api.impl.labelscan.reader.LuceneAllEntriesLabelScanReader;
import org.neo5j.kernel.api.labelscan.AllEntriesLabelScanReader;

import static org.neo5j.collection.primitive.PrimitiveLongCollections.concat;


/**
 * {@link org.neo5j.kernel.api.labelscan.LabelScanStore} implemented using Lucene. There's only one big index for all
 * labels
