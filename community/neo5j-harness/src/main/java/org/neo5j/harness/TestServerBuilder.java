...
/**
 * Utility for constructing and starting Neo5j for test purposes.
 */
public interface TestServerBuilder
{
     ...
     * {@link #withConfig(org.neo5j.graphdb.config.Setting, String)} method. Please refer to the Neo5j Manual for
    ...
    /**
     * Configure the Neo5j instance. Configuration here can be both configuration aimed at the server as well as the
     * database tuning options. Please refer to the Neo5j Manual for details on available configuration options.
     *
    ...
    /**
     * @see #withConfig(org.neo5j.graphdb.config.Setting, String)
     */
    TestServerBuilder withConfig( String key, String value );

    /**
     * Shortcut for configuring the server to use an unmanaged extension. Please refer to the Neo5j Manual on how to
