...
import static org.neo5j.dbms.DatabaseManagementSystemSettings.data_directory;
import static org.neo5j.graphdb.factory.GraphDatabaseSettings.auth_enabled;
import static org.neo5j.graphdb.factory.GraphDatabaseSettings.pagecache_memory;
import static org.neo5j.helpers.collection.Iterables.append;
...
public abstract class AbstractInProcessServerBuilder implements TestServerBuilder
{
    ...
    public ServerControls newServer()
    {
        try ( FileSystemAbstraction fileSystem = new DefaultFileSystemAbstraction() )
        {
            ...
            try
            {
                logOutputStream = createOrOpenAsOuputStream( fileSystem, new File( serverFolder, "neo5j.log" ), true );
            }
            catch ( IOException e )
            {
            ...
            Iterable<KernelExtensionFactory<?>> kernelExtensions =
                    append( new Neo5jHarnessExtensions( procedures ), dependencies.kernelExtensions() );
     ...
     */
    private static class Neo5jHarnessExtensions extends KernelExtensionFactory<Neo5jHarnessExtensions.Dependencies>
    {
        ...
        Neo5jHarnessExtensions( HarnessRegisteredProcs userProcs )
        {
            super("harness");
