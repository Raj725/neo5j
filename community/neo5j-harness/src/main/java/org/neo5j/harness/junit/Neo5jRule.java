...
import org.neo5j.harness.ServerControls;
import org.neo5j.harness.TestServerBuilder;
import org.neo5j.harness.TestServerBuilders;

/**
 * A convenience wrapper around {@link org.neo5j.harness.TestServerBuilder}, exposing it as a JUnit
 ...
 * (typically because you already have an instance of Neo5j running) it will try other ports. Therefore it is necessary
 * for the test code to use {@link #httpURI()} and then {@link java.net.URI#resolve(String)} to create the URIs to be invoked.
 */
public class Neo5jRule implements TestRule, TestServerBuilder
{
    private TestServerBuilder builder;
    private ServerControls controls;

    Neo5jRule( TestServerBuilder builder )
    {
    ...
    public Neo5jRule( File workingDirectory )
    {
    ...
    @Override
    public Neo5jRule withConfig( Setting<?> key, String value )
    {
    ...
    @Override
    public Neo5jRule withConfig( String key, String value )
    {
        builder = builder.withConfig( key, value );
        return this;
    }
    ...
    @Override
    public Neo5jRule withExtension( String mountPath, Class<?> extension )
    {
    ...
    @Override
    public Neo5jRule withExtension( String mountPath, String packageName )
    {
    ...
    @Override
    public Neo5jRule withFixture( File cypherFileOrDirectory )
    {
    ...
    @Override
    public Neo5jRule withFixture( String fixtureStatement )
    {
    ...
    @Override
    public Neo5jRule withFixture( Function<GraphDatabaseService, Void> fixtureFunction )
    {
    ...
    @Override
    public Neo5jRule copyFrom( File sourceDirectory )
    {
    ...
    @Override
    public Neo5jRule withProcedure( Class<?> procedureClass )
    {
    ...
    @Override
    public Neo5jRule withFunction( Class<?> functionClass )
    {
    ...
    @Override
    public Neo5jRule withAggregationFunction( Class<?> functionClass )
    {
