...
import org.neo5j.driver.v1.StatementResult;
import org.neo5j.harness.junit.Neo5jRule;
import org.neo5j.test.rule.SuppressOutput;
import org.neo5j.tooling.procedure.procedures.valid.Procedures;
...
public class ProcedureTest
{
    ...
    @Rule
    public Neo5jRule graphDb = new Neo5jRule().withProcedure( PROCEDURES_CLASS );
