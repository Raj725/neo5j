...
public class UserFunctionProcessorTest
{
    ...
    public void fails_if_return_type_is_incorrect()
    {
        ...
        assert_().about( javaSource() ).that( function ).processedWith( processor ).failsToCompile().withErrorCount( 1 )
                .withErrorContaining(
                        "Unsupported return type <java.util.stream.Stream<java.lang.Long>> of function defined in <org.neo5j.tooling.procedure.procedures.invalid.bad_return_type.BadReturnTypeUserFunction#wrongReturnTypeFunction>" )
    ...
    public void fails_if_duplicate_functions_are_declared()
    {
        ...
        assert_().about( javaSources() ).that( asList( firstDuplicate, secondDuplicate ) ).processedWith( processor )
                ...
                "Procedure|function name <org.neo5j.tooling.procedure.procedures.invalid.duplicated.foobar> is already defined 2 times. It should be defined only once!" );
    }
