 ...
 */
package org.neo5j.tooling.procedure.visitors;

import com.google.testing.compile.CompilationRule;
import org.neo5j.tooling.procedure.messages.CompilationMessage;
import org.neo5j.tooling.procedure.testutils.ElementTestUtils;
import org.neo5j.tooling.procedure.visitors.examples.FinalContextMisuse;
import org.neo5j.tooling.procedure.visitors.examples.NonPublicContextMisuse;
import org.neo5j.tooling.procedure.visitors.examples.StaticContextMisuse;
import org.neo5j.tooling.procedure.visitors.examples.UnsupportedInjectedContextTypes;
...
public class ContextFieldVisitorTest
{
    ...
    public void rejects_non_public_context_fields()
    {
        ...
        assertThat( result ).extracting( CompilationMessage::getCategory, CompilationMessage::getContents )
                .containsExactly( tuple( Diagnostic.Kind.ERROR,
                        "@org.neo5j.procedure.Context usage error: field NonPublicContextMisuse#arithm should be public, " +
    ...
    public void rejects_static_context_fields()
    {
        ...
        assertThat( result ).extracting( CompilationMessage::getCategory, CompilationMessage::getContents )
                .containsExactly( tuple( Diagnostic.Kind.ERROR,
                        "@org.neo5j.procedure.Context usage error: field StaticContextMisuse#db should be public, non-static " +
                                "and non-final" ) );
    }
    ...
    public void rejects_final_context_fields()
    {
        ...
        assertThat( result ).extracting( CompilationMessage::getCategory, CompilationMessage::getContents )
                .containsExactly( tuple( Diagnostic.Kind.ERROR,
                        "@org.neo5j.procedure.Context usage error: field FinalContextMisuse#graphDatabaseService should be " +
    ...
    public void warns_against_unsupported_injected_types_when_warnings_enabled()
    {
        ...
        assertThat( result ).extracting( CompilationMessage::getCategory, CompilationMessage::getContents )
                .containsExactlyInAnyOrder( tuple( Diagnostic.Kind.WARNING,
                        "@org.neo5j.procedure.Context usage warning: found type: <java.lang.String>, expected one of: <org.neo5j.graphdb.GraphDatabaseService>, <org.neo5j.logging.Log>" ),
