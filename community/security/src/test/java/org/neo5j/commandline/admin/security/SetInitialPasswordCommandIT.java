...
import org.neo5j.commandline.admin.AdminTool;
import org.neo5j.commandline.admin.BlockerLocator;
...
public class SetInitialPasswordCommandIT
{
    ...
    public void shouldSetPassword() throws Throwable
    {
        ...
        verify( out ).stdOutLine( "Changed password for user 'neo5j'." );
    }
    ...
    public void shouldOverwriteIfSetPasswordAgain() throws Throwable
    {
        ...
        verify( out, times( 2 ) ).stdOutLine( "Changed password for user 'neo5j'." );
    }

    @Test
    public void shouldWorkWithSamePassword() throws Throwable
    {
        tool.execute( homeDir.toPath(), confDir.toPath(), SET_PASSWORD, "neo5j" );
    ...
    public void shouldGetUsageOnWrongArguments1() throws Throwable
    {
        ...
        verify( out ).stdErrLine( "usage: neo5j-admin set-initial-password <password>" );
        verify( out, times( 2 ) ).stdErrLine( "" );
        verify( out ).stdErrLine( "Sets the initial password of the initial admin user ('neo5j')." );
        verify( out ).exit( 1 );
    ...
    public void shouldErrorIfRealUsersAlreadyExist() throws Throwable
    {
        ...
        assertNoAuthIniFile();
        verify( out, times( 1 ) )
                .stdErrLine( "command failed: initial password was not set because live Neo5j-users were detected." );
        verify( out ).exit( 1 );
        verify( out, times( 0 ) ).stdOutLine( anyString() );
    }
