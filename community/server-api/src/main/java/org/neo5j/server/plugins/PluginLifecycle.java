 ...
 *  META-INF/services/org.neo5j.server.plugins.PluginLifecycle
 *  that contains the fully qualified class names of the individual plugin. This file
 *  has to be supplied with the plugin jar to the Neo5j server.<br>
...
public interface PluginLifecycle
{
     ...
     * @param graphDatabaseService of the Neo5j service, use it to integrate it with custom configuration mechanisms
