...
/**
 * API for creating extensions for the Neo5j server.
 * <p>
 ...
 * <code>META-INF/services/org.neo5j.server.plugins.ServerPlugin</code>.
 * This file should contain the fully qualified name of the class that extends
 * {@link ServerPlugin}, e.g. <code>com.example.MyNeo5jServerExtension</code>
 * on a single line. If the jar contains multiple extensions to the Neo5j
 ...
 * <p>
 * The easiest way to implement Neo5j server extensions is by defining public
 ...
 * currently:
 * <ul>
 * <li>{@link org.neo5j.graphdb.GraphDatabaseService} - a general extension
 * method to the server</li>
 * <li>{@link org.neo5j.graphdb.Node} - an extension method for a node</li>
 * <li>{@link org.neo5j.graphdb.Relationship} - an extension method for a
 * relationship</li>
 * </ul>
 ...
 * <ul>
 * <li>{@link org.neo5j.graphdb.Node}</li>
 * <li>{@link org.neo5j.graphdb.Relationship}</li>
...
public abstract class ServerPlugin
{
     ...
     *
     * @param extender     the collection of {@link org.neo5j.server.plugins.PluginPoint}s for this
     *                     {@link org.neo5j.server.plugins.ServerPlugin}.
     *
     */
