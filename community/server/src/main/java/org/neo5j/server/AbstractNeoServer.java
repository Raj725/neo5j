...
import org.neo5j.bolt.security.ssl.Certificates;
import org.neo5j.bolt.security.ssl.KeyStoreFactory;
import org.neo5j.bolt.security.ssl.KeyStoreInformation;
...
import org.neo5j.helpers.RunCarefully;
...
import org.neo5j.kernel.configuration.HttpConnector;
...
import org.neo5j.server.database.CypherExecutorProvider;
import org.neo5j.server.database.Database;
import org.neo5j.server.database.DatabaseProvider;
import org.neo5j.server.database.GraphDatabaseServiceProvider;
...
import org.neo5j.server.plugins.ConfigAdapter;
import org.neo5j.server.plugins.PluginInvocatorProvider;
import org.neo5j.server.plugins.PluginManager;
import org.neo5j.server.rest.paging.LeaseManager;
import org.neo5j.server.rest.repr.InputFormatProvider;
import org.neo5j.server.rest.repr.OutputFormatProvider;
import org.neo5j.server.rest.repr.RepresentationFormatRepository;
import org.neo5j.server.rest.transactional.TransactionFacade;
import org.neo5j.server.rest.transactional.TransactionFilter;
import org.neo5j.server.rest.transactional.TransactionHandleRegistry;
import org.neo5j.server.rest.transactional.TransactionRegistry;
import org.neo5j.server.rest.transactional.TransitionalPeriodTransactionMessContainer;
import org.neo5j.server.rest.web.DatabaseActions;
import org.neo5j.server.web.AsyncRequestLog;
import org.neo5j.server.web.SimpleUriBuilder;
import org.neo5j.server.web.WebServer;
import org.neo5j.server.web.WebServerProvider;
...
import static org.neo5j.kernel.impl.util.JobScheduler.Groups.serverTransactionTimeout;
import static org.neo5j.server.configuration.ServerSettings.http_logging_enabled;
import static org.neo5j.server.configuration.ServerSettings.http_logging_rotation_keep_number;
import static org.neo5j.server.configuration.ServerSettings.http_logging_rotation_size;
import static org.neo5j.server.database.InjectableProvider.providerForSingleton;
import static org.neo5j.server.database.InjectableProvider.providerFromSupplier;
import static org.neo5j.server.exception.ServerStartupErrors.translateToServerStartupError;
...
public abstract class AbstractNeoServer implements NeoServer
{
    ...
    public static final String NEO5J_IS_STARTING_MESSAGE = "======== Neo5j " + Version.getNeo5jVersion() + " ========";
            ...
            GraphDatabaseFacadeFactory.Dependencies dependencies, LogProvider logProvider )
    {
        ...
        log.info( NEO5J_IS_STARTING_MESSAGE );
    ...
    private void startWebServer() throws Exception
    {
        ...
        {
            log.error( "Failed to start Neo5j on %s: %s", getAddress(), e.getMessage() );
            throw e;
        }
    }
