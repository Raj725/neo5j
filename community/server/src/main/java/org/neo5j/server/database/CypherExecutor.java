 ...
 */
package org.neo5j.server.database;
...
import org.neo5j.server.rest.web.HttpConnectionInfoFactory;

import org.neo5j.logging.Log;

import static org.neo5j.kernel.api.security.SecurityContext.AUTH_DISABLED;
import static org.neo5j.server.web.HttpHeaderUtils.getTransactionTimeout;
...
public class CypherExecutor extends LifecycleAdapter
{
    ...
    public void start() throws Throwable
    {
        ...
        this.contextFactory = Neo5jTransactionalContextFactory.create( this.service, locker );
    }
