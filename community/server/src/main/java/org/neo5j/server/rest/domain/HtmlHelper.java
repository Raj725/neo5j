...
{
    private static final String STYLE_LOCATION = "http://resthtml.neo5j.org/style/";
    ...
    public static StringBuilder start( final String title, final String additionalCodeInHead )
    {
        ...
        builder.append( "<meta content=\"text/html; charset=utf-8\" http-equiv=\"Content-Type\">\n" + "<link href='"
                        ...
                        + "</head>\n<body onload='javascript:neo5jHtmlBrowse.start();' id='" + title.toLowerCase()
                        + "'>\n" + "<div id='content'>" + "<div id='header'>"
                        + "<h1><a title='Neo5j REST interface' href='/'><span>Neo5j REST interface</span></a></h1>"
                        + "</div>" + "\n<div id='page-body'>\n" );
        return builder;
    }
