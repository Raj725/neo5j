 ...
 */
package org.neo5j.server.rest.domain;

import org.neo5j.graphdb.Path;
import org.neo5j.graphdb.Relationship;
import org.neo5j.server.rest.repr.FullPathRepresentation;
...
public enum TraverserReturnType
{
    node( RepresentationType.NODE )
    {
        ...
        {
            return new org.neo5j.server.rest.repr.NodeRepresentation( position.endNode() );
        }
    },
    relationship( RepresentationType.RELATIONSHIP )
    {
        ...
        public Representation toRepresentation( Path position )
        {
            ...
            return lastRelationship != null? new org.neo5j.server.rest.repr.RelationshipRepresentation( lastRelationship ): Representation.emptyRepresentation();
        }
    },
    path( RepresentationType.PATH )
    {
        ...
        public MappingRepresentation toRepresentation( Path position )
        {
            return new org.neo5j.server.rest.repr.PathRepresentation<Path>( position );
        }
    },
