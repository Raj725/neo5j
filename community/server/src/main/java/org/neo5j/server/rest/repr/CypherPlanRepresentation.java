...
import static org.neo5j.server.rest.repr.ObjectToRepresentationConverter.getMapRepresentation;

/**
 * This takes a function that resolves to a {@link org.neo5j.graphdb.ExecutionPlanDescription}, and it does so for two reasons:
