...
import static org.neo5j.server.rest.web.Surface.PATH_BATCH;
import static org.neo5j.server.rest.web.Surface.PATH_CYPHER;
import static org.neo5j.server.rest.web.Surface.PATH_EXTENSIONS;
...
import static org.neo5j.server.rest.web.Surface.PATH_RELATIONSHIP_TYPES;
...
import static org.neo5j.server.rest.web.Surface.PATH_TRANSACTION;
...
public class DatabaseRepresentation extends MappingRepresentation implements ExtensibleRepresentation
{
    ...
    protected void serialize( MappingSerializer serializer )
    {
        ...
        serializer.putString( "neo5j_version", Version.getNeo5jVersion() );
    }
}
