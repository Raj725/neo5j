...
import org.neo5j.server.helpers.PropertyTypeDispatcher;

import static org.neo5j.server.rest.repr.ValueRepresentation.bool;
import static org.neo5j.server.rest.repr.ValueRepresentation.number;
import static org.neo5j.server.rest.repr.ValueRepresentation.string;

/**
 * Converts common primitive and basic objects and arrays of the same into a
 * representation. Handy for specialization.
 *
 * @see org.neo5j.server.rest.management.repr.JmxAttributeRepresentationDispatcher
 */
