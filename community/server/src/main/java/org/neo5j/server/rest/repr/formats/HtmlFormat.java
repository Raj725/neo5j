...
import org.neo5j.server.rest.domain.HtmlHelper;
    ...
    private enum MappingTemplate
    {
        NODE( Representation.NODE )
        {
            ...
            String render( Map<String, Object> serialized )
            {
                ...
                builder.append( "<form action='javascript:neo5jHtmlBrowse.getRelationships();'><fieldset><legend>Get relationships</legend>\n" );
    ...
    private static String renderIndex( Map<String, Object> serialized )
    {
        ...
        for ( String indexName : serialized.keySet() )
        {
            ...
            builder.append( "<ul>" );
            {
                ...
                builder.append( "<form action='javascript:neo5jHtmlBrowse.search(\"" )
