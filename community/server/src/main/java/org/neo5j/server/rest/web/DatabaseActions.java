 ...
 */
package org.neo5j.server.rest.web;
...
import org.neo5j.graphalgo.CommonEvaluators;
import org.neo5j.graphalgo.CostEvaluator;
import org.neo5j.graphalgo.GraphAlgoFactory;
import org.neo5j.graphalgo.PathFinder;
import org.neo5j.graphalgo.WeightedPath;
...
import org.neo5j.graphdb.PathExpander;
import org.neo5j.graphdb.PathExpanderBuilder;
import org.neo5j.graphdb.PathExpanders;
import org.neo5j.graphdb.PropertyContainer;
import org.neo5j.graphdb.Relationship;
import org.neo5j.graphdb.RelationshipType;
import org.neo5j.graphdb.ResourceIterable;
import org.neo5j.graphdb.index.AutoIndexer;
import org.neo5j.graphdb.index.Index;
import org.neo5j.graphdb.index.IndexHits;
import org.neo5j.graphdb.index.IndexManager;
import org.neo5j.graphdb.index.ReadableIndex;
import org.neo5j.graphdb.index.UniqueFactory;
import org.neo5j.graphdb.index.UniqueFactory.UniqueEntity;
import org.neo5j.graphdb.schema.ConstraintCreator;
import org.neo5j.graphdb.schema.ConstraintDefinition;
import org.neo5j.graphdb.schema.ConstraintType;
import org.neo5j.graphdb.schema.IndexCreator;
import org.neo5j.graphdb.schema.IndexDefinition;
import org.neo5j.graphdb.traversal.BranchState;
import org.neo5j.graphdb.traversal.Paths;
...
import org.neo5j.index.lucene.QueryContext;
import org.neo5j.kernel.internal.GraphDatabaseAPI;
import org.neo5j.server.database.InjectableProvider;
import org.neo5j.server.rest.domain.EndNodeNotFoundException;
import org.neo5j.server.rest.domain.PropertySettingStrategy;
import org.neo5j.server.rest.domain.RelationshipExpanderBuilder;
import org.neo5j.server.rest.domain.StartNodeNotFoundException;
import org.neo5j.server.rest.domain.TraversalDescriptionBuilder;
import org.neo5j.server.rest.domain.TraverserReturnType;
import org.neo5j.server.rest.paging.Lease;
import org.neo5j.server.rest.paging.LeaseManager;
import org.neo5j.server.rest.paging.PagedTraverser;
import org.neo5j.server.rest.repr.BadInputException;
import org.neo5j.server.rest.repr.ConstraintDefinitionRepresentation;
import org.neo5j.server.rest.repr.DatabaseRepresentation;
import org.neo5j.server.rest.repr.IndexDefinitionRepresentation;
import org.neo5j.server.rest.repr.IndexRepresentation;
import org.neo5j.server.rest.repr.IndexedEntityRepresentation;
import org.neo5j.server.rest.repr.InvalidArgumentsException;
import org.neo5j.server.rest.repr.ListRepresentation;
import org.neo5j.server.rest.repr.NodeIndexRepresentation;
import org.neo5j.server.rest.repr.NodeIndexRootRepresentation;
import org.neo5j.server.rest.repr.NodeRepresentation;
import org.neo5j.server.rest.repr.PathRepresentation;
import org.neo5j.server.rest.repr.PropertiesRepresentation;
import org.neo5j.server.rest.repr.RelationshipIndexRepresentation;
import org.neo5j.server.rest.repr.RelationshipIndexRootRepresentation;
import org.neo5j.server.rest.repr.RelationshipRepresentation;
import org.neo5j.server.rest.repr.Representation;
import org.neo5j.server.rest.repr.RepresentationType;
import org.neo5j.server.rest.repr.ScoredNodeRepresentation;
import org.neo5j.server.rest.repr.ScoredRelationshipRepresentation;
import org.neo5j.server.rest.repr.ValueRepresentation;
import org.neo5j.server.rest.repr.WeightedPathRepresentation;

import static org.neo5j.graphdb.Label.label;
import static org.neo5j.helpers.collection.Iterables.filter;
import static org.neo5j.helpers.collection.Iterables.map;
import static org.neo5j.helpers.collection.Iterators.asList;
import static org.neo5j.server.rest.repr.RepresentationType.CONSTRAINT_DEFINITION;
...
public class DatabaseActions
{
            ...
            BadInputException
    {
        ...
        catch ( org.neo5j.graphdb.ConstraintViolationException e )
        {
