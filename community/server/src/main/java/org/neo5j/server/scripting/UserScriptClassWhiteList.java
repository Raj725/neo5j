 ...
 * the effect of it.
 *
 * Assume that people using these classes will be using a Neo5j database that runs in a co-located environment, and that
...
public class UserScriptClassWhiteList
{
    ...
    public static Set<String> getWhiteList()
    {
        ...
        safe.add( "org.neo5j.kernel.impl.traversal.StartNodeTraversalBranch" );
        safe.add( "org.neo5j.kernel.impl.traversal.TraversalBranchImpl" );
        safe.add( "org.neo5j.kernel.impl.core.NodeProxy" );
