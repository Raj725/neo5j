...
import static org.neo5j.kernel.lifecycle.LifecycleStatus.STARTING;
...
public class ServerStartupErrorsTest
{
    ...
    public void shouldDescribeUpgradeFailureInAFriendlyWay()
    {
        ...
        LifecycleException error = new LifecycleException( new Object(), STARTING, STARTED,
                new RuntimeException( "Error starting org.neo5j.kernel.ha.factory.EnterpriseFacadeFactory",
        ...
        logging.assertExactly( inLog( "console" )
                .error( "Neo5j cannot be started, because the database files require upgrading and upgrades are " +
