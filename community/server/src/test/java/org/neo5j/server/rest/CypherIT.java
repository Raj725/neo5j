...
import org.neo5j.test.GraphDescription;
import org.neo5j.test.GraphDescription.Graph;
import org.neo5j.test.GraphDescription.LABEL;
import org.neo5j.test.GraphDescription.NODE;
import org.neo5j.test.GraphDescription.PROP;
import org.neo5j.test.GraphDescription.REL;
import org.neo5j.test.TestData.Title;
...
import static org.neo5j.server.rest.domain.JsonHelper.jsonToMap;
...
public class CypherIT extends AbstractRestFunctionalTestBase
{
    ...
    public void testQueryStatistics() throws JsonParseException
    {
        ...
        Map<String,Object> output =
                jsonToMap( doCypherRestCall( cypherUri() + "?includeStats=true", script, Status.OK ) );
    ...
    public void send_query_to_create_a_node_from_a_map() throws Exception
    {
        ...
        String params =
                "\"props\" : { \"position\" : \"Developer\", \"name\" : \"Michael\", \"awesome\" : true, \"children\" : 3 }";
    ...
    public void setAllPropertiesUsingMap() throws Exception
    {
        ...
        String params =
                "\"props\" : { \"position\" : \"Developer\", \"firstName\" : \"Michael\", \"awesome\" : true, \"children\" : 3 }";
        String response = cypherRestCall( script, Status.OK, params );
    ...
    @Test
    @Graph( nodes = {@NODE( name = "I", properties = {
    ...
    public void nested_results() throws Exception
    {
        ...
        assertThat( response, anyOf( containsString( "\"I\",\"you\"" ), containsString( "\"you\",\"I\"" ),
                containsString( "\"I\", \"you\"" ), containsString( "\"you\", \"I\"" ) ) );
    }
    ...
    public void send_queries_with_errors() throws Exception
    {
        ...
        assertThat( responseMap.keySet(),
                containsInAnyOrder( "message", "exception", "fullname", "stackTrace", "cause", "errors" ) );
