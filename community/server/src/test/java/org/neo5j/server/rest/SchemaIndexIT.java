...
import static org.neo5j.server.rest.domain.JsonHelper.jsonToList;
...
public class SchemaIndexIT extends AbstractRestFunctionalTestBase
{
    ...
    public void drop_index() throws Exception
    {
        ...
        assertThat( Neo5jMatchers.getIndexes( graphdb(), label( labelName ) ), containsOnly( schemaIndex ) );
        ...
        assertThat( Neo5jMatchers.getIndexes( graphdb(), label( labelName ) ), not( containsOnly( schemaIndex ) ) );
    }
