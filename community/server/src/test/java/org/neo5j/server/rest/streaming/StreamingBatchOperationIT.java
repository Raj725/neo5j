 ...
 */
package org.neo5j.server.rest.streaming;
...
import org.neo5j.server.rest.JaxRsResponse;
import org.neo5j.server.rest.PrettyJSON;
import org.neo5j.server.rest.RestRequest;
...
//        assertEquals(1, JsonHelper.jsonToList(  rels ).size());
            ...
            UniformInterfaceException, JSONException, JsonParseException
    {
        ...
        assertThat( gnode, inTx(graphdb(), Neo5jMatchers.hasProperty( "name" ).withValue(string)) );
