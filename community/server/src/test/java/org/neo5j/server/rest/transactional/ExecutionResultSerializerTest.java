...
import org.neo5j.graphdb.impl.notification.NotificationCode;
import org.neo5j.graphdb.spatial.Coordinate;
...
import org.neo5j.test.mockito.mock.GraphMock;
import org.neo5j.test.mockito.mock.Link;
...
import static org.neo5j.server.rest.domain.JsonHelper.jsonNode;
import static org.neo5j.server.rest.domain.JsonHelper.readJson;
import static org.neo5j.server.rest.transactional.Neo5jJsonCodecTest.*;
import static org.neo5j.test.Property.property;
import static org.neo5j.test.mockito.mock.GraphMock.link;
import static org.neo5j.test.mockito.mock.GraphMock.node;
import static org.neo5j.test.mockito.mock.GraphMock.path;
import static org.neo5j.test.mockito.mock.GraphMock.relationship;
import static org.neo5j.test.mockito.mock.Properties.properties;
...
public class ExecutionResultSerializerTest extends TxStateCheckerTestSupport
{
    ...
    public void shouldSerializeResponseWithCommitUriAndResultsAndErrors() throws Exception
    {
        ...
        serializer.transactionCommitUri( URI.create( "commit/uri/1" ) );
        serializer.statementResult( executionResult, false );
        serializer.errors( asList( new Neo5jError( Status.Request.InvalidFormat, new Exception( "cause1" ) ) ) );
        serializer.finish();
    ...
    public void shouldProduceWellFormedJsonEvenIfResultIteratorThrowsExceptionOnNext() throws Exception
    {
        ...
        {
            serializer.errors( asList( new Neo5jError( Status.Statement.ExecutionFailed, e ) ) );
        }
        serializer.finish();
