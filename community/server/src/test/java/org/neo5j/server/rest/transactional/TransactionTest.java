...
import org.neo5j.server.rest.RESTRequestGenerator.ResponseEntity;
import org.neo5j.server.rest.domain.JsonParseException;
import org.neo5j.server.rest.repr.util.RFC1123;
...
import static org.neo5j.test.server.HTTP.GET;
...
public class TransactionTest extends AbstractRestFunctionalTestBase
{
    ...
    @Documented( "Execute statements in an open transaction in REST format for the return.\n" +
                 ...
                 "give back full Neo5j Rest API representations of the Neo5j Nodes, Relationships and Paths, if returned." )
