...
import static org.neo5j.kernel.api.exceptions.Status.Statement.SyntaxError;
import static org.neo5j.server.rest.transactional.integration.TransactionMatchers.containsNoStackTraces;
import static org.neo5j.server.rest.transactional.integration.TransactionMatchers.hasErrors;
import static org.neo5j.test.server.HTTP.POST;
