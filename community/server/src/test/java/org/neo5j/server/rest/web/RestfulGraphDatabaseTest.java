...
import org.neo5j.kernel.api.exceptions.Status.Request;
import org.neo5j.kernel.api.exceptions.Status.Schema;
import org.neo5j.kernel.api.exceptions.Status.Statement;
...
import org.neo5j.server.rest.web.RestfulGraphDatabase.AmpersandSeparatedCollection;
...
import static org.neo5j.kernel.api.exceptions.Status.Request.InvalidFormat;
...
public class RestfulGraphDatabaseTest
{
    ...
    private static final String BASE_URI = "http://neo5j.org/";
...
//        assertNotNull( map.get( "reference_node" ) );
        assertNotNull( map.get( "neo5j_version" ) );
...
//        assertEquals( Statement..code().serialize(), singleErrorCode( response ) );
    ...
    public void shouldAdvertiseUriForQueringAllRelationsInTheDatabase()
    {
        ...
        assertThat( new String( (byte[]) response.getEntity() ),
                containsString( "\"relationship_types\" : \"http://neo5j.org/relationship/types\"" ) );
    }
