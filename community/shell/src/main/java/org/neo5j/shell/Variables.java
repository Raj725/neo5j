...
{
    /**
     * The {@link org.neo5j.shell.Session} key to use to store the current node and working
     ...
     * @throws org.neo5j.shell.ShellException if key doesn't match a valid identifier name
     */
