 ...
 */
package org.neo5j.shell.kernel;
...
import org.neo5j.shell.ShellServer;
import org.neo5j.shell.Variables;
import org.neo5j.shell.Welcome;
import org.neo5j.shell.impl.AbstractAppServer;
import org.neo5j.shell.impl.BashVariableInterpreter.Replacer;
import org.neo5j.shell.kernel.apps.TransactionProvidingApp;

import static org.neo5j.shell.Variables.PROMPT_KEY;
...
public class GraphDatabaseShellServer extends AbstractAppServer
{
    ...
    */
    ...
    {
        try ( org.neo5j.graphdb.Transaction transaction = this.getDb().beginTx() )
        {
    ...
    {
        return "Welcome to the Neo5j Shell! Enter 'help' for a list of commands. " +
                "Please note that neo5j-shell is deprecated and to be replaced by cypher-shell.";
    }
    ...
    {
        try ( org.neo5j.graphdb.Transaction transaction = graphDb.beginTx() )
        {
