...
import org.neo5j.graphdb.schema.Schema.IndexState;
...
import org.neo5j.kernel.impl.api.index.sampling.IndexSamplingMode;
import org.neo5j.shell.AppCommandParser;
import org.neo5j.shell.ColumnPrinter;
...
import static org.neo5j.helpers.collection.Iterables.concat;
import static org.neo5j.helpers.collection.Iterables.filter;
import static org.neo5j.helpers.collection.Iterables.indexOf;
import static org.neo5j.helpers.collection.Iterables.sort;
import static org.neo5j.shell.Continuation.INPUT_COMPLETE;
...
public class Schema extends TransactionProvidingApp
{
    ...
    protected Continuation exec( AppCommandParser parser, Session session, Output out ) throws Exception
    {
        ...
        org.neo5j.graphdb.schema.Schema schema = getServer().getDb().schema();
    ...
    private void listIndexesAndConstraints( Output out, org.neo5j.graphdb.schema.Schema schema, Label[] labels,
    ...
    private void printIndexProgress( Output out, org.neo5j.graphdb.schema.Schema schema, Label[] labels,
    ...
    private void awaitIndexes( Output out, org.neo5j.graphdb.schema.Schema schema, Label[] labels, String property )
    ...
    private void listNodeIndexesAndConstraints( Output out, org.neo5j.graphdb.schema.Schema schema, Label[] labels,
    ...
    private void listRelationshipIndexesAndConstraints( Output out, org.neo5j.graphdb.schema.Schema schema,
    ...
    private void listAllIndexesAndConstraints( Output out, org.neo5j.graphdb.schema.Schema schema, Label[] labels,
            RelationshipType[] types, String property, boolean verbose ) throws RemoteException
    {
        reportNodeIndexes( out, schema, labels, property, verbose );
    ...
    private void reportNodeConstraints( Output out, org.neo5j.graphdb.schema.Schema schema,
    ...
    private void reportRelationshipConstraints( Output out, org.neo5j.graphdb.schema.Schema schema,
    ...
    private void reportAllConstraints( Output out, org.neo5j.graphdb.schema.Schema schema,
    ...
    private void reportNodeIndexes( Output out, org.neo5j.graphdb.schema.Schema schema, Label[] labels, String property,
    ...
    private Iterable<IndexDefinition> indexesByLabelAndProperty( org.neo5j.graphdb.schema.Schema schema,
    ...
    private Iterable<ConstraintDefinition> constraintsByLabelAndProperty( org.neo5j.graphdb.schema.Schema schema,
    ...
    private Iterable<ConstraintDefinition> constraintsByTypeAndProperty( org.neo5j.graphdb.schema.Schema schema,
    ...
    private Iterable<IndexDefinition> indexesByLabel( org.neo5j.graphdb.schema.Schema schema, Label[] labels )
    {
