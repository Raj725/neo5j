...
import org.neo5j.shell.TextUtil;
import org.neo5j.shell.impl.AbstractApp;
import org.neo5j.shell.kernel.GraphDatabaseShellServer;
import org.neo5j.shell.util.json.JSONArray;
import org.neo5j.shell.util.json.JSONException;

import static org.neo5j.kernel.api.KernelTransaction.Type.implicit;
import static org.neo5j.kernel.api.security.SecurityContext.AUTH_DISABLED;
import static org.neo5j.shell.ShellException.stackTraceAsString;
...
public abstract class TransactionProvidingApp extends AbstractApp
{
    ...
    protected static final String[] STANDARD_EVAL_IMPORTS = new String[] {
        "org.neo5j.graphdb",
        "org.neo5j.graphdb.event",
        "org.neo5j.graphdb.index",
    ...
    protected void setProperties( PropertyContainer entity, String propertyJson ) throws ShellException
    {
        ...
        try
        {
            ...
            {
                entity.setProperty( entry.getKey(), jsonToNeo5jPropertyValue( entry.getValue() ) );
            }
        }
    ...
    private Object jsonToNeo5jPropertyValue( Object value ) throws ShellException
    {
        try
        {
    ...
    /**
     * Reads the session variable specified in {@link org.neo5j.shell.Variables#WORKING_DIR_KEY} and
