 ...
 */
package org.neo5j.shell.kernel.apps.cypher;
...
import org.neo5j.shell.OutputAsWriter;
import org.neo5j.shell.Session;
import org.neo5j.shell.ShellException;
import org.neo5j.shell.kernel.apps.NodeOrRelationship;
...
public class Start extends TransactionProvidingApp
{
            ...
            Session session )
    {
        ...
        TransactionalContextFactory contextFactory =
            Neo5jTransactionalContextFactory.create( graph, new PropertyContainerLocker() );
