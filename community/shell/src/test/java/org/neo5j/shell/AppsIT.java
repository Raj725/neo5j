...
import org.neo5j.cypher.NodeStillHasRelationshipsException;
...
import static org.neo5j.helpers.collection.MapUtil.genericMap;
import static org.neo5j.test.mockito.matcher.Neo5jMatchers.findNodesByLabelAndProperty;
import static org.neo5j.test.mockito.matcher.Neo5jMatchers.hasLabels;
import static org.neo5j.test.mockito.matcher.Neo5jMatchers.hasProperty;
import static org.neo5j.test.mockito.matcher.Neo5jMatchers.hasSize;
import static org.neo5j.test.mockito.matcher.Neo5jMatchers.inTx;
import static org.neo5j.test.mockito.matcher.Neo5jMatchers.waitForIndex;
...
public class AppsIT extends AbstractShellIT
{
    ...
    public void canDisableWelcomeMessage() throws Exception
    {
        ...
        assertEquals( "Shows welcome message: " + outString, false,
                outString.contains( "Welcome to the Neo5j Shell! Enter 'help' for a list of commands" ) );
    }
    ...
    public void doesShowWelcomeMessage() throws Exception
    {
        ...
        client.shutdown();
        final String outString = out.asString();
        assertEquals( "Shows welcome message: " + outString, true, outString.contains( "Welcome to the Neo5j Shell! Enter 'help' for a list of commands" ) );
    }
