...
import static org.neo5j.ext.udc.UdcConstants.CLUSTER_HASH;
import static org.neo5j.ext.udc.UdcConstants.DATABASE_MODE;
import static org.neo5j.ext.udc.UdcConstants.DISTRIBUTION;
import static org.neo5j.ext.udc.UdcConstants.EDITION;
import static org.neo5j.ext.udc.UdcConstants.FEATURES;
import static org.neo5j.ext.udc.UdcConstants.HEAP_SIZE;
import static org.neo5j.ext.udc.UdcConstants.ID;
import static org.neo5j.ext.udc.UdcConstants.LABEL_IDS_IN_USE;
import static org.neo5j.ext.udc.UdcConstants.MAC;
import static org.neo5j.ext.udc.UdcConstants.NODE_IDS_IN_USE;
import static org.neo5j.ext.udc.UdcConstants.NUM_PROCESSORS;
import static org.neo5j.ext.udc.UdcConstants.OS_PROPERTY_PREFIX;
import static org.neo5j.ext.udc.UdcConstants.PROPERTY_IDS_IN_USE;
import static org.neo5j.ext.udc.UdcConstants.REGISTRATION;
import static org.neo5j.ext.udc.UdcConstants.RELATIONSHIP_IDS_IN_USE;
import static org.neo5j.ext.udc.UdcConstants.REVISION;
import static org.neo5j.ext.udc.UdcConstants.SERVER_ID;
import static org.neo5j.ext.udc.UdcConstants.SOURCE;
import static org.neo5j.ext.udc.UdcConstants.STORE_SIZE;
import static org.neo5j.ext.udc.UdcConstants.TAGS;
import static org.neo5j.ext.udc.UdcConstants.TOTAL_MEMORY;
import static org.neo5j.ext.udc.UdcConstants.UDC_PROPERTY_PREFIX;
import static org.neo5j.ext.udc.UdcConstants.UNKNOWN_DIST;
import static org.neo5j.ext.udc.UdcConstants.USER_AGENTS;
import static org.neo5j.ext.udc.UdcConstants.VERSION;
...
public class DefaultUdcInformationCollector implements UdcInformationCollector
{
    ...
    private Integer determineClusterNameHash()
    {
        try
        {
            Class<?> settings = Class.forName( "org.neo5j.cluster.ClusterSettings" );
    ...
    private final Map<String,String> jarNamesForTags =
            MapUtil.stringMap( "spring-", "spring", "(javax.ejb|ejb-jar)", "ejb",
                    ...
                    "groovy", "groovy", "(tomcat|jetty)", "web", "spring-data-neo5j", "sdn" );
