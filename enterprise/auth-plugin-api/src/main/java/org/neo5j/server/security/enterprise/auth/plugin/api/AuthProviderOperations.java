 ...
 */
package org.neo5j.server.security.enterprise.auth.plugin.api;
...
/**
 * These are the methods that the plugin can perform on Neo5j.
 */
public interface AuthProviderOperations
{
    /**
     * Returns the path to the Neo5j home directory.
     *
     * @return the path to the Neo5j home directory
     */
    Path neo5jHome();

    /**
     * Returns the path to the Neo5j configuration file if one exists.
     *
     * @return the path to the Neo5j configuration file if one exists
     */
    Optional<Path> neo5jConfigFile();

    /**
     * Returns the Neo5j version.
     *
     * @return the Neo5j version
     */
    String neo5jVersion();

    /**
     * Returns the clock that is used by the Neo5j security module within which this auth provider plugin is running.
     *
     * @return the clock that is used by the Neo5j security module
     */
    Clock clock();

    /**
     * Returns the security log that is used by the Neo5j security module within which this auth provider plugin is
     * running.
     *
     * @return the security log that is used by the Neo5j security module
     */
    Log log();

    /**
     * An interface to the security log that is used by the Neo5j security module.
     */
    interface Log
    {
        /**
