 ...
 *
 * @see org.neo5j.server.security.enterprise.auth.plugin.spi.AuthenticationPlugin#authenticate(AuthToken)
 * @see org.neo5j.server.security.enterprise.auth.plugin.spi.AuthPlugin#authenticateAndAuthorize(AuthToken)
 */
public interface AuthToken
{
     ...
     * to a server-side auth plugin. Neo5j will act as a pure transport and will not touch the contents of this map.
     *
