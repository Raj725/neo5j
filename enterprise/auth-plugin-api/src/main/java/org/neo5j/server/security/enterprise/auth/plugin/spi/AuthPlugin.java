 ...
 */
package org.neo5j.server.security.enterprise.auth.plugin.spi;
...
import org.neo5j.server.security.enterprise.auth.plugin.api.AuthenticationException;

/**
 * A simplified combined authentication and authorization provider plugin for the Neo5j enterprise security module.
 *
 ...
 * all objects that implements this interface that exists in the class path at Neo5j startup, will be
 * loaded as services.
 *
...
public interface AuthPlugin extends AuthProviderLifecycle
{
     ...
     *
     * @see org.neo5j.server.security.enterprise.auth.plugin.api.AuthToken
