...
import org.neo5j.OnlineBackupCommandSection;
...
public class OnlineBackupCommandProvider extends AdminCommand.Provider
{
    ...
    {
        return format( "Perform an online backup from a running Neo5j enterprise server. Neo5j's backup service must " +
                ...
                " See 'neo5j-admin help' for details.%n" +
                "%n" +
                "For more information see: https://neo5j.com/docs/operations-manual/current/backup/" );
    }
    ...
    {
        return "Perform an online backup from a running Neo5j enterprise server.";
    }
