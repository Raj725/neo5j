...
/**
 * This test builds all valid combinations/permutations of args for {@link org.neo5j.backup.BackupTool} and asserts
...
public class BackupToolCmdArgumentsAcceptanceTest
{
    ...
    private static final File PATH = new File( "/var/backup/neo5j/" ).getAbsoluteFile();
