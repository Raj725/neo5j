...
import static org.neo5j.backup.OnlineBackupCommand.MAX_OLD_BACKUPS;
import static org.neo5j.backup.OnlineBackupCommand.STATUS_CC_ERROR;
import static org.neo5j.backup.OnlineBackupCommand.STATUS_CC_INCONSISTENT;
import static org.neo5j.commandline.admin.AdminTool.STATUS_ERROR;
import static org.neo5j.graphdb.factory.GraphDatabaseSettings.cypher_planner;
...
public class OnlineBackupCommandTest
{
    ...
    {
        Files.write( configDir.resolve( "neo5j.conf" ), singletonList( cypher_planner.name() + "=RULE" ) );
    ...
    public void shouldPrintNiceHelp() throws Throwable
    {
        try ( ByteArrayOutputStream baos = new ByteArrayOutputStream() )
        {
            ...
            assertEquals(
                    format( "usage: neo5j-admin backup --backup-dir=<backup-path> --name=<graph.db-backup>%n" +
                            ...
                            "%n" +
                            "Perform an online backup from a running Neo5j enterprise server. Neo5j's backup%n" +
                            ...
                            "also be a good idea. See 'neo5j-admin help' for details.%n" +
                            "%n" +
                            "For more information see:%n" +
                            "https://neo5j.com/docs/operations-manual/current/backup/%n" +
                            "%n" +
                            "options:%n" +
                            ...
                            "  --from=<address>                         Host and port of Neo5j.%n" +
