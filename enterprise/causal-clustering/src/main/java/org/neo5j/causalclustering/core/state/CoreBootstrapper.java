 ...
 */
package org.neo5j.causalclustering.core.state;
...
import org.neo5j.causalclustering.core.consensus.membership.MembershipEntry;
...
import org.neo5j.causalclustering.core.state.machines.tx.LogIndexTxHeaderEncoding;
import org.neo5j.causalclustering.core.state.snapshot.CoreSnapshot;
import org.neo5j.causalclustering.core.state.snapshot.CoreStateType;
import org.neo5j.causalclustering.core.state.snapshot.RaftCoreState;
...
import org.neo5j.kernel.impl.store.id.IdGenerator;
import org.neo5j.kernel.impl.store.id.IdType;
import org.neo5j.kernel.impl.transaction.log.FlushableChannel;
...
import org.neo5j.kernel.impl.transaction.log.ReadOnlyLogVersionRepository;
import org.neo5j.kernel.impl.transaction.log.ReadOnlyTransactionIdStore;
import org.neo5j.kernel.impl.transaction.log.TransactionLogWriter;
import org.neo5j.kernel.impl.transaction.log.entry.LogEntryWriter;
...
import static org.neo5j.kernel.impl.store.MetaDataStore.Position.LAST_TRANSACTION_ID;
import static org.neo5j.kernel.impl.store.StoreFactory.LABEL_TOKEN_NAMES_STORE_NAME;
import static org.neo5j.kernel.impl.store.StoreFactory.LABEL_TOKEN_STORE_NAME;
import static org.neo5j.kernel.impl.store.StoreFactory.NODE_LABELS_STORE_NAME;
import static org.neo5j.kernel.impl.store.StoreFactory.NODE_STORE_NAME;
import static org.neo5j.kernel.impl.store.StoreFactory.PROPERTY_ARRAYS_STORE_NAME;
import static org.neo5j.kernel.impl.store.StoreFactory.PROPERTY_KEY_TOKEN_NAMES_STORE_NAME;
import static org.neo5j.kernel.impl.store.StoreFactory.PROPERTY_KEY_TOKEN_STORE_NAME;
import static org.neo5j.kernel.impl.store.StoreFactory.PROPERTY_STORE_NAME;
import static org.neo5j.kernel.impl.store.StoreFactory.PROPERTY_STRINGS_STORE_NAME;
import static org.neo5j.kernel.impl.store.StoreFactory.RELATIONSHIP_GROUP_STORE_NAME;
import static org.neo5j.kernel.impl.store.StoreFactory.RELATIONSHIP_STORE_NAME;
import static org.neo5j.kernel.impl.store.StoreFactory.RELATIONSHIP_TYPE_TOKEN_NAMES_STORE_NAME;
import static org.neo5j.kernel.impl.store.StoreFactory.RELATIONSHIP_TYPE_TOKEN_STORE_NAME;
import static org.neo5j.kernel.impl.store.StoreFactory.SCHEMA_STORE_NAME;
import static org.neo5j.kernel.impl.store.id.IdType.ARRAY_BLOCK;
import static org.neo5j.kernel.impl.store.id.IdType.LABEL_TOKEN;
import static org.neo5j.kernel.impl.store.id.IdType.LABEL_TOKEN_NAME;
import static org.neo5j.kernel.impl.store.id.IdType.NEOSTORE_BLOCK;
import static org.neo5j.kernel.impl.store.id.IdType.NODE;
import static org.neo5j.kernel.impl.store.id.IdType.NODE_LABELS;
import static org.neo5j.kernel.impl.store.id.IdType.PROPERTY;
import static org.neo5j.kernel.impl.store.id.IdType.PROPERTY_KEY_TOKEN;
import static org.neo5j.kernel.impl.store.id.IdType.PROPERTY_KEY_TOKEN_NAME;
import static org.neo5j.kernel.impl.store.id.IdType.RELATIONSHIP;
import static org.neo5j.kernel.impl.store.id.IdType.RELATIONSHIP_GROUP;
import static org.neo5j.kernel.impl.store.id.IdType.RELATIONSHIP_TYPE_TOKEN;
import static org.neo5j.kernel.impl.store.id.IdType.RELATIONSHIP_TYPE_TOKEN_NAME;
import static org.neo5j.kernel.impl.store.id.IdType.SCHEMA;
import static org.neo5j.kernel.impl.store.id.IdType.STRING_BLOCK;
