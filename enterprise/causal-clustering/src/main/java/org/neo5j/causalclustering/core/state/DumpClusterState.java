...
import org.neo5j.causalclustering.core.state.storage.SimpleFileStorage;
import org.neo5j.causalclustering.core.state.storage.SimpleStorage;
import org.neo5j.causalclustering.core.state.storage.StateMarshal;
import org.neo5j.causalclustering.identity.MemberId;
import org.neo5j.causalclustering.identity.MemberId.Marshal;
...
import static org.neo5j.causalclustering.ReplicationModule.SESSION_TRACKER_NAME;
import static org.neo5j.causalclustering.core.IdentityModule.CORE_MEMBER_ID_NAME;
import static org.neo5j.causalclustering.core.consensus.ConsensusModule.RAFT_MEMBERSHIP_NAME;
import static org.neo5j.causalclustering.core.consensus.ConsensusModule.RAFT_TERM_NAME;
import static org.neo5j.causalclustering.core.consensus.ConsensusModule.RAFT_VOTE_NAME;
import static org.neo5j.causalclustering.core.server.CoreServerModule.LAST_FLUSHED_NAME;
import static org.neo5j.causalclustering.core.state.machines.CoreStateMachinesModule.ID_ALLOCATION_NAME;
import static org.neo5j.causalclustering.core.state.machines.CoreStateMachinesModule.LOCK_TOKEN_NAME;
