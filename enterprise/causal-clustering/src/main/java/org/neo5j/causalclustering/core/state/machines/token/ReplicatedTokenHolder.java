...
import org.neo5j.kernel.impl.core.NonUniqueTokenException;
import org.neo5j.kernel.impl.core.TokenHolder;
...
abstract class ReplicatedTokenHolder<TOKEN extends Token> implements TokenHolder<TOKEN>
{
    ...
    private int requestToken( String tokenName )
    {
        ...
        {
            throw new org.neo5j.graphdb.TransactionFailureException( "Could not create token", e );
        }
