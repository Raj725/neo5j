 ...
 */
package org.neo5j.causalclustering.identity;
...
public final class StoreId
{
    public static final StoreId DEFAULT = new StoreId(
            org.neo5j.kernel.impl.store.StoreId.DEFAULT.getCreationTime(),
            org.neo5j.kernel.impl.store.StoreId.DEFAULT.getRandomId(),
            org.neo5j.kernel.impl.store.StoreId.DEFAULT.getUpgradeTime(),
            org.neo5j.kernel.impl.store.StoreId.DEFAULT.getUpgradeId() );
    ...
    public boolean equalToKernelStoreId( org.neo5j.kernel.impl.store.StoreId kenelStoreId )
    {
