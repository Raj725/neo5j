...
public class UnbindFromClusterCommand implements AdminCommand
{
    ...
    public void execute( String[] args ) throws IncorrectUsage, CommandFailed
    {
        try
        {
            Config config = loadNeo5jConfig( homeDir, configDir, arguments.parse( args ).get( "database" ) );
        ...
        {
            throw new CommandFailed( "Database is currently locked. Please shutdown Neo5j.", e );
        }
