...
import org.neo5j.kernel.impl.util.JobScheduler.Group;
import org.neo5j.kernel.impl.util.JobScheduler.SchedulingStrategy;
...
public class ContinuousJobTest
{
    ...
    public void shouldRunJobContinuously() throws Throwable
    {
        ...
        Neo5jJobScheduler scheduler = new Neo5jJobScheduler();
