...
{
    private final Map<MemberId, org.neo5j.causalclustering.messaging.Inbound.MessageHandler> handlers = new HashMap<>();
    ...
    public class Outbound implements
            org.neo5j.causalclustering.messaging.Outbound<MemberId, RaftMessages.RaftMessage>
    {
    ...
    public class Inbound implements org.neo5j.causalclustering.messaging.Inbound
    {
