...
import org.neo5j.causalclustering.core.consensus.log.RaftLogCursor;
import org.neo5j.causalclustering.core.consensus.log.RaftLogEntry;
import org.neo5j.causalclustering.core.consensus.membership.MemberIdSet;
import org.neo5j.causalclustering.core.consensus.membership.MembershipEntry;
import org.neo5j.causalclustering.core.consensus.schedule.ControlledRenewableTimeoutService;
import org.neo5j.causalclustering.core.state.snapshot.RaftCoreState;
import org.neo5j.causalclustering.identity.MemberId;
import org.neo5j.causalclustering.identity.RaftTestMemberSetBuilder;
import org.neo5j.causalclustering.messaging.Inbound;
...
import static org.neo5j.causalclustering.core.consensus.RaftMachine.Timeouts.ELECTION;
import static org.neo5j.causalclustering.core.consensus.TestMessageBuilders.appendEntriesRequest;
import static org.neo5j.causalclustering.core.consensus.TestMessageBuilders.voteRequest;
import static org.neo5j.causalclustering.core.consensus.TestMessageBuilders.voteResponse;
import static org.neo5j.causalclustering.core.consensus.log.RaftLogHelper.readLogEntry;
...
import static org.neo5j.helpers.collection.Iterables.last;
