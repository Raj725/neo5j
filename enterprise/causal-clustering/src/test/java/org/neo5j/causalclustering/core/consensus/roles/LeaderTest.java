 ...
 */
package org.neo5j.causalclustering.core.consensus.roles;
...
import org.neo5j.causalclustering.core.consensus.RaftMessages.AppendEntries;
import org.neo5j.causalclustering.core.consensus.RaftMessages.Timeout.Heartbeat;
import org.neo5j.causalclustering.core.consensus.ReplicatedInteger;
import org.neo5j.causalclustering.core.consensus.ReplicatedString;
...
import org.neo5j.causalclustering.core.consensus.log.ReadableRaftLog;
import org.neo5j.causalclustering.core.consensus.outcome.AppendLogEntry;
import org.neo5j.causalclustering.core.consensus.outcome.BatchAppendLogEntries;
import org.neo5j.causalclustering.core.consensus.outcome.Outcome;
import org.neo5j.causalclustering.core.consensus.outcome.ShipCommand;
import org.neo5j.causalclustering.core.consensus.roles.follower.FollowerState;
import org.neo5j.causalclustering.core.consensus.roles.follower.FollowerStates;
import org.neo5j.causalclustering.core.consensus.state.RaftState;
import org.neo5j.causalclustering.core.consensus.state.ReadableRaftState;
...
import static org.neo5j.causalclustering.core.consensus.MessageUtils.messageFor;
import static org.neo5j.causalclustering.core.consensus.ReplicatedInteger.valueOf;
import static org.neo5j.causalclustering.core.consensus.TestMessageBuilders.appendEntriesResponse;
import static org.neo5j.causalclustering.core.consensus.roles.Role.FOLLOWER;
import static org.neo5j.causalclustering.core.consensus.roles.Role.LEADER;
import static org.neo5j.causalclustering.core.consensus.state.RaftStateBuilder.raftState;
...
import static org.neo5j.helpers.collection.Iterables.single;
