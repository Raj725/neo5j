...
import org.neo5j.causalclustering.backup.RestoreClusterUtils;
...
import org.neo5j.causalclustering.core.state.machines.tx.LastCommittedIndexFinder;
...
import org.neo5j.kernel.impl.transaction.log.ReadOnlyTransactionStore;
...
public class CoreBootstrapperTest
{
    ...
    public void shouldSetAllCoreState() throws Exception
    {
        ...
        File classicNeo5jStore = RestoreClusterUtils.createClassicNeo5jStore(
                testDirectory.directory(), fileSystem, nodeCount, Standard.LATEST_NAME );

        PageCache pageCache = pageCacheRule.getPageCache( fileSystem );
        CoreBootstrapper bootstrapper = new CoreBootstrapper( classicNeo5jStore, pageCache, fileSystem,
        ...
        LastCommittedIndexFinder lastCommittedIndexFinder = new LastCommittedIndexFinder( new ReadOnlyTransactionIdStore( pageCache, classicNeo5jStore ), new ReadOnlyTransactionStore(
                pageCache, fileSystem, classicNeo5jStore, new Monitors() ), NullLogProvider.getInstance() );
