...
public class CoreClusterMember implements ClusterMember
{
                              ...
                              Map<String, IntFunction<String>> instanceExtraParams )
    {
        ...
        this.neo5jHome = new File( parentDir, "server-core-" + serverId );
        config.put( GraphDatabaseSettings.neo5j_home.name(), neo5jHome.getAbsolutePath() );
        config.put( GraphDatabaseSettings.logs_directory.name(), new File( neo5jHome, "logs" ).getAbsolutePath() );

        this.discoveryServiceFactory = discoveryServiceFactory;
        File dataDir = new File( neo5jHome, "data" );
