...
import org.neo5j.causalclustering.discovery.SharedDiscoveryService;
import org.neo5j.causalclustering.discovery.procedures.ClusterOverviewProcedure;
import org.neo5j.causalclustering.discovery.procedures.Role;
...
import static org.neo5j.causalclustering.discovery.procedures.Role.FOLLOWER;
import static org.neo5j.causalclustering.discovery.procedures.Role.LEADER;
import static org.neo5j.causalclustering.discovery.procedures.Role.READ_REPLICA;
...
public class ClusterOverviewIT
{
    ...
    private void assertEventualOverview( Cluster cluster, Matcher<List<MemberInfo>> expected, int coreServerId )
            throws org.neo5j.kernel.api.exceptions.KernelException, InterruptedException
    {
