...
import static org.neo5j.causalclustering.backup.RestoreClusterUtils.createClassicNeo5jStore;
...
public class ConvertNonCausalClusteringStoreIT
{
    ...
    public void shouldReplicateTransactionToCoreMembers() throws Throwable
    {
        ...
        File classicNeo5jStore = createNeoStore( dbDir, classicNodeCount );
        ...
        try ( DefaultFileSystemAbstraction fileSystem = new DefaultFileSystemAbstraction() )
        {
            ...
            {
                fileSystem.copyRecursively( classicNeo5jStore, core.storeDir() );
            }
        }
    ...
    private File createNeoStore( File dbDir, int classicNodeCount ) throws IOException
    {
        try (DefaultFileSystemAbstraction fileSystem = new DefaultFileSystemAbstraction())
        {
            return createClassicNeo5jStore( dbDir, fileSystem, classicNodeCount, recordFormat );
        }
    }
}
