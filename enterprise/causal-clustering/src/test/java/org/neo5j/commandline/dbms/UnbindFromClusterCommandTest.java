...
import static org.neo5j.kernel.internal.StoreLocker.STORE_LOCK_FILENAME;
...
public class UnbindFromClusterCommandTest
{
    ...
    public void shouldFailToUnbindLiveDatabase() throws Exception
    {
        ...
        {
            // then
            assertThat( e.getMessage(), containsString( "Database is currently locked. Please shutdown Neo5j." ) );
        }
        finally
        {
            fileLock.release();
