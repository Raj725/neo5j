...
import org.neo5j.cluster.protocol.atomicbroadcast.multipaxos.context.ElectionContextImpl;
...
public class DefaultWinnerStrategy implements WinnerStrategy
{
    ...
    @Override
    public org.neo5j.cluster.InstanceId pickWinner( Collection<Vote> votes )
    {
