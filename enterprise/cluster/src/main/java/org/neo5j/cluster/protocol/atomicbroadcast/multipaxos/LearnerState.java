    ...
    learner
            {
                        ...
                        case learnTimedout:
                        {
                            ...
                            if ( !context.hasDeliveredAllKnownInstances() )
                            {
                                      ...
                                      instanceId++ )
                                {
                                    ...
                                    {
                                        for ( org.neo5j.cluster.InstanceId node : context.getAlive() )
                                        {
                        ...
                        case learnRequest:
                        {
                            ...
                            else
                            {
                                outgoing.offer( message.copyHeadersTo( Message.respond( LearnerMessage.learnFailed,
                                        message,
                                        new LearnerMessage.LearnFailedState() ), org.neo5j.cluster.protocol
                        ...
                        case catchUp:
                        {
                            ...
                            if ( context.getLastKnownLearnedInstanceInCluster() < catchUpTo )
                            {
                                ...
                                org.neo5j.cluster.InstanceId instanceId =
                                        ...
                                        ? new org.neo5j.cluster.InstanceId(
                ...
                {
                    org.neo5j.cluster.InstanceId lastKnownAliveInstance = context.getLastKnownAliveUpToDateInstance();
