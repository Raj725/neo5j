...
import org.neo5j.cluster.protocol.atomicbroadcast.multipaxos.AtomicBroadcastContext;
...
import org.neo5j.cluster.util.Quorums;
    ...
    implements AtomicBroadcastContext
{
    ...
    AtomicBroadcastContextImpl( org.neo5j.cluster.InstanceId me, CommonContextState commonState,
                                LogProvider logging,
