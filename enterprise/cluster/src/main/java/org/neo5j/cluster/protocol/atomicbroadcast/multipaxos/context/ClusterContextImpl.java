...
import org.neo5j.cluster.protocol.atomicbroadcast.multipaxos.LearnerContext;
...
import org.neo5j.helpers.Listeners;
...
import static org.neo5j.function.Predicates.in;
import static org.neo5j.helpers.Uris.parameter;
        ...
        implements ClusterContext
{
    ...
    @Override
    public void unelected( final String roleName, final org.neo5j.cluster.InstanceId instanceId )
    {
        unelected( roleName, instanceId, InstanceId.NONE, NO_ELECTOR_VERSION );
    }

    @Override
    public void unelected( String roleName, org.neo5j.cluster.InstanceId instanceId,
                           org.neo5j.cluster.InstanceId electorId, long version )
    {
    ...
    @Override
    public Iterable<org.neo5j.cluster.InstanceId> getOtherInstances()
    {
    ...
    @Override
    public boolean isInstanceJoiningFromDifferentUri( org.neo5j.cluster.InstanceId joiningId, URI uri )
    {
    ...
    @Override
    public void instanceIsJoining( org.neo5j.cluster.InstanceId joiningId, URI uri )
    {
