...
import org.neo5j.cluster.protocol.atomicbroadcast.multipaxos.InstanceId;
...
import org.neo5j.cluster.protocol.atomicbroadcast.multipaxos.PaxosInstance;
import org.neo5j.cluster.protocol.atomicbroadcast.multipaxos.PaxosInstanceStore;
...
import org.neo5j.kernel.impl.util.CappedLogger;
        ...
        implements LearnerContext
{
    ...
    LearnerContextImpl( org.neo5j.cluster.InstanceId me, CommonContextState commonState,
                        LogProvider logging,
    ...
    private LearnerContextImpl( org.neo5j.cluster.InstanceId me, CommonContextState commonState, LogProvider logging,
    ...
    public void setLastKnownLearnedInstanceInCluster( long lastKnownLearnedInstanceInCluster,
            org.neo5j.cluster.InstanceId instanceId )
    {
        commonState.setLastKnownLearnedInstanceInCluster( lastKnownLearnedInstanceInCluster, instanceId );
    }

    @Override
    public org.neo5j.cluster.InstanceId getLastKnownAliveUpToDateInstance()
    {
