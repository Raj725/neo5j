...
import org.neo5j.cluster.protocol.atomicbroadcast.multipaxos.ProposerContext;
...
import static org.neo5j.helpers.collection.Iterables.limit;
        ...
        implements ProposerContext
{
    ...
    ProposerContextImpl( org.neo5j.cluster.InstanceId me, CommonContextState commonState,
                         LogProvider logging,
    ...
    private ProposerContextImpl( org.neo5j.cluster.InstanceId me, CommonContextState commonState, LogProvider logging,
    ...
    {
        Iterable<URI> aliveMembers = Iterables.map( new Function<org.neo5j.cluster.InstanceId, URI>()
        {
            @Override
            public URI apply( org.neo5j.cluster.InstanceId instanceId ) throws RuntimeException
            {
