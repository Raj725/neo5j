...
import static org.neo5j.cluster.com.message.Message.respond;
import static org.neo5j.cluster.com.message.Message.timeout;
                            ...
                            if ( somethingIsWrong )
                            {
                                ...
                                outgoing.offer( message.copyHeadersTo( respond( ClusterMessage.joinDenied, message,
                                        new ClusterMessage.ConfigurationResponseState( context.getConfiguration()
                                                ...
                                                new org.neo5j.cluster.protocol.atomicbroadcast.multipaxos.InstanceId(
