...
public class LearnerStateTest
{
    ...
    public void shouldUseLastKnownOnlineClusterMemberAndSetTimeoutForCatchup() throws Throwable
    {
        ...
        org.neo5j.cluster.InstanceId upToDateClusterMember = new org.neo5j.cluster.InstanceId( 1 );

        // What we know
        when( ctx.getLastLearnedInstanceId() ).thenReturn( 0L );
        when( ctx.getPaxosInstance( new org.neo5j.cluster.protocol.atomicbroadcast.multipaxos.InstanceId( 1L ) ) )
                .thenReturn( new PaxosInstance( null, new org.neo5j.cluster.protocol.atomicbroadcast.multipaxos
                        .InstanceId( 1L ) ) );
    ...
    public void learnerShouldAskAllAliveInstancesAndTheseOnlyForMissingValue() throws Throwable
    {
        ...
        Set<org.neo5j.cluster.InstanceId> aliveInstanceIds = new HashSet<org.neo5j.cluster.InstanceId>();
        org.neo5j.cluster.InstanceId id2 = new org.neo5j.cluster.InstanceId( 2 );
        org.neo5j.cluster.InstanceId id4 = new org.neo5j.cluster.InstanceId( 4 );
    ...
    public void shouldHandleLocalLearnMessagesWithoutInstanceIdInTheMessageHeaderWhenCatchingUp() throws Throwable
    {
        ...
        org.neo5j.cluster.InstanceId instanceId = new org.neo5j.cluster.InstanceId( 42 );
        long payload = 12L;
