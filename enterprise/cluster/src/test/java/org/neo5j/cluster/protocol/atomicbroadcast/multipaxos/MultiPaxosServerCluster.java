...
import static org.neo5j.test.StreamConsumer.PRINT_FAILURES;
...
public class MultiPaxosServerCluster
{
        ...
        throws IOException, InterruptedException
    {
        ...
        sleep( 3000 );
//        all( "logging org.neo5j.kernel.ha2.protocol off" );
        send( 1, "create default" );
        send( 2, "join neo5j://localhost:5001" );
        send( 3, "join neo5j://localhost:5001" );
        ...
        send( 2, "leave");
        sleep( 1000 );
        send( 1, "join neo5j://localhost:5003");
        send( 2, "join neo5j://localhost:5003");
        sleep( 6000 );
        send( 3, "promote neo5j://127.0.0.1:5001 coordinator" );
        sleep( 6000 );
