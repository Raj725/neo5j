...
import org.neo5j.cluster.com.message.MessageHolder;
import org.neo5j.cluster.com.message.MessageType;
import org.neo5j.cluster.com.message.TrackingMessageHolder;
import org.neo5j.cluster.protocol.MessageArgumentMatcher;
import org.neo5j.cluster.protocol.atomicbroadcast.multipaxos.PaxosInstance.State;
...
import static org.neo5j.cluster.com.message.Message.to;
import static org.neo5j.cluster.protocol.atomicbroadcast.multipaxos.InstanceId.INSTANCE;
import static org.neo5j.cluster.protocol.atomicbroadcast.multipaxos.ProposerMessage.phase1Timeout;
import static org.neo5j.cluster.protocol.atomicbroadcast.multipaxos.ProposerMessage.promise;
import static org.neo5j.cluster.protocol.atomicbroadcast.multipaxos.ProposerMessage.propose;
import static org.neo5j.cluster.protocol.atomicbroadcast.multipaxos.ProposerMessage.rejectAccept;
...
public class ProposerStateTest
{
    ...
    public void ifProposingWithClosedInstanceThenRetryWithNextInstance() throws Throwable
    {
        ...
        org.neo5j.cluster.protocol.atomicbroadcast.multipaxos.InstanceId instanceId = new org.neo5j.cluster.protocol.atomicbroadcast.multipaxos.InstanceId( 42 );
        ...
        message.setHeader( org.neo5j.cluster.protocol.atomicbroadcast.multipaxos.InstanceId.INSTANCE, instanceId.toString() );
    ...
    public void proposer_proposePhase1TimeoutShouldCarryOnPayload() throws Throwable
    {
        ...
        when( context.getPaxosInstance( any( org.neo5j.cluster.protocol.atomicbroadcast.multipaxos.InstanceId.class ) ) ).thenReturn( instance );
        when( context.getMyId() ).thenReturn( new org.neo5j.cluster.InstanceId( 0 ) );
        ...
        // THEN
        verify( context ).setTimeout( eq( new org.neo5j.cluster.protocol.atomicbroadcast.multipaxos.InstanceId( instanceId ) ),
    ...
    public void proposer_rejectAcceptShouldCarryOnPayload() throws Throwable
    {
        // GIVEN
        String instanceId = "1";
        PaxosInstance instance = new PaxosInstance( mock( PaxosInstanceStore.class ), new org.neo5j.cluster.protocol.atomicbroadcast.multipaxos.InstanceId( instanceId ) );
        Serializable payload = "myPayload";
        ...
        when( context.getLog( any( Class.class ) ) ).thenReturn( NullLog.getInstance() );
        when( context.getPaxosInstance( any( org.neo5j.cluster.protocol.atomicbroadcast.multipaxos.InstanceId.class ) ) ).thenReturn( instance );
        when( context.getMyId() ).thenReturn( new org.neo5j.cluster.InstanceId( parseInt( instanceId ) ) );
        TrackingMessageHolder outgoing = new TrackingMessageHolder();
