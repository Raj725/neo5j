...
import org.neo5j.cypher.internal.compiler.v3_2.planDescription.InternalPlanDescription.Arguments.EstimatedRows
import org.neo5j.cypher.{ExecutionEngineFunSuite, LdbcQueries, NewPlannerTestSupport}
...
class LdbcAcceptanceTest extends ExecutionEngineFunSuite with NewPlannerTestSupport {
  import org.neo5j.cypher.LdbcQueries._
