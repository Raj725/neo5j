...
import org.neo5j.cypher.internal.compiler.v3_2.pipes.{IndexSeekByRange, UniqueIndexSeekByRange}
import org.neo5j.cypher.{ExecutionEngineFunSuite, NewPlannerTestSupport, SyntaxException}

/**
  * These tests are testing the actual index implementation, thus they should all check the actual result.
  * If you only want to verify that plans using indexes are actually planned, please use
  * [[org.neo5j.cypher.internal.compiler.v3_2.planner.logical.LeafPlanningIntegrationTest]]
  */
