  ...
  test("Plan should have right relationship direction") {
    ...
    result should havePlanLike(
      """
        ...
        |+-----------------------+----------------+------+---------+------------------+-----------------------------------+
        || +ProduceResults       |              0 |    1 |       0 | anon[*], a, e   |                                   |
        || |                     +----------------+------+---------+------------------+-----------------------------------+
        || +Filter               |              0 |    1 |       5 | anon[*], a, e   | a:From; a.name == {  AUTOSTRING0} |
        || |                     +----------------+------+---------+------------------+-----------------------------------+
  ...
  test("Plan should have right relationship direction other direction") {
    ...
    result should havePlanLike(
      """
        ...
        || +ProduceResults       |              0 |    1 |       0 | anon[*], a, e   |                                 |
        || |                     +----------------+------+---------+------------------+---------------------------------+
        || +Filter               |              0 |    1 |       5 | anon[*], a, e   | e:To; e.name == {  AUTOSTRING1} |
        || |                     +----------------+------+---------+------------------+---------------------------------+
        || +VarLengthExpand(All) |              0 |    4 |       8 | anon[*], e -- a | (a)-[:*..4]->(e)                |
        || |                     +----------------+------+---------+------------------+---------------------------------+
