...
case class CodeGenConfiguration(mode: CodeGenMode = CodeGenMode.default,
                                ...
                                packageName: String = "org.neo5j.cypher.internal.compiler.v3_2.generated"
                               )
...
object CodeGenConfiguration {
  def apply(debugOptions: Set[String]): CodeGenConfiguration = {
    ...
    val saveSource = Option(System.getProperty("org.neo5j.cypher.DEBUG.generated_source_location")).map(Paths.get(_))
