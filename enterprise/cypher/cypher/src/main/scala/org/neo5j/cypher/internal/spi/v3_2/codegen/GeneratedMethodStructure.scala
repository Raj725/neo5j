 ...
 */
package org.neo5j.cypher.internal.spi.v3_2.codegen

import java.util
import java.util.PrimitiveIterator
import java.util.stream.{DoubleStream, IntStream, LongStream}

import org.neo5j.codegen.Expression.{not, or, _}
import org.neo5j.codegen.MethodReference.methodReference
import org.neo5j.codegen._
import org.neo5j.collection.primitive._
import org.neo5j.collection.primitive.hopscotch.LongKeyIntValueTable
import org.neo5j.cypher.internal.codegen.CompiledConversionUtils.CompositeKey
import org.neo5j.cypher.internal.codegen._
import org.neo5j.cypher.internal.compiled_runtime.v3_2.codegen.ir.expressions.{BoolType,  FloatType, IntType, LongType, ReferenceType, Parameter => _, _}
import org.neo5j.cypher.internal.compiled_runtime.v3_2.codegen.spi._
import org.neo5j.cypher.internal.compiled_runtime.v3_2.codegen.{CodeGenContext, QueryExecutionEvent}
import org.neo5j.cypher.internal.compiler.v3_2.ast.convert.commands.DirectionConverter.toGraphDb
import org.neo5j.cypher.internal.compiler.v3_2.planDescription.Id
import org.neo5j.cypher.internal.compiler.v3_2.spi.{NodeIdWrapper, RelationshipIdWrapper}
import org.neo5j.cypher.internal.frontend.v3_2.helpers._
import org.neo5j.cypher.internal.frontend.v3_2.symbols.{CTNode, CTRelationship, ListType}
import org.neo5j.cypher.internal.frontend.v3_2.{ParameterNotFoundException, SemanticDirection, symbols}
import org.neo5j.cypher.internal.spi.v3_2.codegen.GeneratedMethodStructure.CompletableFinalizer
import org.neo5j.cypher.internal.spi.v3_2.codegen.Methods._
import org.neo5j.cypher.internal.spi.v3_2.codegen.Templates.{createNewInstance, handleKernelExceptions, newRelationshipDataExtractor, tryCatch}
import org.neo5j.graphdb.Direction
import org.neo5j.kernel.api.ReadOperations
import org.neo5j.kernel.api.schema_new.index.{NewIndexDescriptor, NewIndexDescriptorFactory}
import org.neo5j.kernel.api.schema_new.{IndexQuery, LabelSchemaDescriptor}
import org.neo5j.kernel.impl.api.RelationshipDataExtractor
import org.neo5j.kernel.impl.api.store.RelationshipIterator
import org.neo5j.cypher.internal.compiled_runtime.v3_2.codegen.ir.expressions.CodeGenType
