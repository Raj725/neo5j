...
import org.neo5j.collection.primitive.{PrimitiveLongIntMap, PrimitiveLongIterator}
import org.neo5j.cypher.internal.codegen.CompiledConversionUtils.CompositeKey
import org.neo5j.cypher.internal.codegen._
import org.neo5j.cypher.internal.compiled_runtime.v3_2.codegen.{QueryExecutionEvent, QueryExecutionTracer}
import org.neo5j.cypher.internal.compiler.v3_2.ResultRowImpl
import org.neo5j.cypher.internal.compiler.v3_2.planDescription.Id
import org.neo5j.cypher.internal.compiler.v3_2.spi.{InternalResultRow, InternalResultVisitor, NodeIdWrapper, RelationshipIdWrapper}
...
import org.neo5j.kernel.impl.api.{RelationshipDataExtractor, RelationshipVisitor}
import org.neo5j.kernel.impl.core.{NodeManager, NodeProxy, RelationshipProxy}
...
object Methods {
  ...
  val indexQuery = method[ReadOperations, PrimitiveLongIterator]("indexQuery", typeRef[NewIndexDescriptor], typeRef[Array[IndexQuery]])
  val indexQueryExact = method[IndexQuery, IndexQuery.ExactPredicate]("exact", typeRef[Int], typeRef[Object])
  val nodeGetUniqueFromIndexLookup = method[ReadOperations, Long]("nodeGetFromUniqueIndexSeek", typeRef[NewIndexDescriptor], typeRef[Array[IndexQuery.ExactPredicate]])
