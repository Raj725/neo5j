...
import org.neo5j.cypher.internal.javacompat.PlanDescription
...
class RootPlanAcceptanceTest extends ExecutionEngineFunSuite {
  ...
  private def shouldContainSourceCode(planDescription: org.neo5j.cypher.internal.PlanDescription) = {
    shouldContain("source", planDescription)
  }

  private def shouldContainByteCode(planDescription: org.neo5j.cypher.internal.PlanDescription) = {
    shouldContain("bytecode", planDescription)
  }

  private def shouldContain(argument:String, planDescription: org.neo5j.cypher.internal.PlanDescription) = {
