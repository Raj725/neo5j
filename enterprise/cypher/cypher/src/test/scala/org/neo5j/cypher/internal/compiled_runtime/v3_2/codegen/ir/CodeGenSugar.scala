...
import org.neo5j.cypher.internal.compiled_runtime.v3_2.ExecutionPlanBuilder.tracer
import org.neo5j.cypher.internal.compiled_runtime.v3_2.codegen.{Namer, _}
import org.neo5j.cypher.internal.compiled_runtime.v3_2.executionplan.{GeneratedQuery, GeneratedQueryExecution}
import org.neo5j.cypher.internal.compiled_runtime.v3_2.{CompiledExecutionResult, CompiledPlan}
...
import org.neo5j.cypher.internal.compiler.v3_2.{CostBasedPlannerName, ExecutionMode, NormalMode, TaskCloser}
...
import org.neo5j.cypher.internal.spi.v3_2.{TransactionBoundQueryContext, TransactionalContextWrapper}
...
import org.neo5j.kernel.api.{KernelTransaction, Statement}
...
trait CodeGenSugar extends MockitoSugar {
  ...
  def executeCompiled(plan: CompiledPlan,
    ...
    try {
      ...
      val contextFactory = Neo5jTransactionalContextFactory.create(graphDb, locker)
