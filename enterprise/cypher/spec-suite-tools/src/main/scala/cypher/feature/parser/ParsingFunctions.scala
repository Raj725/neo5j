...
/**
  ...
  * that can be used to match on a {@link org.neo5j.graphdb.Result Result} object.
  */
...
/**
  ...
  * a matcher that will match a {@link org.neo5j.graphdb.QueryStatistics QueryStatistics} object.
  */
