...
import org.neo5j.com.Serializer;
...
import org.neo5j.kernel.impl.store.id.IdRange;
...
import static org.neo5j.com.Protocol.EMPTY_SERIALIZER;
import static org.neo5j.com.Protocol.VOID_DESERIALIZER;
...
/**
 * The {@link org.neo5j.kernel.ha.com.master.Master} a slave should use to communicate with its master. It
 * serializes requests and sends them to the master, more specifically
 * {@link org.neo5j.kernel.ha.com.master.MasterServer} (which delegates to
 * {@link org.neo5j.kernel.ha.com.master.MasterImpl}
 * on the master side.
 */
