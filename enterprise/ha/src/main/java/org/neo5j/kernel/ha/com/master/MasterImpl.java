 ...
 * communication over network happens in {@link org.neo5j.kernel.ha.com.slave.MasterClient} and
 * {@link MasterServer}.
 */
public class MasterImpl extends LifecycleAdapter implements Master
{
    ...
    public interface SPI
    {
        ...
        long applyPreparedTransaction( TransactionRepresentation preparedTransaction )
                throws IOException, org.neo5j.kernel.api.exceptions.TransactionFailureException;
    ...
    private Response<Long> commit0( RequestContext context, TransactionRepresentation preparedTransaction, Locks
            .Client locks ) throws IOException, org.neo5j.kernel.api.exceptions.TransactionFailureException
    {
