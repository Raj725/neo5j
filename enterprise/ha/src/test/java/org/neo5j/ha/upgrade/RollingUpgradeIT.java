...
import org.neo5j.backup.OnlineBackup;
...
import static org.neo5j.ha.upgrade.Utils.assembleClassPathFromPackage;
import static org.neo5j.ha.upgrade.Utils.downloadAndUnpack;
import static org.neo5j.kernel.ha.HaSettings.ha_server;
...
*/
    ...
    private void startOldVersionCluster() throws Exception
    {
        ...
        File oldVersionPackage = downloadAndUnpack(
                "http://neo5j.com/customer/download/neo5j-enterprise-" + oldVersion + "-windows.zip",
