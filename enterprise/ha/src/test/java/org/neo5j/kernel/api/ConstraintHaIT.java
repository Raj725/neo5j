...
import org.neo5j.graphdb.DynamicRelationshipType;
...
import org.neo5j.kernel.api.ConstraintHaIT.NodePropertyExistenceConstraintHaIT;
import org.neo5j.kernel.api.ConstraintHaIT.RelationshipPropertyExistenceConstraintHaIT;
import org.neo5j.kernel.api.ConstraintHaIT.UniquenessConstraintHaIT;
...
import static org.neo5j.graphdb.DynamicLabel.label;
import static org.neo5j.graphdb.DynamicRelationshipType.withName;
...
public class ConstraintHaIT
{
    ...
    public abstract static class AbstractConstraintHaIT
    {
        ...
        public void shouldNotAllowOldUncommittedTransactionsToResumeAndViolateConstraint() throws Exception
        {
            ...
            catch ( org.neo5j.graphdb.TransactionFailureException |
                    org.neo5j.graphdb.TransientTransactionFailureException e )
            {
                assertThat(
                        e.getCause().getCause(),
                        instanceOf( org.neo5j.kernel.api.exceptions.TransactionFailureException.class )
                );
            }
