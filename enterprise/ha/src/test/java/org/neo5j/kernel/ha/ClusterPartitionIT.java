...
import org.neo5j.graphdb.TransientDatabaseFailureException;
import org.neo5j.ha.TestRunConditions;
...
import org.neo5j.kernel.impl.ha.ClusterManager.NetworkFlag;
import org.neo5j.test.rule.LoggerRule;
import org.neo5j.test.rule.RetryACoupleOfTimesHandler;
...
import static org.neo5j.kernel.ha.cluster.HighAvailabilityMemberState.PENDING;
import static org.neo5j.kernel.impl.ha.ClusterManager.allSeesAllAsAvailable;
import static org.neo5j.kernel.impl.ha.ClusterManager.instanceEvicted;
import static org.neo5j.kernel.impl.ha.ClusterManager.masterAvailable;
import static org.neo5j.kernel.impl.ha.ClusterManager.masterSeesSlavesAsAvailable;
import static org.neo5j.kernel.impl.ha.ClusterManager.memberSeesOtherMemberAsFailed;
import static org.neo5j.test.rule.DatabaseRule.tx;
import static org.neo5j.test.rule.RetryACoupleOfTimesHandler.TRANSIENT_ERRORS;
import static org.neo5j.test.rule.RetryACoupleOfTimesHandler.retryACoupleOfTimesOn;
