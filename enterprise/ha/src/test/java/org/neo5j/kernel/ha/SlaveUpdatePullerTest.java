...
import org.neo5j.kernel.ha.UpdatePuller.Condition;
...
import org.neo5j.kernel.impl.util.CountingJobScheduler;
...
public class SlaveUpdatePullerTest
{
    ...
    private final JobScheduler jobScheduler = new CountingJobScheduler( scheduledJobs, new Neo5jJobScheduler() );
