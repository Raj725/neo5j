...
import org.neo5j.com.ComException;
...
import org.neo5j.kernel.ha.com.master.SlavePriorities;
import org.neo5j.kernel.ha.com.master.SlavePriority;
...
import org.neo5j.logging.AssertableLogProvider.LogMatcher;
...
import static org.neo5j.kernel.ha.com.master.SlavePriorities.givenOrder;
import static org.neo5j.kernel.ha.com.master.SlavePriorities.roundRobin;
import static org.neo5j.logging.AssertableLogProvider.Level.ERROR;
...
public class TestMasterCommittingAtSlave
{
                                                 ...
                                                 boolean... failingSlaves ) throws Exception
    {
        ...
        Neo5jJobScheduler scheduler = cleanup.add( new Neo5jJobScheduler() );
