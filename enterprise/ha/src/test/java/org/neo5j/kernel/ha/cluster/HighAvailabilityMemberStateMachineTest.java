 ...
 */
package org.neo5j.kernel.ha.cluster;
...
import org.neo5j.cluster.member.ClusterMemberListener;
import org.neo5j.cluster.protocol.election.Election;
import org.neo5j.com.ResourceReleaser;
...
import org.neo5j.kernel.AvailabilityGuard.AvailabilityRequirement;
...
import org.neo5j.kernel.ha.com.master.HandshakeResult;
import org.neo5j.kernel.ha.com.master.Master;
import org.neo5j.kernel.ha.com.slave.MasterClient;
...
import org.neo5j.kernel.impl.transaction.DeadSimpleTransactionIdStore;
...
import static org.neo5j.com.StoreIdTestFactory.newStoreIdForCurrentVersion;
import static org.neo5j.kernel.ha.cluster.modeswitch.HighAvailabilityModeSwitcher.MASTER;
import static org.neo5j.kernel.ha.cluster.modeswitch.HighAvailabilityModeSwitcher.SLAVE;
import static org.neo5j.kernel.ha.cluster.modeswitch.HighAvailabilityModeSwitcherTest.storeSupplierMock;
