...
import org.neo5j.com.TransactionNotPresentOnMasterException;
import org.neo5j.com.TransactionObligationResponse;
...
import org.neo5j.kernel.ha.id.IdAllocation;
import org.neo5j.kernel.impl.enterprise.lock.forseti.ForsetiLockManager;
import org.neo5j.kernel.impl.locking.DumpLocksVisitor;
...
import org.neo5j.kernel.impl.util.collection.ConcurrentAccessException;
import org.neo5j.kernel.impl.util.collection.TimedRepository;
...
import org.neo5j.test.rule.VerboseTimeout;
import org.neo5j.time.Clocks;

import static org.junit.Assert.assertTrue;
import static org.mockito.Mockito.mock;
import static org.neo5j.cluster.ClusterSettings.server_id;
...
import static org.neo5j.kernel.ha.HaSettings.lock_read_timeout;
...
public class MasterImplConversationStopFuzzIT
{
    ...
    private final JobScheduler scheduler = life.add( new Neo5jJobScheduler() );
