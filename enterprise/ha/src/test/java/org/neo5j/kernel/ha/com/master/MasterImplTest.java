...
import org.neo5j.kernel.impl.util.collection.NoSuchEntryException;
import org.neo5j.storageengine.api.lock.ResourceType;
import org.neo5j.test.rule.concurrent.OtherThreadRule;
...
public class MasterImplTest
{
    ...
    public void givenStartedAndInaccessibleWhenNewLockSessionThrowException() throws Throwable
    {
        ...
        catch ( org.neo5j.kernel.api.exceptions.TransactionFailureException e )
        {
            // Ok
        }
    }
