 ...
 */
package org.neo5j.kernel.ha.lock;
...
import org.neo5j.graphdb.TransientFailureException;
...
import org.neo5j.kernel.impl.locking.community.CommunityLockManger;
...
import static org.neo5j.com.ResourceReleaser.NO_OP;
import static org.neo5j.kernel.impl.locking.ResourceTypes.NODE;
import static org.neo5j.kernel.impl.store.StoreId.DEFAULT;
import static org.neo5j.logging.AssertableLogProvider.inLog;
import static org.neo5j.logging.NullLog.getInstance;
...
public class SlaveLocksClientTest
{
    ...
    @Test( expected = org.neo5j.graphdb.TransientDatabaseFailureException.class )
