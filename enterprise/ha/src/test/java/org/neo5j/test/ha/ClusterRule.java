...
import org.neo5j.kernel.impl.ha.ClusterManager.Builder;
import org.neo5j.kernel.impl.ha.ClusterManager.ClusterBuilder;
import org.neo5j.kernel.impl.ha.ClusterManager.ManagedCluster;
import org.neo5j.kernel.impl.ha.ClusterManager.StoreDirInitializer;
import org.neo5j.kernel.impl.util.Listener;
import org.neo5j.test.rule.TestDirectory;

import static org.neo5j.cluster.ClusterSettings.default_timeout;
import static org.neo5j.cluster.ClusterSettings.join_timeout;
import static org.neo5j.graphdb.factory.GraphDatabaseSettings.pagecache_memory;
import static org.neo5j.graphdb.factory.GraphDatabaseSettings.store_internal_log_level;
import static org.neo5j.kernel.ha.HaSettings.tx_push_factor;
