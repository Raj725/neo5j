 ...
 */
package org.neo5j.kernel.enterprise.builtinprocs;
...
import org.neo5j.function.UncaughtCheckedException;
...
import org.neo5j.kernel.api.KernelTransactionHandle;
...
import static org.neo5j.function.ThrowingFunction.catchThrown;
import static org.neo5j.function.ThrowingFunction.throwIfPresent;
import static org.neo5j.graphdb.security.AuthorizationViolationException.PERMISSION_DENIED;
import static org.neo5j.kernel.enterprise.builtinprocs.QueryId.fromExternalString;
import static org.neo5j.kernel.enterprise.builtinprocs.QueryId.ofInternalId;
