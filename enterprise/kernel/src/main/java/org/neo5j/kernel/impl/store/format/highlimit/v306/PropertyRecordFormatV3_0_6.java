 ...
 */
package org.neo5j.kernel.impl.store.format.highlimit.v306;

import java.io.IOException;

import org.neo5j.io.pagecache.PageCursor;
import org.neo5j.kernel.impl.store.format.BaseOneByteHeaderRecordFormat;
import org.neo5j.kernel.impl.store.format.highlimit.Reference;
...
import static org.neo5j.kernel.impl.store.format.highlimit.Reference.toAbsolute;
import static org.neo5j.kernel.impl.store.format.highlimit.Reference.toRelative;
import static org.neo5j.kernel.impl.store.format.highlimit.v306.BaseHighLimitRecordFormatV3_0_6.HEADER_BIT_FIXED_REFERENCE;
import static org.neo5j.kernel.impl.store.format.highlimit.v306.BaseHighLimitRecordFormatV3_0_6.HEADER_BYTE;
import static org.neo5j.kernel.impl.store.format.highlimit.v306.BaseHighLimitRecordFormatV3_0_6.NULL;
...
class PropertyRecordFormatV3_0_6 extends BaseOneByteHeaderRecordFormat<PropertyRecord>
{
    ...
    {
        super( fixedRecordSize( RECORD_SIZE ), 0, IN_USE_BIT, HighLimitV3_0_6.DEFAULT_MAXIMUM_BITS_PER_ID );
    }
