...
import org.neo5j.kernel.impl.store.format.standard.StandardFormatFamily;
...
import static org.neo5j.kernel.impl.storemigration.MigrationTestUtils.truncateToFixedLength;
import static org.neo5j.kernel.impl.storemigration.StoreUpgrader.UnexpectedUpgradingStoreVersionException.MESSAGE;
        ...
        public void shouldCommunicateWhatCausesInabilityToUpgrade()
        {
            ...
            catch ( StoreUpgrader.UnexpectedUpgradingStoreVersionException e )
            {
                ...
                assertEquals( String.format( MESSAGE, version, upgradableDatabase.currentVersion(),
                        Version.getNeo5jVersion() ), e.getMessage() );
            }
