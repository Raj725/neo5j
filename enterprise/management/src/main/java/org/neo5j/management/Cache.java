...
@Description( "Information about the caching in Neo5j" )
public interface Cache
{
    String NAME = "Cache";

    @Description( "The type of cache used by Neo5j" )
    String getCacheType();
    ...
    @Description( value = "Clears the Neo5j caches", impact = MBeanOperationInfo.ACTION )
    void clear();
}
