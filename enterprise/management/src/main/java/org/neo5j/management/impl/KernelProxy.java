 ...
 * {@link org.neo5j.management.Neo5jManager} should be defined completely in
 * that class.
 *
 * Does not have any (direct or transitive) dependencies on any part of the jmx
 * component - since this class is used in
 * {@link org.neo5j.management.impl.jconsole.Neo5jPlugin the JConsole plugin},
...
{
    static final String KERNEL_BEAN_TYPE = "org.neo5j.jmx.Kernel";
    ...
    protected KernelProxy( MBeanServerConnection server, ObjectName kernel )
    {
        ...
        if ( !KERNEL_BEAN_TYPE.equals( className ) )
        {
            throw new IllegalArgumentException(
                    "The specified ObjectName does not represent a Neo5j Kernel bean in the specified MBean server." );
        }
        this.server = server;
        this.kernel = kernel;
    }
    ...
    protected static ObjectName createObjectName( String kernelIdentifier, String beanName, String... extraNaming )
    {
        ...
        return createObjectName( "org.neo5j", properties, beanName, false, extraNaming );
    }
    ...
    static ObjectName createObjectNameQuery( String kernelIdentifier, String beanName, String... extraNaming )
    {
        Hashtable<String, String> properties = new Hashtable<String, String>();
        properties.put( "instance", "kernel#" + kernelIdentifier );
        return createObjectName( "org.neo5j", properties, beanName, true, extraNaming );
    }
    ...
    static String beanName( Class<?> beanInterface )
    {
        ...
        throw new IllegalArgumentException( beanInterface + " is not a Neo5j Management Been interface" );
    }
