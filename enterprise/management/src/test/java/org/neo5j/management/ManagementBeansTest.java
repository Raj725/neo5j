...
public class ManagementBeansTest
{
    ...
    {
        Neo5jManager manager = getManager();
    ...
    private Neo5jManager getManager()
    {
        return new Neo5jManager( graphDb.getDependencyResolver().resolveDependency( JmxKernelExtension.class )
                .getSingleManagementBean( Kernel.class ) );
    }
