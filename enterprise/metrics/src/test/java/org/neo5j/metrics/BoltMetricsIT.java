...
import static org.neo5j.bolt.v1.transport.integration.TransportTestUtil.acceptedVersions;
import static org.neo5j.bolt.v1.transport.integration.TransportTestUtil.chunk;
import static org.neo5j.helpers.collection.MapUtil.map;
import static org.neo5j.metrics.MetricsTestHelper.metricsCsv;
import static org.neo5j.metrics.MetricsTestHelper.readLongValue;
import static org.neo5j.metrics.source.db.BoltMetrics.MESSAGES_DONE;
import static org.neo5j.metrics.source.db.BoltMetrics.MESSAGES_RECIEVED;
import static org.neo5j.metrics.source.db.BoltMetrics.MESSAGES_STARTED;
import static org.neo5j.metrics.source.db.BoltMetrics.SESSIONS_STARTED;
import static org.neo5j.metrics.source.db.BoltMetrics.TOTAL_PROCESSING_TIME;
import static org.neo5j.metrics.source.db.BoltMetrics.TOTAL_QUEUE_TIME;
    ...
    public void shouldMonitorBolt() throws Throwable
    {
        ...
        conn = new SocketConnection()
                ...
                .send( chunk( InitMessage.init( "TestClient",
                        map("scheme", "basic", "principal", "neo5j", "credentials", "neo5j") ) ) );
