...
import static org.neo5j.graphdb.factory.GraphDatabaseSettings.check_point_interval_time;
import static org.neo5j.graphdb.factory.GraphDatabaseSettings.cypher_min_replan_interval;
import static org.neo5j.helpers.collection.MapUtil.stringMap;
import static org.neo5j.kernel.impl.ha.ClusterManager.clusterOfSize;
import static org.neo5j.metrics.MetricsSettings.csvEnabled;
import static org.neo5j.metrics.MetricsSettings.csvPath;
import static org.neo5j.metrics.MetricsSettings.graphiteInterval;
import static org.neo5j.metrics.MetricsSettings.metricsEnabled;
import static org.neo5j.metrics.MetricsTestHelper.metricsCsv;
import static org.neo5j.metrics.MetricsTestHelper.readLongValueAndAssert;
...
public class MetricsKernelExtensionFactoryIT
{
    ...
    public void shouldShowTxCommittedMetricsWhenMetricsEnabled() throws Throwable
    {
        ...
        // WHEN
        // We should at least have a "timestamp" column, and a "neo5j.transaction.committed" column
