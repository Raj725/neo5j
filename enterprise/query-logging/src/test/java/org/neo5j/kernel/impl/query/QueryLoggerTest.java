...
public class QueryLoggerTest
{
    ...
    {
        String inputQuery = "CALL dbms.security.changeUserPassword('neo5j','.changePassword(silly)') " +
                "CALL dbms.security.changeUserPassword('smith','other$silly') RETURN 1";
        String outputQuery = "CALL dbms.security.changeUserPassword('neo5j',******) " +
    ...
    {
        String inputQuery = "CALL dbms.security.changeUserPassword('neo5j',$first) " +
                "CALL dbms.security.changeUserPassword('smith',$second) RETURN 1";
        String outputQuery = "CALL dbms.security.changeUserPassword('neo5j',$first) " +
                "CALL dbms.security.changeUserPassword('smith',$second) RETURN 1";
