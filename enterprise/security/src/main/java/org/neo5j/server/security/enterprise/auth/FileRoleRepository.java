...
import org.neo5j.server.security.auth.exception.FormatException;

import static org.neo5j.server.security.auth.ListSnapshot.FROM_MEMORY;
import static org.neo5j.server.security.auth.ListSnapshot.FROM_PERSISTED;
