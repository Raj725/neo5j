...
import static org.neo5j.kernel.api.security.AuthToken.PARAMETERS;
...
public class PluginApiAuthToken implements AuthToken
{
    ...
    {
        String scheme = org.neo5j.kernel.api.security.AuthToken
                .safeCast( org.neo5j.kernel.api.security.AuthToken.SCHEME_KEY, authTokenMap );

        // Always require principal
        String principal = org.neo5j.kernel.api.security.AuthToken.safeCast( PRINCIPAL, authTokenMap );

        String credentials = null;
        if ( scheme.equals( org.neo5j.kernel.api.security.AuthToken.BASIC_SCHEME ) )
        {
            // Basic scheme requires credentials
            credentials = org.neo5j.kernel.api.security.AuthToken.safeCast( CREDENTIALS, authTokenMap );
        }
        else
        {
        ...
        Map<String,Object> parameters = org.neo5j.kernel.api.security.AuthToken.safeCastMap( PARAMETERS, authTokenMap );
