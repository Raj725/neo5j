...
import org.neo5j.kernel.enterprise.api.security.EnterpriseAuthManager;
...
import static org.neo5j.bolt.v1.messaging.message.ResetMessage.reset;
import static org.neo5j.helpers.collection.MapUtil.map;
import static org.neo5j.kernel.api.security.AuthToken.BASIC_SCHEME;
import static org.neo5j.kernel.api.security.AuthToken.CREDENTIALS;
import static org.neo5j.kernel.api.security.AuthToken.NATIVE_REALM;
import static org.neo5j.kernel.api.security.AuthToken.PRINCIPAL;
import static org.neo5j.kernel.api.security.AuthToken.REALM_KEY;
import static org.neo5j.kernel.api.security.AuthToken.SCHEME_KEY;
import static org.neo5j.kernel.api.security.AuthToken.newBasicAuthToken;
...
class BoltInteraction implements NeoInteractionLevel<BoltInteraction.BoltSubject>
{
    ...
    private final Neo5jWithSocket server;
    ...
    BoltInteraction( Map<String, String> config, Supplier<FileSystemAbstraction> fileSystemSupplier ) throws IOException
    {
        ...
        server = new Neo5jWithSocket( getClass(),
                factory,
                () -> fileSystem,
                settings ->
                {
