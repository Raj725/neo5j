...
import org.neo5j.io.fs.DelegateFileSystemAbstraction;
...
import org.neo5j.server.security.auth.FileRepositorySerializer;
...
public class FileRoleRepositoryTest
{
    ...
    public void shouldNotAllowComplexNames() throws Exception
    {
        ...
        // When
        roleRepository.assertValidRoleName( "neo5j" );
    ...
    public void shouldNotAddEmptyUserToRole() throws Throwable
    {
        // Given
        fs.mkdirs( roleFile.getParentFile() );
        FileRepositorySerializer.writeToFile( fs, roleFile, UTF8.encode( "admin:neo5j\nreader:\n" ) );
        ...
        assertTrue( "neo5j should be assigned to 'admin'", role.users().contains( "neo5j" ) );
