...
import static org.neo5j.graphdb.security.AuthorizationViolationException.PERMISSION_DENIED;
import static org.neo5j.logging.AssertableLogProvider.inLog;
import static org.neo5j.server.security.enterprise.auth.plugin.api.PredefinedRoles.ADMIN;
import static org.neo5j.server.security.enterprise.auth.plugin.api.PredefinedRoles.ARCHITECT;
import static org.neo5j.server.security.enterprise.auth.plugin.api.PredefinedRoles.READER;
...
public class UserManagementProceduresLoggingTest
{
    ...
    public void shouldLogFailureToCreateUser() throws Throwable
    {
        ...
        catchInvalidArguments( () -> authProcedures.createUser( "neo5j", "nonEmpty", true ) );
        ...
        log.assertExactly(
                ...
                error( "[admin]: tried to create user `%s`: %s", "neo5j", "The specified user 'neo5j' already exists." )
        );
    }
    ...
    {
        authProcedures.createUser( "mats", "neo5j", false );
    ...
    {
        // Given
        authProcedures.createUser( "mats", "neo5j", true );
        log.clear();
    ...
    {
        // Given
        authProcedures.createUser( "andres", "neo5j", true );
        log.clear();

        // When
        catchInvalidArguments( () -> authProcedures.changeUserPassword( "andres", "neo5j", false ) );
    ...
    public void shouldLogFailureToChangeOwnPassword() throws Throwable
    {
        ...
        // When
        catchInvalidArguments( () -> authProcedures.changeUserPassword( "mats", "neo5j", false ) );
        ...
        catchInvalidArguments( () -> authProcedures.changePassword( "neo5j", false ) );
    ...
    {
        // Given
        authProcedures.createUser( "johan", "neo5j", false );
