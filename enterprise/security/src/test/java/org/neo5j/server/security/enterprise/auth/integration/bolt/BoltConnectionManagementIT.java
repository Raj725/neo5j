...
import org.neo5j.bolt.v1.runtime.spi.ImmutableRecord;
...
public class BoltConnectionManagementIT
{
    ...
    public void setup() throws Exception
    {
        ...
        authenticate( admin, "neo5j", "neo5j", "123" );
    ...
    @Rule
    public Neo5jWithSocket server = new Neo5jWithSocket( getClass(), getTestGraphDatabaseFactory(),
            getSettingsFunction() );
    ...
    public void shouldListOwnConnection() throws Throwable
    {
        ...
        assertTrue( result.containsKey( "neo5j" ) );
        assertTrue( result.get( "neo5j" ) == 1L );
    }
    ...
    public void shouldTerminateConnectionForUser() throws Throwable
    {
        ...
        assertTrue( listResult.containsKey( "neo5j" ) );
        assertTrue( listResult.get( "neo5j" ) == 1L );
    ...
    public void shouldFailWhenTerminatingConnectionsByNonAdmin() throws Throwable
    {
        ...
        // Then
        assertFailTerminateConnectionForUser( user, "neo5j" );
    ...
    {
        assertTerminateOwnConnection( admin, "neo5j" );
    }

    //@Test
    public void shouldTerminateOwnConnectionsIfAdmin() throws Throwable
    {
        authenticate( user, "neo5j", "123", null );
        assertTerminateOwnConnections( admin, user, "neo5j" );
    }
