...
import org.neo5j.server.security.enterprise.auth.MultiRealmAuthManagerRule.FullSecurityLog;
...
public class BoltInitChangePasswordTest
{
    ...
    public void setup() throws Throwable
    {
        ...
        authManagerRule.getManager().getUserManager().newUser( "neo5j", "123", true );
    }

    @Test
    public void shouldLogInitPasswordChange() throws Throwable
    {
        authentication.authenticate( authToken( "neo5j", "123", "secret" ) );

        FullSecurityLog fullLog = authManagerRule.getFullSecurityLog();
        fullLog.assertHasLine( "neo5j", "logged in" );
    ...
    {
        assertException( () -> authentication.authenticate( authToken( "neo5j", "123", "123" ) ),
