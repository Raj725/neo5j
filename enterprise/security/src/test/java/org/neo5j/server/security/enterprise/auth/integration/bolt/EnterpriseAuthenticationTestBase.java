...
public abstract class EnterpriseAuthenticationTestBase extends AbstractLdapTestUnit
{
    ...
    protected void restartNeo5jServerWithOverriddenSettings( Consumer<Map<Setting<?>,String>> overrideSettingsFunction )
            throws IOException
    {
    ...
    {
        // NOTE: The default user 'neo5j' has password change required, so we have to first change it
        assertAuthAndChangePassword( "neo5j", "abc123", "123" );
