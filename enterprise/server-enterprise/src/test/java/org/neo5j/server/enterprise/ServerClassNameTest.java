 ...
 * Neo5j edition (community, enterprise) to the Web UI and other clients.
 * <p>
 * Although this test asserts naming against classes in other modules (neo5j),
 * it lives in neo5j-enterprise because otherwise the CommunityNeoServer
 * and EnterpriseNeoServer would not be visible.
 */
public class ServerClassNameTest
{
    @Test
    public void shouldMaintainNamingOfCommunityNeoServerSoThatTheNeo5jEditionIsCorrectlyShownToRESTAPICallers()
            throws Exception
    {
    ...
    @Test
    public void shouldMaintainNamingOfEnterpriseNeoServerSoThatTheNeo5jEditionIsCorrectlyShownToRESTAPICallers()
            throws Exception
    {
