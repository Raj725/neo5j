...
import org.neo5j.harness.internal.Ports;
...
import org.neo5j.kernel.guard.GuardTimeoutException;
...
import org.neo5j.kernel.impl.factory.DataSourceModule;
...
import org.neo5j.server.database.LifecycleManagingDatabase;
import org.neo5j.server.helpers.CommunityServerBuilder;
import org.neo5j.server.web.HttpHeaderUtils;
import org.neo5j.shell.InterruptSignalHandler;
import org.neo5j.shell.Response;
import org.neo5j.shell.ShellException;
import org.neo5j.shell.impl.CollectingOutput;
import org.neo5j.shell.impl.SameJvmClient;
import org.neo5j.shell.kernel.GraphDatabaseShellServer;
import org.neo5j.test.TestGraphDatabaseFactory;
import org.neo5j.test.TestGraphDatabaseFactoryState;
...
import static org.neo5j.kernel.api.exceptions.Status.Transaction.TransactionNotFound;
...
public class TransactionGuardIntegrationTest
{
    ...
    public void terminateLongRunningDriverQuery() throws Exception
    {
        ...
        org.neo5j.driver.v1.Config driverConfig = getDriverConfig();

        try ( Driver driver = GraphDatabase.driver( "bolt://localhost:" + boltPortDatabaseWithTimeout, driverConfig );
                Session session = driver.session() )
        {
            org.neo5j.driver.v1.Transaction transaction = session.beginTransaction();
    ...
    private org.neo5j.driver.v1.Config getDriverConfig()
    {
        return org.neo5j.driver.v1.Config.build()
                .withEncryptionLevel( org.neo5j.driver.v1.Config.EncryptionLevel.NONE )
                .toConfig();
    }
