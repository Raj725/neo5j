...
import org.neo5j.bolt.v1.runtime.MonitoredWorkerFactory.SessionMonitor;
...
import org.neo5j.driver.v1.exceptions.ConnectionFailureException;
...
import static org.neo5j.graphdb.factory.GraphDatabaseSettings.Connector.ConnectorType.BOLT;
import static org.neo5j.graphdb.factory.GraphDatabaseSettings.boltConnector;
