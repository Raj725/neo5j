...
public class UserAggregationFunctionIT
{
    ...
    public void shouldHandleSingleStringArgumentAggregationFunction()
    {
        ...
        // When
        Result result = db.execute( "MATCH (n) RETURN org.neo5j.procedure.count(n.prop) AS count" );
    ...
    public void shouldHandleSingleStringArgumentAggregationFunctionAndGroupingKey()
    {
        ...
        // When
        Result result = db.execute( "MATCH (n) RETURN n.prop1, org.neo5j.procedure.count(n.prop2) AS count" );
    ...
    public void shouldFailNicelyWhenInvalidRuntimeType()
    {
        ...
        // When
        db.execute( "MATCH (n) RETURN org.neo5j.procedure.count(n.prop) AS count" );
    }
    ...
    public void shouldHandleNodeArgumentAggregationFunction()
    {
        ...
        // When
        Result result =
                db.execute( "MATCH (n) WITH org.neo5j.procedure.findBestNode(n) AS best RETURN best.level AS level" );
    ...
    public void shouldHandleRelationshipArgumentAggregationFunction()
    {
        ...
        Result result = db.execute(
                "MATCH ()-[r]->() WITH org.neo5j.procedure.findBestRel(r) AS best RETURN best.level AS level" );
    ...
    public void shouldHandlePathArgumentAggregationFunction()
    {
        ...
        // When
        Result result = db.execute(
                "MATCH p=()-[:T*]->() WITH org.neo5j.procedure.longestPath(p) AS longest RETURN length(longest) AS " +
                "len" );
    ...
    public void shouldHandleNumberArgumentAggregationFunction()
    {
        // Given, When
        Result result = db.execute(
                "UNWIND [43, 42.5, 41.9, 1337] AS num RETURN org.neo5j.procedure.near42(num) AS closest" );
    ...
    public void shouldHandleDoubleArgumentAggregationFunction()
    {
        // Given, When
        Result result = db.execute(
                "UNWIND [43, 42.5, 41.9, 1337] AS num RETURN org.neo5j.procedure.doubleAggregator(num) AS closest" );
    ...
    public void shouldHandleLongArgumentAggregationFunction()
    {
        // Given, When
        Result result = db.execute(
                "UNWIND [43, 42.5, 41.9, 1337] AS num RETURN org.neo5j.procedure.longAggregator(num) AS closest" );
    ...
    public void shouldHandleNoArgumentBooleanAggregationFunction()
    {
        assertThat( db.execute(
                "UNWIND [1,2] AS num RETURN org.neo5j.procedure.boolAggregator() AS wasCalled" ).next(),
                equalTo( map( "wasCalled", true ) ) );
        assertThat( db.execute(
                "UNWIND [] AS num RETURN org.neo5j.procedure.boolAggregator() AS wasCalled" ).next(),
    ...
    public void shouldBeAbleToUseAdbInFunction()
    {
        ...
        // When
        Result result = db.execute(
                "UNWIND $ids AS ids WITH org.neo5j.procedure.collectNode(ids) AS nodes RETURN nodes",
