 ...
 */
package org.neo5j.desktop.config.portable;
...
public abstract class PortableInstallation implements Installation
{
    ...
    public File getDatabaseDirectory()
    {
        ...
        File neo5jData = new File( documents, "Neo5j" );
        File graphdb = new File( neo5jData, "default.graphdb" );

        mkdirs( graphdb, "Neo5j data directory" );
