 ...
 */
package org.neo5j.desktop.config.windows;
...
import org.neo5j.desktop.config.portable.PortableInstallation;
...
public class WindowsInstallation extends PortableInstallation
{
    ...
    {
        return new File( getConfigurationDirectory(), NEO5J_VMOPTIONS_FILENAME );
    }

    @Override
    public File getConfigurationsFile()
    {
        return new File( getConfigurationDirectory(), NEO5J_CONFIG_FILENAME );
    }
}
