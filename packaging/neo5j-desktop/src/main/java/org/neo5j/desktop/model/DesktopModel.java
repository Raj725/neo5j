 ...
 */
package org.neo5j.desktop.model;
...
import org.neo5j.desktop.Parameters;
import org.neo5j.desktop.config.Installation;
import org.neo5j.desktop.model.exceptions.UnsuitableDirectoryException;
import org.neo5j.desktop.runtime.DesktopConfigurator;
import org.neo5j.desktop.ui.DesktopModelListener;
...
public class DesktopModel
{
    ...
    public String getNeo5jVersion()
    {
        return format( "%s", Version.getNeo5jVersion() );
    }
    ...
    private static void verifyGraphDirectory( File dir ) throws UnsuitableDirectoryException
    {
        ...
        {
            if ( fileName.startsWith( "neostore" ) || fileName.equals( "neo5j.conf" ) )
            {
                return;
            }
        }
        ...
        throw new UnsuitableDirectoryException(
                "%s is neither empty nor does it contain a neo5j graph database", dir );
    }
