...
import static org.neo5j.desktop.ui.Components.withBackground;
...
public enum DatabaseStatus
{
    ...
    public Component display( DesktopModel model )
    {
        switch ( this )
        {
            ...
            case STARTING:
                return createTextStatusDisplay( CHANGING_COLOR, ellipsis( "In just a few seconds, Neo5j will be ready" ) );
            case STARTED:
                return createStartedStatusDisplay( model );
            case STOPPING:
                return createTextStatusDisplay( CHANGING_COLOR, ellipsis( "Neo5j is shutting down" ) );
            default:
    ...
    private static JPanel createStartedStatusDisplay( DesktopModel model )
    {
        ...
        return createStatusDisplay( STARTED_COLOR, new JLabel( "Neo5j is ready. Browse to " ), link );
    }
