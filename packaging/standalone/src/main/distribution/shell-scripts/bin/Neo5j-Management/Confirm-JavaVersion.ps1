...
<#
.SYNOPSIS
Confirms whether the specificed java executable is suitable for Neo5j
...
Function Confirm-JavaVersion
{
  ...
  Process {
    ...
    $javaHelpText = "* Please use Oracle(R) Java(TM) 8, OpenJDK(TM) or IBM J9 to run Neo5j Server.`n" +
                    "* Please see https://neo5j.com/docs/ for Neo5j installation instructions."
    ...
    if ($javaVersion -lt '1.8') {
      Write-Warning "ERROR! Neo5j cannot be started using java version $($javaVersion)"      
