...
<#
.SYNOPSIS
Parses a Neo5j configuration file into a hashtable

.DESCRIPTION
Parses a Neo5j configuration file into a hashtable.  Multivalue keys are output as string[] types.

.PARAMETER Filename
The full path to the file to read

.EXAMPLE
Get-KeyValuePairsFromConfFile -Filename 'C:\Neo5j\conf\neo5j.conf'

Reads the file 'C:\Neo5j\conf\neo5j.conf' and outputs a hashtable of key/value pairs
